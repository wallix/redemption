...
'rdp': ({
    ...
    'session_probe': {
        ...
        ('session_probe:alternate_directory_environment_variable', 'alternate_directory_environment_variable', u''),
        ('session_probe:public_session', 'public_session', False),
        ('session_probe:outbound_connection_monitoring_rules', 'outbound_connection_monitoring_rules', u''),
        ('session_probe:process_monitoring_rules', 'process_monitoring_rules', u''),
        ('session_probe:extra_system_processes', 'extra_system_processes', u''),
        ('session_probe:windows_of_these_applications_as_unidentified_input_field', 'windows_of_these_applications_as_unidentified_input_field', u''),
    },
    'server_cert': {
        ('server_cert:server_cert_store', 'server_cert_store', True),
        ('server_cert:server_cert_check', 'server_cert_check', 1),
