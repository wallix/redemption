...
cp_spec = {
  ...
  'rdp': {
    u'mod_rdp:enable_nla': ('enable_nla', True),
    ...
    u'mod_rdp:use_client_provided_alternate_shell': ('use_client_provided_alternate_shell', False),
    u'mod_rdp:use_client_provided_remoteapp': ('use_client_provided_remoteapp', False),
    u'mod_rdp:use_native_remoteapp_capability': ('use_native_remoteapp_capability', True),
  ...
  'session_probe': {
    u'mod_rdp:enable_session_probe': ('enable_session_probe', False),
    ...
    u'mod_rdp:session_probe_keepalive_timeout': ('keepalive_timeout', 5000),
    u'mod_rdp:session_probe_on_keepalive_timeout': ('on_keepalive_timeout', 1),
    u'mod_rdp:session_probe_end_disconnected_session': ('end_disconnected_session', False),
    u'mod_rdp:session_probe_enable_log': ('enable_log', False),
    u'mod_rdp:session_probe_enable_log_rotation': ('enable_log_rotation', True),
    u'mod_rdp:session_probe_disconnected_application_limit': ('disconnected_application_limit', 0),
    u'mod_rdp:session_probe_disconnected_session_limit': ('disconnected_session_limit', 0),
    u'mod_rdp:session_probe_idle_session_limit': ('idle_session_limit', 0),
    u'mod_rdp:session_probe_clipboard_based_launcher_clipboard_initialization_delay': ('smart_launcher_clipboard_initialization_delay', 2000),
    u'mod_rdp:session_probe_clipboard_based_launcher_start_delay': ('smart_launcher_start_delay', 0),
    u'mod_rdp:session_probe_clipboard_based_launcher_long_delay': ('smart_launcher_long_delay', 500),
    u'mod_rdp:session_probe_clipboard_based_launcher_short_delay': ('smart_launcher_short_delay', 50),
    u'mod_rdp:session_probe_launcher_abort_delay': ('launcher_abort_delay', 2000),
    u'mod_rdp:session_probe_enable_crash_dump': ('enable_crash_dump', False),
    u'mod_rdp:session_probe_handle_usage_limit': ('handle_usage_limit', 0),
  ...
  'server_cert': {
    u'mod_rdp:server_cert_store': ('server_cert_store', True),
    u'mod_rdp:server_cert_check': ('server_cert_check', 1),
    u'mod_rdp:server_access_allowed_message': ('server_access_allowed_message', 1),
    u'mod_rdp:server_cert_create_message': ('server_cert_create_message', 1),
    u'mod_rdp:server_cert_success_message': ('server_cert_success_message', 1),
    u'mod_rdp:server_cert_failure_message': ('server_cert_failure_message', 1),
  },
  'file_verification': {
