...
################################################################################
    ...
    #===============================================================================
        ...
        , u'fr':
            ...
            , u'auth_failed %s'         : u"Echec de l'autentification pour l'utilisateur %s"
            , u'auth_failed_wab %s'     : u"Echec de l'autentification pour l'utilisateur du wab %s"
