...
global_request_cb = CFUNCTYPE(None,
    c_void_p, c_int, c_int, c_char_p, c_uint32, py_object)

auth_none_reply_client_cb = CFUNCTYPE(None, c_int, py_object)

auth_cb = CFUNCTYPE(c_int,
    c_char_p, c_char_p, c_uint32, c_int, c_int, py_object)

connect_status_cb = CFUNCTYPE(None,
    py_object, c_float)

channel_open_request_x11_cb = CFUNCTYPE(c_void_p,
    c_void_p, c_char_p, c_int, c_uint32, c_uint32, c_uint32, py_object)

channel_open_request_auth_agent_cb = CFUNCTYPE(c_void_p,
    c_void_p, py_object)
...
class ssh_client_callbacks_struct(Structure):
    _fields_ = [
        ('size', c_ulong),
        ('userdata', py_object),
        ('auth_none_reply_client_cb', auth_none_reply_client_cb),
...
auth_interactive_cb = CFUNCTYPE(c_int, c_char_p, c_int, py_object)

auth_gssapi_mic_cb = CFUNCTYPE(c_int, c_char_p, c_char_p, py_object)

auth_pubkey_cb = CFUNCTYPE(c_int, c_char_p, c_void_p, c_int, py_object)

service_request_cb = CFUNCTYPE(c_int, c_char_p, py_object)

channel_open_request_session_cb = CFUNCTYPE(c_void_p, py_object)

channel_open_request_direct_tcpip_cb = CFUNCTYPE(c_void_p,
    c_char_p, c_uint16, c_char_p, c_uint16, py_object)

channel_open_request_forwarded_tcpip_cb = CFUNCTYPE(c_void_p,
    c_void_p, c_char_p, c_uint16, c_char_p, c_uint16, py_object)


channel_data_cb = CFUNCTYPE(c_int,
    c_void_p, c_void_p, c_void_p, c_uint, c_int, py_object)

channel_eof_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, py_object)

channel_close_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, py_object)

channel_signal_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, c_char_p, py_object)

channel_exit_status_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, c_int, py_object)

channel_exit_signal_cb = CFUNCTYPE(None, 
    c_void_p, c_void_p, c_char_p, c_int, c_char_p, c_char_p, py_object)

channel_pty_request_cb = CFUNCTYPE(c_int, 
    c_void_p, c_void_p, c_char_p, c_int, c_int, c_int, c_int, py_object)

channel_shell_request_cb = CFUNCTYPE(c_int, 
    c_void_p, c_void_p, py_object)

channel_auth_agent_req_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, py_object)

channel_x11_req_cb = CFUNCTYPE(None, 
    c_void_p, c_void_p, c_int, c_char_p, c_char_p, c_uint, py_object)

channel_exec_request_cb = CFUNCTYPE(c_int, 
    c_void_p, c_void_p, c_char_p, py_object)

channel_env_request_cb = CFUNCTYPE(c_int, 
    c_void_p, c_void_p, c_char_p, c_char_p, py_object)

channel_subsystem_request_cb = CFUNCTYPE(c_int, 
    c_void_p, c_void_p, c_char_p, py_object)


channel_open_x11_server_status_cb = CFUNCTYPE(None,
    c_void_p, c_void_p, c_int, py_object)


channel_pty_window_change_cb = CFUNCTYPE(c_int, 
...
class ssh_channel_callbacks_struct(Structure):
    _fields_ = [
        ...
        ('channel_open_x11_server_status_function', channel_open_x11_server_status_cb)
        ]
...
try:
    ...
    class ssh_server_callbacks_struct(Structure):
        _fields_ = [
            ...
            ('connect_status_server_cb', connect_status_cb),
            ('global_request_server_cb', global_request_cb),

            ('auth_password_server_cb', auth_password_cb),
            ('auth_none_server_cb', auth_none_cb),
            ('auth_interactive_server_cb', auth_interactive_cb),
            ('auth_gssapi_mic_server_cb', auth_gssapi_mic_cb),
            ('auth_pubkey_server_cb', auth_pubkey_cb),
            ('service_request_server_cb', service_request_cb),
            ('channel_open_request_session_server_cb', channel_open_request_session_cb),
            ('channel_open_request_direct_tcpip_server_cb', channel_open_request_direct_tcpip_cb),
            ('channel_open_request_forwarded_tcpip_function', channel_open_request_forwarded_tcpip_cb)
        ]
