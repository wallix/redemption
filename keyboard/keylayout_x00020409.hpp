...
#if !defined(__KEYLAYOUT_X00020409_HPP__)
#define __KEYLAYOUT_X00020409_HPP__

#include "keylayout.hpp"

namespace x00020409 {    // English (United States) // United States-International

const static int LCID = 0x00020409;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x60 - x67 */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00A1, 0x00B2, 0x00B3, 0x00A4, 0x20AC, 0x00BC,
    /* x08 - x0F */    0x00BD, 0x00BE, 0x2018, 0x2019, 0x00A5, 0x00D7, 0x0008, 0x0009,
    /* x10 - x17 */    0x00E4, 0x00E5, 0x00E9, 0x00AE, 0x00FE, 0x00FC, 0x00FA, 0x00ED,
    /* x18 - x1F */    0x00F3, 0x00F6, 0x00AB, 0x00BB, 0x000D, 0x0000, 0x00E1, 0x00DF,
    /* x20 - x27 */    0x00F0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00F8, 0x00B6,
    /* x28 - x2F */    0x00B4, 0x0000, 0x0000, 0x00AC, 0x00E6, 0x0000, 0x00A9, 0x0000,
    /* x30 - x37 */    0x0000, 0x00F1, 0x00B5, 0x00E7, 0x0000, 0x00BF, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00B9, 0x0000, 0x0000, 0x00A3, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00F7, 0x0008, 0x0009,
    /* x10 - x17 */    0x00C4, 0x00C5, 0x00C9, 0x0000, 0x00DE, 0x00DC, 0x00DA, 0x00CD,
    /* x18 - x1F */    0x00D3, 0x00D6, 0x0000, 0x0000, 0x000D, 0x0000, 0x00C1, 0x00A7,
    /* x20 - x27 */    0x00D0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00D8, 0x00B0,
    /* x28 - x2F */    0x00A8, 0x0000, 0x0000, 0x00A6, 0x00C6, 0x0000, 0x00A2, 0x0000,
    /* x30 - x37 */    0x0000, 0x00D1, 0x0000, 0x00C7, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00A1, 0x00B2, 0x00B3, 0x00A4, 0x20AC, 0x00BC,
    /* x08 - x0F */    0x00BD, 0x00BE, 0x2018, 0x2019, 0x00A5, 0x00D7, 0x0008, 0x0009,
    /* x10 - x17 */    0x00C4, 0x00C5, 0x00C9, 0x00AE, 0x00DE, 0x00DC, 0x00DA, 0x00CD,
    /* x18 - x1F */    0x00D3, 0x00D6, 0x00AB, 0x00BB, 0x000D, 0x0000, 0x00C1, 0x00DF,
    /* x20 - x27 */    0x00D0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00D8, 0x00B6,
    /* x28 - x2F */    0x00B4, 0x0000, 0x0000, 0x00AC, 0x00C6, 0x0000, 0x00A9, 0x0000,
    /* x30 - x37 */    0x0000, 0x00D1, 0x00B5, 0x00C7, 0x0000, 0x00BF, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00B9, 0x0000, 0x0000, 0x00A3, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00F7, 0x0008, 0x0009,
    /* x10 - x17 */    0x00E4, 0x00E5, 0x00E9, 0x0000, 0x00FE, 0x00FC, 0x00FA, 0x00ED,
    /* x18 - x1F */    0x00F3, 0x00F6, 0x0000, 0x0000, 0x000D, 0x0000, 0x00E1, 0x00A7,
    /* x20 - x27 */    0x00F0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00F8, 0x00B0,
    /* x28 - x2F */    0x00A8, 0x0000, 0x0000, 0x00A6, 0x00E6, 0x0000, 0x00A2, 0x0000,
    /* x30 - x37 */    0x0000, 0x00F1, 0x0000, 0x00E7, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x005e, 0x07, 11, { {0x006f, 0x00f4}  // 'o' = 'ô'
                        , {0x0049, 0x00ce}  // 'I' = 'Î'
                        , {0x0020, 0x005e}  // ' ' = '^'
                        , {0x0041, 0x00c2}  // 'A' = 'Â'
                        , {0x0045, 0x00ca}  // 'E' = 'Ê'
    ...
    { 0x0027, 0x28, 15, { {0x006f, 0x00f3}  // 'o' = 'ó'
                        , {0x0049, 0x00cd}  // 'I' = 'Í'
                        , {0x0059, 0x00dd}  // 'Y' = 'Ý'
                        , {0x0041, 0x00c1}  // 'A' = 'Á'
                        , {0x0043, 0x00c7}  // 'C' = 'Ç'
    ...
    { 0x0022, 0x28, 12, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0020, 0x0022}  // ' ' = '"'
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0045, 0x00cb}  // 'E' = 'Ë'
    ...
    { 0x0060, 0x29, 11, { {0x006f, 0x00f2}  // 'o' = 'ò'
                        , {0x0049, 0x00cc}  // 'I' = 'Ì'
                        , {0x0020, 0x0060}  // ' ' = '`'
                        , {0x0041, 0x00c0}  // 'A' = 'À'
                        , {0x0045, 0x00c8}  // 'E' = 'È'
    ...
    { 0x007e, 0x29,  7, { {0x006f, 0x00f5}  // 'o' = 'õ'
                        , {0x0020, 0x007e}  // ' ' = '~'
                        , {0x006e, 0x00f1}  // 'n' = 'ñ'
                        , {0x0041, 0x00c3}  // 'A' = 'Ã'
                        , {0x0061, 0x00e3}  // 'a' = 'ã'
...
} // END NAMESPACE - x00020409

static const Keylayout keylayout_x00020409( x00020409::LCID
                                          , x00020409::noMod
                                          , x00020409::shift
                                          , x00020409::altGr
                                          , x00020409::shiftAltGr
                                          , x00020409::ctrl
                                          , x00020409::capslock_noMod
                                          , x00020409::capslock_shift
                                          , x00020409::capslock_altGr
                                          , x00020409::capslock_shiftAltGr
                                          , x00020409::deadkeys
                                          , x00020409::nbDeadkeys
);
