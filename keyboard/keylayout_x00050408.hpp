...
#if !defined(__KEYLAYOUT_X00050408_HPP__)
#define __KEYLAYOUT_X00050408_HPP__

#include "keylayout.hpp"

namespace x00050408 {    // Greek (Greece) // Greek Latin

const static int LCID = 0x00050408;
...
const Keylayout::dkey_t deadkeys[] = {
    ...
    { 0x00b4, 0x28, 15, { {0x006f, 0x00f3}  // 'o' = 'ó'
                        , {0x0049, 0x00cd}  // 'I' = 'Í'
                        , {0x0059, 0x00dd}  // 'Y' = 'Ý'
                        , {0x0041, 0x00c1}  // 'A' = 'Á'
                        , {0x0043, 0x00c7}  // 'C' = 'Ç'
    ...
    { 0x00a8, 0x28, 13, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0059, 0x009f}  // 'Y' = ''
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0045, 0x00cb}  // 'E' = 'Ë'
...
} // END NAMESPACE - x00050408

static const Keylayout keylayout_x00050408( x00050408::LCID
                                          , x00050408::noMod
                                          , x00050408::shift
                                          , x00050408::altGr
                                          , x00050408::shiftAltGr
                                          , x00050408::ctrl
                                          , x00050408::capslock_noMod
                                          , x00050408::capslock_shift
                                          , x00050408::capslock_altGr
                                          , x00050408::capslock_shiftAltGr
                                          , x00050408::deadkeys
                                          , x00050408::nbDeadkeys
);
