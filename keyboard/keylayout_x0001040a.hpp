...
#if !defined(__KEYLAYOUT_X0001040A_HPP__)
#define __KEYLAYOUT_X0001040A_HPP__

#include "keylayout.hpp"

namespace x0001040a {    // Spanish (Spain)

const static int LCID = 0x0001040a;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x10 - x17 */       '7',    '8',    '9',    '0', 0x002D, 0x00A8, 0x0008, 0x0009,
    /* x18 - x1F */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x20 - x27 */       'o',    'p', 0x00F7, 0x0060, 0x000D, 0x0000,    'a',    's',
    /* x28 - x2F */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x30 - x37 */    0x00E7, 0x0027, 0x0000, 0x00B4,    'z',    'x',    'c',    'v',
    /* x38 - x3F */       'b',    'n',    'm', 0x002C, 0x002E, 0x003D, 0x0000, 0x002A,
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x00AA, 0x0022, 0x002F, 0x0028, 0x0029, 0x00A1,
    /* x10 - x17 */    0x0021, 0x00BF, 0x003F, 0x20A7, 0x002B, 0x00A8, 0x0008, 0x0000,
    /* x18 - x1F */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x20 - x27 */       'O',    'P', 0x00D7, 0x0060, 0x000D, 0x0000,    'A',    'S',
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00D1,
    /* x30 - x37 */    0x00C7, 0x00B7, 0x0000, 0x00B4,    'Z',    'X',    'C',    'V',
    /* x38 - x3F */       'B',    'N',    'M', 0x003B, 0x003A, 0x0025, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x007C, 0x0040, 0x0023, 0x00BC, 0x00BD, 0x00AC,
    /* x10 - x17 */    0x005F, 0x0023, 0x00A7, 0x005C, 0x002A, 0x007E, 0x0008, 0x0009,
    /* x18 - x1F */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x005B, 0x005D, 0x000D, 0x0000, 0x0024, 0x0026,
    /* x28 - x2F */    0x0040, 0x005B, 0x005D, 0x007C, 0x00A3, 0x00B1, 0x0000, 0x007E,
    /* x30 - x37 */    0x007B, 0x005C, 0x0000, 0x007D, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x005E, 0x0000, 0x0000, 0x002A,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x20 - x27 */       'O',    'P', 0x00D7, 0x0060, 0x000D, 0x0000,    'A',    'S',
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00D1,
    /* x30 - x37 */    0x00C7, 0x0027, 0x0000, 0x00B4,    'Z',    'X',    'C',    'V',
    /* x38 - x3F */       'B',    'N',    'M', 0x002C, 0x002E, 0x003D, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x002D, 0x0000, 0x0000, 0x0000, 0x002B, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x00AA, 0x0022, 0x002F, 0x0028, 0x0029, 0x00A1,
    /* x10 - x17 */    0x0021, 0x00BF, 0x003F, 0x20A7, 0x002B, 0x00A8, 0x0008, 0x0009,
    /* x18 - x1F */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x20 - x27 */       'o',    'p', 0x00F7, 0x0060, 0x000D, 0x0000,    'a',    's',
    /* x28 - x2F */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x30 - x37 */    0x00E7, 0x00B7, 0x0000, 0x00B4,    'z',    'x',    'c',    'v',
    /* x38 - x3F */       'b',    'n',    'm', 0x003B, 0x003A, 0x0025, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x002D, 0x0000, 0x0000, 0x0000, 0x002B, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
      { 0x00a8, 0x0d, 12, { {0x006f, 0x00f6}  // 'o' = 'ö'
                          , {0x0049, 0x00cf}  // 'I' = 'Ï'
                          , {0x0020, 0x00a8}  // ' ' = '¨'
                          , {0x0041, 0x00c4}  // 'A' = 'Ä'
                          , {0x0045, 0x00cb}  // 'E' = 'Ë'
      ...
      { 0x0060, 0x1b, 11, { {0x006f, 0x00f2}  // 'o' = 'ò'
                          , {0x0049, 0x00cc}  // 'I' = 'Ì'
                          , {0x0020, 0x0060}  // ' ' = '`'
                          , {0x0041, 0x00c0}  // 'A' = 'À'
                          , {0x0045, 0x00c8}  // 'E' = 'È'
      ...
      { 0x00b4, 0x2b, 12, { {0x006f, 0x00f3}  // 'o' = 'ó'
                          , {0x0049, 0x00cd}  // 'I' = 'Í'
                          , {0x0020, 0x00b4}  // ' ' = '´'
                          , {0x0041, 0x00c1}  // 'A' = 'Á'
                          , {0x0045, 0x00c9}  // 'E' = 'É'
      ...
      { 0x005e, 0x34, 11, { {0x006f, 0x00f4}  // 'o' = 'ô'
                          , {0x0049, 0x00ce}  // 'I' = 'Î'
                          , {0x0020, 0x005e}  // ' ' = '^'
                          , {0x0041, 0x00c2}  // 'A' = 'Â'
                          , {0x0045, 0x00ca}  // 'E' = 'Ê'
...
} // END NAMESPACE - x0001040a

static const Keylayout keylayout_x0001040a( x0001040a::LCID
                                          , x0001040a::noMod
                                          , x0001040a::shift
                                          , x0001040a::altGr
                                          , x0001040a::shiftAltGr
                                          , x0001040a::ctrl
                                          , x0001040a::capslock_noMod
                                          , x0001040a::capslock_shift
                                          , x0001040a::capslock_altGr
                                          , x0001040a::capslock_shiftAltGr
                                          , x0001040a::deadkeys
);
