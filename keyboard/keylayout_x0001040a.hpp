...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x002D, 0x00A8, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00F7, 0x0060, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x28 - x2F */    0x00E7, 0x0027, 0x0000, 0x00B4,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x002C, 0x002E, 0x003D, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00AA, 0x0022, 0x002F, 0x0028, 0x0029, 0x00A1,
    /* x08 - x0F */    0x0021, 0x00BF, 0x003F, 0x20A7, 0x002B, 0x00A8, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00D7, 0x0060, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00D1,
    /* x28 - x2F */    0x00C7, 0x00B7, 0x0000, 0x00B4,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x003B, 0x003A, 0x0025, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x007C, 0x0040, 0x0023, 0x00BC, 0x00BD, 0x00AC,
    /* x08 - x0F */    0x005F, 0x0023, 0x00A7, 0x005C, 0x002A, 0x007E, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x005B, 0x005D, 0x000D, 0x0000, 0x0024, 0x0026,
    /* x20 - x27 */    0x0040, 0x005B, 0x005D, 0x007C, 0x00A3, 0x00B1, 0x0000, 0x007E,
    /* x28 - x2F */    0x007B, 0x005C, 0x0000, 0x007D, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x005E, 0x0000, 0x0000,    '*',
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x18 - x1F */       'O',    'P', 0x00D7, 0x0060, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00D1,
    /* x28 - x2F */    0x00C7, 0x0027, 0x0000, 0x00B4,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x002C, 0x002E, 0x003D, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00AA, 0x0022, 0x002F, 0x0028, 0x0029, 0x00A1,
    /* x08 - x0F */    0x0021, 0x00BF, 0x003F, 0x20A7, 0x002B, 0x00A8, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00F7, 0x0060, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x28 - x2F */    0x00E7, 0x00B7, 0x0000, 0x00B4,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x003B, 0x003A, 0x0025, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
