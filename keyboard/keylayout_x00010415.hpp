...
#if !defined(__KEYLAYOUT_X00010415_HPP__)
#define __KEYLAYOUT_X00010415_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */       'o',    'p', 0x017C, 0x015B, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x0142,
    /* x28 - x2F */    0x0105, 0x02DB, 0x0000, 0x00F3,    'y',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Z',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x0144, 0x0107, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x0141,
    /* x28 - x2F */    0x0119, 0x00B7, 0x0000, 0x017A,    'Y',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x10 - x17 */    0x005C, 0x00A6, 0x0000, 0x0000, 0x0000, 0x0000, 0x20AC, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x00F7, 0x00D7, 0x000D, 0x0000, 0x0000, 0x0111,
    /* x20 - x27 */    0x0110, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0024,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x02c7, 0x03, 17, { {0x007a, 0x017e}  // 'z' = 'ž'
                        , {0x0043, 0x010c}  // 'C' = 'Č'
                        , {0x006e, 0x0148}  // 'n' = 'ň'
                        , {0x0053, 0x0160}  // 'S' = 'Š'
                        , {0x0052, 0x0158}  // 'R' = 'Ř'
    ...
    { 0x00b7, 0x09,  3, { {0x007a, 0x017c}  // 'z' = 'ż'
                        , {0x005a, 0x017b}  // 'Z' = 'Ż'
                        , {0x0020, 0x00b7}  // ' ' = '·'
                        }
    },
...
static const Keylayout keylayout_x00010415( x00010415::LCID
                                          ...
                                          , x00010415::shift
                                          , x00010415::altGr
                                          , x00010415::shiftAltGr
                                          , x00010415::ctrl
                                          , x00010415::capslock_noMod
                                          , x00010415::capslock_shift
                                          , x00010415::capslock_altGr
                                          , x00010415::capslock_shiftAltGr
                                          , x00010415::deadkeys
