...
#if !defined(__KEYLAYOUT_X00020408_HPP__)
#define __KEYLAYOUT_X00020408_HPP__

#include "keylayout.hpp"

namespace x00020408 {    // Greek (Greece) // Greek (319)

const static int LCID = 0x00020408;

const Keylayout::KeyLayout_t noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x0027, 0x002B, 0x0008, 0x0009,
    /* x10 - x17 */    0x00B7, 0x03C2, 0x03B5, 0x03C1, 0x03C4, 0x03C5, 0x03B8, 0x03B9,
    ...
    /* x28 - x2F */    0x2019, 0x00BD, 0x0000, 0x00B2, 0x03B6, 0x03C7, 0x03C8, 0x03C9,
    ...
    /* x48 - x4F */       '8',    '9',    '-',    '4',    '5',    '6',    '+',    '1',
    /* x50 - x57 */       '2',    '3',    '0', 0x002C, 0x0000, 0x0000, 0x00A7, 0x0000,
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x00A3, 0x0024, 0x0025, 0x00AC,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x00B0, 0x002A, 0x0008, 0x0000,
    /* x10 - x17 */    0x2015, 0x00A6, 0x0395, 0x03A1, 0x03A4, 0x03A5, 0x0398, 0x0399,
    /* x18 - x1F */    0x039F, 0x03A0, 0x00AB, 0x00BB, 0x000D, 0x0000, 0x0391, 0x03A3,
    /* x20 - x27 */    0x0394, 0x03A6, 0x0393, 0x0397, 0x039E, 0x039A, 0x039B, 0x00A8,
    /* x28 - x2F */    0x2018, 0x00B1, 0x0000, 0x00B3, 0x0396, 0x03A7, 0x03A8, 0x03A9,
    ...
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002C, 0x0000, 0x0000, 0x00A9, 0x0000,
    /* x58 - x5F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x28 - x2F */    0x2019, 0x00BD, 0x0000, 0x00B2, 0x0396, 0x03A7, 0x03A8, 0x03A9,
    /* x30 - x37 */    0x0392, 0x039D, 0x039C, 0x002C, 0x002E, 0x002D, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002C, 0x0000, 0x0000, 0x00A7, 0x0000,
    /* x58 - x5F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x60 - x67 */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x68 - x6F */       '/', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x70 - x77 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x00A3, 0x0024, 0x0025, 0x00AC,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x00B0, 0x002A, 0x0008, 0x0009,
    /* x10 - x17 */    0x00B7, 0x03C2, 0x03B5, 0x03C1, 0x03C4, 0x03C5, 0x03B8, 0x03B9,
    /* x18 - x1F */    0x03BF, 0x03C0, 0x00AB, 0x00BB, 0x000D, 0x0000, 0x03B1, 0x03C3,
    /* x20 - x27 */    0x03B4, 0x03C6, 0x03B3, 0x03B7, 0x03BE, 0x03BA, 0x03BB, 0x00A8,
    /* x28 - x2F */    0x2018, 0x00B1, 0x0000, 0x00B3, 0x03B6, 0x03C7, 0x03C8, 0x03C9,
...
} // END NAMESPACE - x00020408

static const Keylayout keylayout_x00020408( x00020408::LCID
                                          , x00020408::noMod
                                          , x00020408::shift
                                          , x00020408::altGr
                                          , x00020408::shiftAltGr
                                          , x00020408::ctrl
                                          , x00020408::capslock_noMod
                                          , x00020408::capslock_shift
                                          , x00020408::capslock_altGr
                                          , x00020408::capslock_shiftAltGr
                                          , x00020408::deadkeys
                                          , x00020408::nbDeadkeys
);
