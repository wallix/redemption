...
#if !defined(__KEYLAYOUT_X00010426_HPP__)
#define __KEYLAYOUT_X00010426_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x28 - x2F */    0x0027, 0x0060, 0x0000, 0x00B0,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00A0, 0x00AB, 0x00BB, 0x20AC, 0x0000, 0x2019,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x2013, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0113, 0x0157, 0x0000, 0x0000, 0x016B, 0x012B,
    /* x18 - x1F */    0x00F5, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0101, 0x0161,
    /* x20 - x27 */    0x0000, 0x0000, 0x0123, 0x0000, 0x0000, 0x0137, 0x013C, 0x0000,
    /* x28 - x2F */    0x00B4, 0x00AD, 0x0000, 0x0000, 0x017E, 0x0000, 0x010D, 0x0000,
    /* x30 - x37 */    0x0000, 0x0146, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x00A7, 0x00B0, 0x0000,
    /* x08 - x0F */    0x00B1, 0x00D7, 0x0000, 0x0000, 0x2014, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0112, 0x0156, 0x0000, 0x0000, 0x016A, 0x012A,
    /* x18 - x1F */    0x00D5, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0100, 0x0160,
    /* x20 - x27 */    0x0000, 0x0000, 0x0122, 0x0000, 0x0000, 0x0136, 0x013B, 0x0000,
    /* x28 - x2F */    0x00A8, 0x0000, 0x0000, 0x0000, 0x017D, 0x0000, 0x010C, 0x0000,
    /* x30 - x37 */    0x0000, 0x0145, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x00b4, 0x28, 13, { {0x007a, 0x017a}  // 'z' = 'ź'
                        , {0x006f, 0x00f3}  // 'o' = 'ó'
                        , {0x0020, 0x00b4}  // ' ' = '´'
                        , {0x006e, 0x0144}  // 'n' = 'ń'
                        , {0x0053, 0x015a}  // 'S' = 'Ś'
    ...
    { 0x00b0, 0x2b,  8, { {0x007a, 0x017c}  // 'z' = 'ż'
                        , {0x0020, 0x00b0}  // ' ' = '°'
                        , {0x0041, 0x00c5}  // 'A' = 'Å'
                        , {0x0045, 0x0116}  // 'E' = 'Ė'
                        , {0x0067, 0x0121}  // 'g' = 'ġ'
...
static const Keylayout keylayout_x00010426( x00010426::LCID
                                          ...
                                          , x00010426::shift
                                          , x00010426::altGr
                                          , x00010426::shiftAltGr
                                          , x00010426::ctrl
                                          , x00010426::capslock_noMod
                                          , x00010426::capslock_shift
                                          , x00010426::capslock_altGr
                                          , x00010426::capslock_shiftAltGr
                                          , x00010426::deadkeys
