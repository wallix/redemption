...
#if !defined(__KEYLAYOUT_X0001080C_HPP__)
#define __KEYLAYOUT_X0001080C_HPP__

#include "keylayout.hpp"

namespace x0001080c {    // French (Belgium)

const static int LCID = 0x0001080c;

const Keylayout::KeyLayout_t noMod = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x0026, 0x00E9, 0x0022, 0x0027, 0x0028, 0x00A7,
    /* x10 - x17 */    0x00E8, 0x0021, 0x00E7, 0x00E0, 0x0029, 0x002D, 0x0008, 0x0009,
    /* x18 - x1F */       'a',    'z',    'e',    'r',    't',    'y',    'u',    'i',
    /* x20 - x27 */       'o',    'p', 0x005E, 0x0024, 0x000D, 0x0000,    'q',    's',
    /* x28 - x2F */       'd',    'f',    'g',    'h',    'j',    'k',    'l',    'm',
    /* x30 - x37 */    0x00F9, 0x00B2, 0x0000, 0x00B5,    'w',    'x',    'c',    'v',
    /* x38 - x3F */       'b',    'n', 0x002C, 0x003B, 0x003A, 0x003D, 0x0000, 0x002A,
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x10 - x17 */       '7',    '8',    '9',    '0', 0x00B0, 0x005F, 0x0008, 0x0000,
    /* x18 - x1F */       'A',    'Z',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x20 - x27 */       'O',    'P', 0x00A8, 0x002A, 0x000D, 0x0000,    'Q',    'S',
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L',    'M',
    /* x30 - x37 */    0x0025, 0x00B3, 0x0000, 0x00A3,    'W',    'X',    'C',    'V',
    /* x38 - x3F */       'B',    'N', 0x003F, 0x002E, 0x002F, 0x002B, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x007C, 0x0040, 0x0023, 0x007B, 0x005B, 0x005E,
    /* x10 - x17 */    0x0000, 0x0000, 0x007B, 0x007D, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x18 - x1F */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x005B, 0x005D, 0x000D, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x10 - x17 */       '7',    '8',    '9',    '0', 0x00B0, 0x005F, 0x0008, 0x0009,
    /* x18 - x1F */       'A',    'Z',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x20 - x27 */       'O',    'P', 0x00A8, 0x002A, 0x000D, 0x0000,    'Q',    'S',
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L',    'M',
    /* x30 - x37 */    0x0025, 0x00B2, 0x0000, 0x00A3,    'W',    'X',    'C',    'V',
    /* x38 - x3F */       'B',    'N', 0x003F, 0x002E, 0x002F, 0x002B, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x002D, 0x0000, 0x0000, 0x0000, 0x002B, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x20 - x27 */       'o',    'p', 0x005E, 0x0024, 0x000D, 0x0000,    'q',    's',
    /* x28 - x2F */       'd',    'f',    'g',    'h',    'j',    'k',    'l',    'm',
    /* x30 - x37 */    0x00F9, 0x00B3, 0x0000, 0x00B5,    'w',    'x',    'c',    'v',
    /* x38 - x3F */       'b',    'n', 0x002C, 0x003B, 0x003A, 0x003D, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x002D, 0x0000, 0x0000, 0x0000, 0x002B, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
      ...
      { 0x007e, 0x35,  7, { {0x006f, 0x00f5}  // 'o' = 'õ'
                          , {0x0020, 0x007e}  // ' ' = '~'
                          , {0x006e, 0x00f1}  // 'n' = 'ñ'
                          , {0x0041, 0x00c3}  // 'A' = 'Ã'
                          , {0x0061, 0x00e3}  // 'a' = 'ã'
...
} // END NAMESPACE - x0001080c

static const Keylayout keylayout_x0001080c( x0001080c::LCID
                                          , x0001080c::noMod
                                          , x0001080c::shift
                                          , x0001080c::altGr
                                          , x0001080c::shiftAltGr
                                          , x0001080c::ctrl
                                          , x0001080c::capslock_noMod
                                          , x0001080c::capslock_shift
                                          , x0001080c::capslock_altGr
                                          , x0001080c::capslock_shiftAltGr
                                          , x0001080c::deadkeys
);
