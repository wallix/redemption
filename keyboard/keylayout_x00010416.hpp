...
#if !defined(__KEYLAYOUT_X00010416_HPP__)
#define __KEYLAYOUT_X00010416_HPP__

#include "keylayout.hpp"

namespace x00010416 {    // Portuguese (Brazil) // Portuguese (Brazilian ABNT2)

const static int LCID = 0x00010416;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */       'o',    'p', 0x00B4, 0x005B, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E7,
    /* x28 - x2F */    0x007E, 0x0027, 0x0000, 0x005D,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x002C, 0x002E, 0x003B, 0x0000,    '*',
    ...
    /* x70 - x77 */    0x0000, 0x0000, 0x0000, 0x002F, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x78 - x7F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x002E, 0x0000,
};

const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0040, 0x0023, 0x0024, 0x0025, 0x00A8,
    /* x08 - x0F */    0x0026, 0x002A, 0x0028, 0x0029, 0x005F, 0x002B, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x0060, 0x007B, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C7,
    /* x28 - x2F */    0x005E, 0x0022, 0x0000, 0x007D,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x003C, 0x003E, 0x003A, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    ...
    /* x68 - x6F */       '/', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x70 - x77 */    0x0000, 0x0000, 0x0000, 0x003F, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x78 - x7F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x002E, 0x0000,
};

const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00B9, 0x00B2, 0x00B3, 0x00A3, 0x00A2, 0x00AC,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00A7, 0x0008, 0x0009,
    /* x10 - x17 */    0x002F, 0x003F, 0x00B0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x00AA, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x00BA, 0x0000, 0x0000, 0x20A2, 0x0000,
    ...
    /* x60 - x67 */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x68 - x6F */       '/', 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x70 - x77 */    0x0000, 0x0000, 0x0000, 0x00B0, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x00a8, 0x07, 12, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0020, 0x00a8}  // ' ' = '¨'
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0045, 0x00cb}  // 'E' = 'Ë'
    ...
    { 0x00b4, 0x1a, 13, { {0x006f, 0x00f3}  // 'o' = 'ó'
                        , {0x0049, 0x00cd}  // 'I' = 'Í'
                        , {0x0059, 0x00dd}  // 'Y' = 'Ý'
                        , {0x0041, 0x00c1}  // 'A' = 'Á'
                        , {0x0045, 0x00c9}  // 'E' = 'É'
    ...
    { 0x007e, 0x28,  7, { {0x006f, 0x00f5}  // 'o' = 'õ'
                        , {0x0020, 0x007e}  // ' ' = '~'
                        , {0x006e, 0x00f1}  // 'n' = 'ñ'
                        , {0x0041, 0x00c3}  // 'A' = 'Ã'
                        , {0x0061, 0x00e3}  // 'a' = 'ã'
...
} // END NAMESPACE - x00010416

static const Keylayout keylayout_x00010416( x00010416::LCID
                                          , x00010416::noMod
                                          , x00010416::shift
                                          , x00010416::altGr
                                          , x00010416::shiftAltGr
                                          , x00010416::ctrl
                                          , x00010416::capslock_noMod
                                          , x00010416::capslock_shift
                                          , x00010416::capslock_altGr
                                          , x00010416::capslock_shiftAltGr
                                          , x00010416::deadkeys
                                          , x00010416::nbDeadkeys
);
