...
#if !defined(__KEYLAYOUT_X00020405_HPP__)
#define __KEYLAYOUT_X00020405_HPP__
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x18 - x1F */    0x0000, 0x0000, 0x00FA, 0x0029, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x016F,
    /* x28 - x2F */    0x00A7, 0x003B, 0x0000, 0x00A8, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x003F, 0x003A, 0x002D, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x18 - x1F */    0x0000, 0x0000, 0x002F, 0x0028, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0022,
    /* x28 - x2F */    0x0021, 0x00B0, 0x0000, 0x005E, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x00D7, 0x00F7, 0x005F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x00020405( x00020405::LCID
                                          ...
                                          , x00020405::shift
                                          , x00020405::altGr
                                          , x00020405::shiftAltGr
                                          , x00020405::ctrl
                                          , x00020405::capslock_noMod
                                          , x00020405::capslock_shift
                                          , x00020405::capslock_altGr
                                          , x00020405::capslock_shiftAltGr
                                          , x00020405::deadkeys
