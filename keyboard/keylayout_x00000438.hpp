...
#if !defined(__KEYLAYOUT_X00000438_HPP__)
#define __KEYLAYOUT_X00000438_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */       'o',    'p', 0x00E5, 0x00F0, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E6,
    /* x28 - x2F */    0x00F8, 0x00BD, 0x0000, 0x0027,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00C5, 0x00D0, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C6,
    /* x28 - x2F */    0x00D8, 0x00A7, 0x0000, 0x002A,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x08 - x0F */    0x007B, 0x005B, 0x005D, 0x007D, 0x0000, 0x007C, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x00A8, 0x007E, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x005E, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x18 - x1F */       'O',    'P', 0x00C5, 0x00D0, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C6,
    /* x28 - x2F */    0x00D8, 0x00BD, 0x0000, 0x0027,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x002C, 0x002E, 0x002D, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x18 - x1F */       'o',    'p', 0x00E5, 0x00F0, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E6,
    /* x28 - x2F */    0x00F8, 0x00A7, 0x0000, 0x002A,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x003B, 0x003A, 0x005F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x00000438( x00000438::LCID
                                          ...
                                          , x00000438::shift
                                          , x00000438::altGr
                                          , x00000438::shiftAltGr
                                          , x00000438::ctrl
                                          , x00000438::capslock_noMod
                                          , x00000438::capslock_shift
                                          , x00000438::capslock_altGr
                                          , x00000438::capslock_shiftAltGr
                                          , x00000438::deadkeys
                                          , x00000438::nbDeadkeys
);
