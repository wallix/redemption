...
#if !defined(__KEYLAYOUT_X00030408_HPP__)
#define __KEYLAYOUT_X00030408_HPP__

#include "keylayout.hpp"

namespace x00030408 {    // Greek (Greece) // Greek (220) Latin

const static int LCID = 0x00030408;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */       'o',    'p', 0x002B, 0x007D, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x0384,
    /* x28 - x2F */    0x00A8, 0x005C, 0x0000, 0x0023,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x002A, 0x007B, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00A8,
    /* x28 - x2F */    0x0385, 0x007C, 0x0000, 0x0040,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x28 - x2F */    0x0385, 0x0000, 0x0000, 0x00AC, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x0384, 0x27,  1, { {0x0020, 0x0384}  // ' ' = '΄'
                        }
    },
    { 0x00a8, 0x27,  1, { {0x0020, 0x00a8}  // ' ' = '¨'
                        }
    },
    { 0x0385, 0x28,  1, { {0x0020, 0x0385}  // ' ' = '΅'
                        }
    },
};
...
} // END NAMESPACE - x00030408

static const Keylayout keylayout_x00030408( x00030408::LCID
                                          , x00030408::noMod
                                          , x00030408::shift
                                          , x00030408::altGr
                                          , x00030408::shiftAltGr
                                          , x00030408::ctrl
                                          , x00030408::capslock_noMod
                                          , x00030408::capslock_shift
                                          , x00030408::capslock_altGr
                                          , x00030408::capslock_shiftAltGr
                                          , x00030408::deadkeys
                                          , x00030408::nbDeadkeys
);
