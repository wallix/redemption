...
#if !defined(__KEYLAYOUT_X00001809_HPP__)
#define __KEYLAYOUT_X00001809_HPP__

#include "keylayout.hpp"

namespace x00001809 {    // English (Ireland) // Irish

const static int LCID = 0x00001809;
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x20AC, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x00E9, 0x0000, 0x0000, 0x0000, 0x00FA, 0x00ED,
    ...
    /* x28 - x2F */    0x00B4, 0x00A6, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x00C9, 0x0000, 0x0000, 0x0000, 0x00DA, 0x00CD,
    /* x18 - x1F */    0x00D3, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00C1, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0060, 0x00A6, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
} // END NAMESPACE - x00001809

static const Keylayout keylayout_x00001809( x00001809::LCID
                                          , x00001809::noMod
                                          , x00001809::shift
                                          , x00001809::altGr
                                          , x00001809::shiftAltGr
                                          , x00001809::ctrl
                                          , x00001809::capslock_noMod
                                          , x00001809::capslock_shift
                                          , x00001809::capslock_altGr
                                          , x00001809::capslock_shiftAltGr
                                          , x00001809::deadkeys
                                          , x00001809::nbDeadkeys
);
