...
#if !defined(__KEYLAYOUT_X0000041F_HPP__)
#define __KEYLAYOUT_X0000041F_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x002A, 0x002D, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u', 0x0131,
    /* x18 - x1F */       'o',    'p', 0x011F, 0x00FC, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x015F,
    /* x28 - x2F */       'i', 0x0022, 0x0000, 0x002C,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x00F6, 0x00E7, 0x002E, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0027, 0x005E, 0x002B, 0x0025, 0x0026,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x005F, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x011E, 0x00DC, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x015E,
    /* x28 - x2F */    0x0130, 0x00E9, 0x0000, 0x003B,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x00D6, 0x00C7, 0x003A, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x003E, 0x00A3, 0x0023, 0x0024, 0x00BD, 0x0000,
    /* x08 - x0F */    0x007B, 0x005B, 0x005D, 0x007D, 0x005C, 0x007C, 0x0008, 0x0009,
    /* x10 - x17 */    0x0040, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000,    'i',
    /* x18 - x1F */    0x0000, 0x0000, 0x00A8, 0x007E, 0x000D, 0x0000, 0x00E6, 0x00DF,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x003C, 0x0000, 0x0060, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0130,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00C6, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x18 - x1F */       'O',    'P', 0x011E, 0x00DC, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x015E,
    /* x28 - x2F */    0x0130, 0x0022, 0x0000, 0x002C,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x00D6, 0x00C7, 0x002E, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0027, 0x005E, 0x002B, 0x0025, 0x0026,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x005F, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u', 0x0131,
    /* x18 - x1F */       'o',    'p', 0x011F, 0x00FC, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x015F,
    /* x28 - x2F */       'i', 0x00E9, 0x0000, 0x003B,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x00F6, 0x00E7, 0x003A, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002C, 0x0000, 0x0000, 0x003E, 0x0000,
...
const Keylayout::KeyLayout_t capslock_altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x003E, 0x00A3, 0x0023, 0x0024, 0x00BD, 0x0000,
    /* x08 - x0F */    0x007B, 0x005B, 0x005D, 0x007D, 0x005C, 0x007C, 0x0008, 0x0009,
    /* x10 - x17 */    0x0040, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0130,
    /* x18 - x1F */    0x0000, 0x0000, 0x00A8, 0x007E, 0x000D, 0x0000, 0x00C6, 0x00DF,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x003C, 0x0000, 0x0060, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    'i',
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00E6, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    ...
    { 0x00a8, 0x1a, 13, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0020, 0x00a8}  // ' ' = '¨'
                        , {0x0130, 0x00cf}  // 'İ' = 'Ï'
                        , {0x0131, 0x00ef}  // 'ı' = 'ï'
...
static const Keylayout keylayout_x0000041f( x0000041f::LCID
                                          ...
                                          , x0000041f::shift
                                          , x0000041f::altGr
                                          , x0000041f::shiftAltGr
                                          , x0000041f::ctrl
                                          , x0000041f::capslock_noMod
                                          , x0000041f::capslock_shift
                                          , x0000041f::capslock_altGr
                                          , x0000041f::capslock_shiftAltGr
                                          , x0000041f::deadkeys
                                          , x0000041f::nbDeadkeys
);
