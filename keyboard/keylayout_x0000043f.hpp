...
#if !defined(__KEYLAYOUT_X0000043F_HPP__)
#define __KEYLAYOUT_X0000043F_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */    0x002E, 0x04AF, 0x04B1, 0x049B, 0x04E9, 0x04BB, 0x0008, 0x0009,
    /* x10 - x17 */    0x0439, 0x0446, 0x0443, 0x043A, 0x0435, 0x043D, 0x0433, 0x0448,
    /* x18 - x1F */    0x0449, 0x0437, 0x0445, 0x044A, 0x000D, 0x0000, 0x0444, 0x044B,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x044D, 0x0028, 0x0000, 0x005C, 0x044F, 0x0447, 0x0441, 0x043C,
    /* x30 - x37 */    0x0438, 0x0442, 0x044C, 0x0431, 0x044E, 0x2116, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x04D8, 0x0406, 0x04A2, 0x0492, 0x003B,
    /* x08 - x0F */    0x003A, 0x04AE, 0x04B0, 0x049A, 0x04E8, 0x04BA, 0x0008, 0x0000,
    /* x10 - x17 */    0x0419, 0x0426, 0x0423, 0x041A, 0x0415, 0x041D, 0x0413, 0x0428,
    /* x18 - x1F */    0x0429, 0x0417, 0x0425, 0x042A, 0x000D, 0x0000, 0x0424, 0x042B,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x042D, 0x0029, 0x0000, 0x002F, 0x042F, 0x0427, 0x0421, 0x041C,
    /* x30 - x37 */    0x0418, 0x0422, 0x042C, 0x0411, 0x042E, 0x003F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0022, 0x04D8, 0x0406, 0x04A2, 0x0492, 0x002C,
    /* x08 - x0F */    0x002E, 0x04AE, 0x04B0, 0x049A, 0x04E8, 0x04BA, 0x0008, 0x0009,
    /* x10 - x17 */    0x0419, 0x0426, 0x0423, 0x041A, 0x0415, 0x041D, 0x0413, 0x0428,
    /* x18 - x1F */    0x0429, 0x0417, 0x0425, 0x042A, 0x000D, 0x0000, 0x0424, 0x042B,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x042D, 0x0028, 0x0000, 0x005C, 0x042F, 0x0427, 0x0421, 0x041C,
    /* x30 - x37 */    0x0418, 0x0422, 0x042C, 0x0411, 0x042E, 0x2116, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002C, 0x0000, 0x0000, 0x007C, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x04D9, 0x0456, 0x04A3, 0x0493, 0x003B,
    /* x08 - x0F */    0x003A, 0x04AF, 0x04B1, 0x049B, 0x04E9, 0x04BB, 0x0008, 0x0009,
    /* x10 - x17 */    0x0439, 0x0446, 0x0443, 0x043A, 0x0435, 0x043D, 0x0433, 0x0448,
    /* x18 - x1F */    0x0449, 0x0437, 0x0445, 0x044A, 0x000D, 0x0000, 0x0444, 0x044B,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x044D, 0x0029, 0x0000, 0x002F, 0x044F, 0x0447, 0x0441, 0x043C,
    /* x30 - x37 */    0x0438, 0x0442, 0x044C, 0x0431, 0x044E, 0x003F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x0000043f( x0000043f::LCID
                                          ...
                                          , x0000043f::shift
                                          , x0000043f::altGr
                                          , x0000043f::shiftAltGr
                                          , x0000043f::ctrl
                                          , x0000043f::capslock_noMod
                                          , x0000043f::capslock_shift
                                          , x0000043f::capslock_altGr
                                          , x0000043f::capslock_shiftAltGr
                                          , x0000043f::deadkeys
                                          , x0000043f::nbDeadkeys
);
