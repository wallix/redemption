...
#if !defined(__KEYLAYOUT_X00000427_HPP__)
#define __KEYLAYOUT_X00000427_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */    0x002E, 0x003F, 0x0028, 0x0029, 0x005F, 0x002B, 0x0008, 0x0009,
    /* x10 - x17 */    0x0105, 0x017E,    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x012F, 0x201C, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x0173,
    /* x28 - x2F */    0x0117, 0x0060, 0x0000, 0x007C,    'z', 0x016B,    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x010D, 0x0161, 0x0119, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x002D, 0x003D, 0x0008, 0x0000,
    /* x10 - x17 */    0x0104, 0x017D,    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x012E, 0x201D, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x0172,
    /* x28 - x2F */    0x0116, 0x007E, 0x0000, 0x005C,    'Z', 0x016A,    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x010C, 0x0160, 0x0118, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x08 - x0F */    0x002E, 0x003F, 0x0028, 0x0029, 0x005F, 0x002B, 0x0008, 0x0009,
    /* x10 - x17 */    0x0104, 0x017D,    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x012E, 0x201C, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x0172,
    /* x28 - x2F */    0x0116, 0x0060, 0x0000, 0x007C,    'Z', 0x016A,    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x010C, 0x0160, 0x0118, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x10 - x17 */    0x0105, 0x017E,    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x012F, 0x201D, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x0173,
    /* x28 - x2F */    0x0117, 0x007E, 0x0000, 0x005C,    'z', 0x016B,    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x010D, 0x0161, 0x0119, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x00000427( x00000427::LCID
                                          ...
                                          , x00000427::shift
                                          , x00000427::altGr
                                          , x00000427::shiftAltGr
                                          , x00000427::ctrl
                                          , x00000427::capslock_noMod
                                          , x00000427::capslock_shift
                                          , x00000427::capslock_altGr
                                          , x00000427::capslock_shiftAltGr
                                          , x00000427::deadkeys
                                          , x00000427::nbDeadkeys
);
