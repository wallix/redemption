...
namespace x00000816 {    // Portuguese (Portugal) // Portuguese

const static int LCID = 0x00000816;

const Keylayout::KeyLayout_t noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x0027, 0x00AB, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x002B, 0x00B4, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E7,
    /* x28 - x2F */    0x00BA, 0x005C, 0x0000, 0x007E,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x00BB, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x002A, 0x0060, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C7,
    /* x28 - x2F */    0x00AA, 0x007C, 0x0000, 0x005E,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0040, 0x00A3, 0x00A7, 0x20AC, 0x0000,
    ...
    /* x18 - x1F */    0x0000, 0x0000, 0x00A8, 0x005D, 0x000D, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x00BB, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x002A, 0x0060, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E7,
    /* x28 - x2F */    0x00AA, 0x007C, 0x0000, 0x005E,    'z',    'x',    'c',    'v',
