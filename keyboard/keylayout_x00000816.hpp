...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x0000, 0x0040, 0x00A3, 0x00A7, 0x20AC, 0x0000,
    /* x10 - x17 */    0x007B, 0x005B, 0x005D, 0x007D, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x18 - x1F */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x00A8, 0x005D, 0x000D, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
      ...
      { 0x00b4, 0x1b, 13, { {0x006f, 0x00f3}  // 'o' = 'ó'
                          , {0x0049, 0x00cd}  // 'I' = 'Í'
                          , {0x0059, 0x00dd}  // 'Y' = 'Ý'
                          , {0x0041, 0x00c1}  // 'A' = 'Á'
                          , {0x0045, 0x00c9}  // 'E' = 'É'
      ...
      { 0x005e, 0x2b, 11, { {0x006f, 0x00f4}  // 'o' = 'ô'
                          , {0x0049, 0x00ce}  // 'I' = 'Î'
                          , {0x0020, 0x005e}  // ' ' = '^'
                          , {0x0041, 0x00c2}  // 'A' = 'Â'
                          , {0x0045, 0x00ca}  // 'E' = 'Ê'
...
static const Keylayout keylayout_x00000816( x00000816::LCID
                                          ...
                                          , x00000816::ctrl
                                          , x00000816::capslock_noMod
                                          , x00000816::capslock_shift
                                          , x00000816::capslock_altGr
                                          , x00000816::capslock_shiftAltGr
                                          , x00000816::deadkeys
);
