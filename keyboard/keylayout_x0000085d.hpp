...
#if !defined(__KEYLAYOUT_X0000085D_HPP__)
#define __KEYLAYOUT_X0000085D_HPP__
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x014B,
    /* x28 - x2F */    0x0142, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x28 - x2F */    0x0141, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x0000085d( x0000085d::LCID
                                          ...
                                          , x0000085d::shift
                                          , x0000085d::altGr
                                          , x0000085d::shiftAltGr
                                          , x0000085d::ctrl
                                          , x0000085d::capslock_noMod
                                          , x0000085d::capslock_shift
                                          , x0000085d::capslock_altGr
                                          , x0000085d::capslock_shiftAltGr
                                          , x0000085d::deadkeys
                                          , x0000085d::nbDeadkeys
);
