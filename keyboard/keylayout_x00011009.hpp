...
#if !defined(__KEYLAYOUT_X00011009_HPP__)
#define __KEYLAYOUT_X00011009_HPP__

#include "keylayout.hpp"

namespace x00011009 {    // English (Canada)
...
const Keylayout::KeyLayout_t noshift = {
    ...
    /* x30 - x37 */    0x00E8, 0x002F, 0x0000, 0x00E0,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x0021, 0x0040, 0x0023, 0x0024, 0x0025, 0x003F,
    /* x10 - x17 */    0x0026, 0x002A, 0x0028, 0x0029, 0x005F, 0x002B, 0x0008, 0x0000,
    /* x18 - x1F */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x20 - x27 */       'O',    'P', 0x00A8, 0x00C7, 0x000D, 0x0000,    'A',    'S',
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x003A,
    /* x30 - x37 */    0x00C8, 0x005C, 0x0000, 0x00C0,    'Z',    'X',    'C',    'V',
    /* x38 - x3F */       'B',    'N',    'M', 0x0027, 0x0022, 0x00C9, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altgr = {
    /* x00 - x07 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x001B, 0x00B1, 0x0040, 0x00A3, 0x00A4, 0x00A4, 0x00AC,
    /* x10 - x17 */    0x007B, 0x007D, 0x005B, 0x005D, 0x00BD, 0x00AC, 0x0008, 0x0009,
    /* x18 - x1F */    0x0000, 0x0000, 0x20AC, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x00A7, 0x00B6, 0x0060, 0x007E, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B0,
    /* x30 - x37 */    0x007B, 0x007C, 0x0000, 0x007D, 0x00AB, 0x00BB, 0x0000, 0x0000,
    /* x38 - x3F */    0x0000, 0x0000, 0x00B5, 0x003C, 0x003E, 0x00B4, 0x0000, 0x002A,
...
const Keylayout::KeyLayout_t capslock = {
    ...
    /* x28 - x2F */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x003B,
    /* x30 - x37 */    0x00C8, 0x002F, 0x0000, 0x00C0,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t shiftcapslock = {
    ...
    /* x18 - x1F */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x20 - x27 */       'o',    'p', 0x00A8, 0x00E7, 0x000D, 0x0000,    'a',    's',
    /* x28 - x2F */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x003A,
    /* x30 - x37 */    0x00E8, 0x005C, 0x0000, 0x00E0,    'z',    'x',    'c',    'v',
    /* x38 - x3F */       'b',    'n',    'm', 0x0027, 0x0022, 0x00E9, 0x0000, 0x002A,
    /* x40 - x47 */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x002D, 0x0000, 0x0000, 0x0000, 0x002B, 0x0000,
