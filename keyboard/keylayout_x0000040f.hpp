...
#if !defined(__KEYLAYOUT_X0000040F_HPP__)
#define __KEYLAYOUT_X0000040F_HPP__
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x00F6, 0x002D, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00F0, 0x0027, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E6,
    /* x28 - x2F */    0x00B4, 0x00B0, 0x0000, 0x002B,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x002C, 0x002E, 0x00FE, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x00D6, 0x005F, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00D0, 0x003F, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C6,
    /* x28 - x2F */    0x0027, 0x00A8, 0x0000, 0x002A,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x003B, 0x003A, 0x00DE, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x28 - x2F */    0x005E, 0x00B0, 0x0000, 0x0060, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x00D6, 0x002D, 0x0008, 0x0009,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00D0, 0x0027, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00C6,
    /* x28 - x2F */    0x00B4, 0x00B0, 0x0000, 0x002B,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x002C, 0x002E, 0x00DE, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x00F6, 0x005F, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00F0, 0x003F, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00E6,
    /* x28 - x2F */    0x0027, 0x00A8, 0x0000, 0x002A,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x003B, 0x003A, 0x00FE, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002C, 0x0000, 0x0000, 0x003E, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    ...
    { 0x00b0, 0x29,  3, { {0x0041, 0x00c5}  // 'A' = 'Å'
                        , {0x0020, 0x00b0}  // ' ' = '°'
                        , {0x0061, 0x00e5}  // 'a' = 'å'
                        }
    },
    { 0x00a8, 0x29, 12, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0020, 0x00a8}  // ' ' = '¨'
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0045, 0x00cb}  // 'E' = 'Ë'
...
static const Keylayout keylayout_x0000040f( x0000040f::LCID
                                          ...
                                          , x0000040f::shift
                                          , x0000040f::altGr
                                          , x0000040f::shiftAltGr
                                          , x0000040f::ctrl
                                          , x0000040f::capslock_noMod
                                          , x0000040f::capslock_shift
                                          , x0000040f::capslock_altGr
                                          , x0000040f::capslock_shiftAltGr
                                          , x0000040f::deadkeys
                                          , x0000040f::nbDeadkeys
);
