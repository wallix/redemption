                    ...
                    case RdpNego::NEGO_STATE_FINAL:
                        {
                            ...
                            LOG(LOG_INFO, "NLA ENABLE : %u",
                                this->nego.enabled_protocols & RdpNego::PROTOCOL_NLA);
                            if (this->nego.enabled_protocols & RdpNego::PROTOCOL_NLA) {
                            // -------- TEST NLA
                                LOG(LOG_INFO, "NLA SPECIAL CLIENT CORE DATA SEND");
                                const char cscore[] = {
// Client Core Data
/* 0000 */ "\x01\xc0\xd8\x00\x04\x00\x08\x00\x80\x07\xdb\x03\x01\xca\x03\xaa" //................
/* 0010 */ "\x09\x04\x00\x00\xb0\x1d\x00\x00\x6d\x00\x74\x00\x61\x00\x00\x00" //........m.t.a...
...
/* 0080 */ "\x00\x00\x00\x00\x01\xca\x01\x00\x00\x00\x00\x00\x18\x00\x0f\x00" //................
/* 0090 */ "\x2f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" ///...............
...
/* 00d0 */ "\x00\x00\x02\x00\x02\x00\x00\x00"                                 //........
                                };
                                stream.out_copy_bytes(cscore, sizeof(cscore) - 1);
                                stream.mark_end();
                                LOG(LOG_INFO, "CS CORE offset : %u", stream.size());
                            }
                            else {
                                LOG(LOG_INFO, "NORMAL CLIENT CORE DATA SEND");
                                cs_core.emit(stream);
                                LOG(LOG_INFO, "CS CORE offset : %u", stream.size());
                            }
                            // ------------------------------------------------------------
                            ...
                            const char tosend[] = {
// x224 DT_TPDU - tpktHeader + x224Data
/*0000*/ "\x03\x00\x01\xac\x02\xf0\x80"

// mcsCi - MCS Connect Initial
"\x7f\x65\x82\x01\xa0\x04\x01\x01\x04" // ........e.......
...
/*0060*/ "\x01\x01\x02\x02\xff\xff\x02\x01\x02\x04\x82\x01\x3f"

// GCC Create Request
"\x00\x05\x00" // ............?...
/*0070*/ "\x14\x7c\x00\x01\x81\x36\x00\x08\x00\x10\x00\x01\xc0\x00\x44\x75" // .|...6........Du
/*0080*/ "\x63\x61\x81\x28"
...
// Client Cluster Data
"\x04\xc0\x0c\x00" // ................
/*0160*/ "\x11\x00\x00\x00\x00\x00\x00\x00"

// Client Security Data
"\x02\xc0\x0c\x00\x1b\x00\x00\x00" // ................
/*0170*/ "\x00\x00\x00\x00"

// Client Network data
"\x03\xc0\x38\x00\x04\x00\x00\x00\x72\x64\x70\x64" // ......8.....rdpd
/*0180*/ "\x72\x00\x00\x00\x00\x00\x80\x80\x72\x64\x70\x73\x6e\x64\x00\x00" // r.......rdpsnd..
/*0190*/ "\x00\x00\x00\xc0\x64\x72\x64\x79\x6e\x76\x63\x00\x00\x00\x80\xc0" // ....drdynvc.....
/*01a0*/ "\x63\x6c\x69\x70\x72\x64\x72\x00\x00\x00\xa0\xc0"                 // cliprdr.....
...
/* 0080 */ "\xc0\x00\x44\x75\x63\x61\x80\xf0"
...
// Client Cluster Data
/* 0160 */ "\x04\xc0\x0c\x00\x0d\x00\x00\x00\x00\x00\x00\x00"
// Client Security Data
"\x02\xc0\x0c\x00" //................
/* 0170 */ "\x03\x00\x00\x00\x00\x00\x00\x00"                                 //........
                            };
                            (void)tosend;
                            // this->nego.trans->send(tosend, sizeof(tosend));
