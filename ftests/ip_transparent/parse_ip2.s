	...
	.align 2
	.p2align 4,,15
	.type	_ZN10LineBuffer9get_spaceEv.constprop.8, @function
_ZN10LineBuffer9get_spaceEv.constprop.8:
.LFB1130:
	.cfi_startproc
	pushl	%edi
...
.L2:
	...
	.cfi_endproc
.LFE1130:
	.size	_ZN10LineBuffer9get_spaceEv.constprop.8, .-_ZN10LineBuffer9get_spaceEv.constprop.8
...
.LC15:
	...
	.text
	.p2align 4,,15
	.type	_ZL18parse_ip_conntrackiPKcS0_iiPcij.isra.5.constprop.6, @function
_ZL18parse_ip_conntrackiPKcS0_iiPcij.isra.5.constprop.6:
.LFB1132:
	.cfi_startproc
	pushl	%ebp
	.cfi_def_cfa_offset 8
...
.L335:
	movl	%ebx, %eax
	movl	%edi, 20584(%esp)
	call	_ZN10LineBuffer9get_spaceEv.constprop.8
	testl	%eax, %eax
	js	.L408
	cmpl	$15, %esi
	jg	.L409
...
.L429:
	...
	.cfi_endproc
.LFE1132:
	.size	_ZL18parse_ip_conntrackiPKcS0_iiPcij.isra.5.constprop.6, .-_ZL18parse_ip_conntrackiPKcS0_iiPcij.isra.5.constprop.6
	.section	.rodata.str1.1
.LC16:
...
.LFB1115:
	...
	movl	%eax, (%esp)
	movl	%ebx, %eax
	call	_ZL18parse_ip_conntrackiPKcS0_iiPcij.isra.5.constprop.6
	testl	%eax, %eax
	je	.L450
	movl	$.LC17, 4(%esp)
	movl	$_ZSt4cerr, (%esp)
