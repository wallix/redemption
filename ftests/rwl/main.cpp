...
class rwlparser : public state_machine_def<rwlparser>
{
public:
    rwlparser(rwl_target& target)
    : screen(target)
...
public:
    ...
    struct table_transition : boost::mpl::vector<
        ...
        //-+---------------+--------------+--------------+-------------+----------------+
        row< DefinedProp,   Dot,           DefinedLink,   Dot,          &p::not_action   >,
        row< DefinedProp,   TwoPoint,      ValueBlock,    TwoPoint,     &p::defined_prop >,
        //-+---------------+--------------+--------------+-------------+----------------+
        row< DefinedLink,   Identifier,    DefinedProp,   Identifier,   &p::prop_name    >,
        //-+---------------+--------------+--------------+-------------+----------------+
        ...
        //-+---------------+--------------+--------------+-------------+----------------+
        row< EndString,     Quote,         PropSep,       Quote,        &p::not_action   >,
        //-+---------------+--------------+--------------+-------------+----------------+
        row< PropOrFunc,    Dot,           LinkProp,      Dot,          &p::not_action   >,
        ...
        //-+---------------+--------------+--------------+-------------+----------------+
        row< Prop,          Dot,           LinkProp,      Dot,          &p::not_action   >,
        row< Prop,          MathOperator,  Value,         MathOperator, &p::math_operator>,
        row< Prop,          void,          PropSep,       void,         &p::not_action   >,
        //-+---------------+--------------+--------------+-------------+----------------+
        row< Expression,    MathOperator,  Value,         MathOperator, &p::math_operator>,
