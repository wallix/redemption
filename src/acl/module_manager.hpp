        ...
        case MODULE_RDP:
            {
                ...
                mod_rdp_params.enable_wab_agent                    = this->ini.get<cfg::globals::enable_session_probe>();
                mod_rdp_params.enable_wab_agent_loading_mask       = this->ini.get<cfg::globals::enable_session_probe_loading_mask>();
                mod_rdp_params.wab_agent_launch_timeout            = this->ini.get<cfg::globals::session_probe_launch_timeout>();
                mod_rdp_params.wab_agent_on_launch_failure         = this->ini.get<cfg::globals::session_probe_on_launch_failure>();
                mod_rdp_params.wab_agent_keepalive_timeout         = this->ini.get<cfg::globals::session_probe_keepalive_timeout>();
                mod_rdp_params.wab_agent_alternate_shell           = this->ini.get<cfg::globals::session_probe_alternate_shell>();
