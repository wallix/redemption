        ...
        case MODULE_RDP:
            {
                ...
                mod_rdp_params.disable_file_system_log_syslog      = bool(this->ini.get<cfg::video::disable_clipboard_log>() & configs::FileSystemLogFlags::syslog);
                mod_rdp_params.disable_file_system_log_wrm         = bool(this->ini.get<cfg::video::disable_clipboard_log>() & configs::FileSystemLogFlags::wrm);
