...
#ifndef REDEMPTION_GDI_ADAPTER_BASE_HPP
#define REDEMPTION_GDI_ADAPTER_BASE_HPP
...
struct AdapterBase : InterfaceBase, protected Proxy
{
    using proxy_type = Proxy;
    using interface_base = InterfaceBase;

    AdapterBase() = default;
    AdapterBase(AdapterBase const &) = delete;

    template<class... ProxyArgs>
    AdapterBase(ProxyArgs && ... args)
