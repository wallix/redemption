...
Rect clip_from_cmd(RDPOpaqueRect const & cmd) { return cmd.rect; }
Rect clip_from_cmd(RDP::RDPMultiScrBlt const & cmd) { return cmd.rect; }
Rect clip_from_cmd(RDP::RDPMultiPatBlt const & cmd) { return cmd.rect; }

Rect clip_from_cmd(RDPGlyphIndex const & cmd) { return cmd.bk; }

Rect clip_from_cmd(RDPEllipseSC const & cmd) { return cmd.el.get_rect(); }
Rect clip_from_cmd(RDPEllipseCB const & cmd) { return cmd.el.get_rect(); }
