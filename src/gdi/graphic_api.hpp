...
struct GraphicApi : private noncopyable
{
    ...
    virtual void draw(const RDP::RAIL::NewOrExistingWindow            &) = 0;
    virtual void draw(const RDP::RAIL::WindowIcon                     &) = 0;
    virtual void draw(const RDP::RAIL::CachedIcon                     &) = 0;
    virtual void draw(const RDP::RAIL::DeletedWindow                  &) = 0;
    virtual void draw(const RDP::RAIL::NewOrExistingNotificationIcons &) = 0;
    virtual void draw(const RDP::RAIL::DeletedNotificationIcons       &) = 0;
    virtual void draw(const RDP::RAIL::ActivelyMonitoredDesktop       &) = 0;
    virtual void draw(const RDP::RAIL::NonMonitoredDesktop            &) = 0;
