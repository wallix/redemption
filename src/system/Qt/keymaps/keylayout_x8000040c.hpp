#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_R_X8000040c_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_R_X8000040c_HPP_

#include "../src/system/Qt/keymaps/keylayout_r.hpp"

namespace x8000040c{ 

const static int LCID = 0x40c;

const static char * const locale_name = "fr-FR";
...
static const Keylayout_r keylayout_x8000040c( x8000040c::LCID
                                 , x8000040c::locale_name
                                 , x8000040c::noMod
                                 , x8000040c::shift
                                 , x8000040c::altGr
                                 , x8000040c::shiftAltGr
                                 , x8000040c::ctrl
                                 , x8000040c::capslock_noMod
                                 , x8000040c::capslock_shift
                                 , x8000040c::capslock_altGr
                                 , x8000040c::capslock_shiftAltGr
                                 , x8000040c::deadkeys
                                 , x8000040c::nbDeadkeys
