...
# define RED_CHECK_EQ(a, b) ::redemption_unit_test__::bool_((a) == (b))
# define RED_CHECK_NE(a, b) ::redemption_unit_test__::bool_((a) != (b))
# define RED_CHECK_LT(a, b) ::redemption_unit_test__::bool_((a) < (b))
# define RED_CHECK_LE(a, b) ::redemption_unit_test__::bool_((a) <= (b))
# define RED_CHECK_GT(a, b) ::redemption_unit_test__::bool_((a) > (b))
# define RED_CHECK_GE(a, b) ::redemption_unit_test__::bool_((a) >= (b))
# define RED_CHECK(a) ::redemption_unit_test__::bool_(a)
# define RED_CHECK_MESSAGE(a, iostream_expr) ::redemption_unit_test__::bool_(a), "" << iostream_expr
# define RED_CHECK_EQUAL_COLLECTIONS(a, b) ::redemption_unit_test__::bool_((a) == (b))
...
# define RED_REQUIRE_EXCEPTION(stmt, exception, predicate) do {\
    stmt; [](exception & e) { predicate(e); }; } while (0)
# define RED_REQUIRE_EQUAL(a, b) ::redemption_unit_test__::bool_((a) == (b))
# define RED_REQUIRE_EQ(a, b) ::redemption_unit_test__::bool_((a) == (b))
# define RED_REQUIRE_NE(a, b) ::redemption_unit_test__::bool_((a) != (b))
# define RED_REQUIRE_LT(a, b) ::redemption_unit_test__::bool_((a) < (b))
# define RED_REQUIRE_LE(a, b) ::redemption_unit_test__::bool_((a) <= (b))
# define RED_REQUIRE_GT(a, b) ::redemption_unit_test__::bool_((a) > (b))
# define RED_REQUIRE_GE(a, b) ::redemption_unit_test__::bool_((a) >= (b))
# define RED_REQUIRE(a) ::redemption_unit_test__::bool_(a)
# define RED_REQUIRE_MESSAGE(a, iostream_expr) ::redemption_unit_test__::bool_(a), "" << iostream_expr
# define RED_REQUIRE_EQUAL_COLLECTIONS(a, b) ::redemption_unit_test__::bool_((a) == (b))
