...
public:
    ...
    {
        auto * p = this->buf;
        this->trans->recv_new(p, this->in_stream.get_capacity());
    }
    ...
    void do_recv(uint8_t ** pbuffer, size_t len) override {
        ...
        while (total_len < len){
            ...
            case PARTIAL_IMAGE_CHUNK:
            {
                ...
                auto * p = header_buf;
                this->trans->recv_new(p, header_sz);
                ...
                p = this->buf;
                this->trans->recv_new(p, this->chunk_size - 8);
            }
            break;
            ...
            try {
                ...
                if (this->chunk_type != LAST_IMAGE_CHUNK && this->chunk_type != PARTIAL_IMAGE_CHUNK) {
                    ...
                    if (this->chunk_size - HEADER_SIZE > 0) {
                        ...
                        this->trans->recv_new(end, this->chunk_size - HEADER_SIZE);
                    }
                }
            }
            catch (Error & e){
