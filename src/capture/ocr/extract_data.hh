...
namespace ocr {
    ...
    static const unsigned bbox_max_height = std::max(fonts::max_height_font[0], fonts::max_height_font[1]) + 1u; /*NOLINT*/  // Height of title bars
    static const unsigned bbox_min_height = std::max(fonts::min_height_font[0], fonts::min_height_font[1]) + 1u; /*NOLINT*/
