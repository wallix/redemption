...
namespace detail
{
    ...
    {
        strncpy(log_proxy_psid, psid, sizeof(log_proxy_psid)-1);
        log_proxy_psid[sizeof(log_proxy_psid)-1] = '\0';
    ...
    {
        strncpy(log_proxy_username, username, sizeof(log_proxy_username)-1);
        log_proxy_username[sizeof(log_proxy_username)-1] = '\0';
    }
