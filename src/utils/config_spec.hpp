...
// @{
    ...
    class UnsignedField : BaseField {};
    class SignedField : BaseField {};
...
option_t<T> option(std::size_t default_index, T && a, Ts && ... args) {
    return {{std::forward<T>(a), std::forward<Ts>(args)...}, default_index};
}
...
void writer_config_spec(Writer && w)
{
    ...
    Attribute const G = Attribute::ghost;
    ...
    {
        w.field(type_<bool_>(), "capture_chunk");
        w.sep();
        w.field(type_<StringField>(), "auth_user", linked, attached, asked);
        w.field(type_<StringField>(), "host", linked, attached);
        w.field(type_<StringField>(), "target", linked, attached);
        w.field(type_<StringField>(), "target_device", linked, attached, asked);
        w.field(type_<StringField>(), "target_user", linked, attached, asked);
        ...
        w.sep();
        w.field(A, type_<bool_>(), "bitmap_cache", desc{"Support of Bitmap Cache."}, set(true));
        w.field(A, type_<bool_>(), "glyph_cache", set(false));
        w.field(A, type_<uint_>(), "port", set(3389));
        w.field(A, type_<bool_>(), "nomouse", set(false));
        w.field(A, type_<bool_>(), "notimestamp", set(false));
        w.field(A, type_<Level>(), "encryptionLevel", rdp_level_desc, set(0));
        w.field(A, type_<StaticIpString>(), "authip", set("127.0.0.1"));
        w.field(A, type_<uint_>(), "authport", set(3350));
        w.sep();
        w.field(V, type_<uint_>(), "session_timeout", desc{"No traffic auto disconnection (in seconds)."}, set(900));
        w.field(H, type_<uint_>(), "keepalive_grace_delay", desc{"Keepalive (in seconds)."}, set(30));
        w.field(A, type_<uint_>(), "close_timeout", desc{"Specifies the time to spend on the close box of proxy RDP before closing client window (0 to desactivate)."}, set(600));
        w.sep();
        w.field(V, type_<StaticNilString<8>>(), "auth_channel", set(null_fill()));
        w.field(A, type_<BoolField>(), "enable_file_encryption", attached);
        w.field(A, type_<StaticIpString>(), "listen_address", set("0.0.0.0"));
        w.field(IPT, type_<bool_>(), "enable_ip_transparent", desc{"Allow IP Transparent."}, set(false));
        ...
        w.sep();
        w.field(A, type_<StringField>(), "codec_id", attached, set("flv"));
        w.field(H, type_<BoolField>(), "movie", attached, set(false));
        w.field(A, type_<StringField>(), "movie_path", attached);
        w.field(A, type_<Level>(), "video_quality", rdp_level_desc, todo{"this could be some kind of enumeration"}, attached, set("medium"));
        w.field(A, type_<bool_>(), "enable_bitmap_update", desc{"Support of Bitmap Update."}, set(true));
        w.sep();
        w.field(V, type_<bool_>(), "enable_close_box", desc{"Show close screen."}, set(true));
        w.field(A, type_<bool_>(), "enable_osd", set(true));
        w.field(type_<bool_>(), "enable_osd_display_remote_target", set(true));
        w.sep();
        w.field(A, type_<BoolField>(), "enable_wab_agent", attached, set(false));
        w.field(A, type_<UnsignedField>(), "wab_agent_launch_timeout", attached, set(0));
        w.field(A, type_<UnsignedField>(), "wab_agent_keepalive_timeout", attached, set(0));
        w.sep();
        ...
        w.sep();
        w.field(H, type_<bool_>(), "disable_proxy_opt", set(false));
    ...
    w.start_section("client");
    {
        ...
        w.field(A, type_<bool_>(), "ignore_logon_password", desc{"If true, ignore password provided by RDP client, user need do login manually."}, set(false));
        w.sep();
        ...
        w.sep();
        w.field(V, type_<bool_>(), "tls_fallback_legacy", desc{"Fallback to RDP Legacy Encryption if client does not support TLS."}, set(true));
        w.field(V, type_<bool_>(), "tls_support", set(true));
        w.field(A, type_<bool_>(), "bogus_neg_request", desc{"Needed to connect with jrdp, based on bogus X224 layer code."}, set(false));
        w.field(A, type_<bool_>(), "bogus_user_id", desc{"Needed to connect with Remmina 0.8.3 and freerdp 0.9.4, based on bogus MCS layer code."}, set(true));
        w.sep();
        ...
        w.sep();
        w.field(A, type_<int_>(), "rdp_compression", rdp_compression_desc, set(4));
        w.sep();
        w.field(A, type_<uint32_>(), "max_color_depth", desc{
        ...
        w.sep();
        w.field(A, type_<bool_>(), "persistent_disk_bitmap_cache", desc{"Persistent Disk Bitmap Cache on the front side."}, set(false));
        w.field(A, type_<bool_>(), "cache_waiting_list", desc{"Support of Cache Waiting List (this value is ignored if Persistent Disk Bitmap Cache is disabled)."}, set(true));
        w.field(A, type_<bool_>(), "persist_bitmap_cache_on_disk", desc{"If enabled, the contents of Persistent Bitmap Caches are stored on disk."}, set(false));
        w.sep();
        w.field(A, type_<bool_>(), "bitmap_compression", desc{"Support of Bitmap Compression."}, set(true));
        w.sep();
        w.field(A, type_<bool_>(), "fast_path", desc{"Enables support of Clent Fast-Path Input Event PDUs."}, set(true));
    }
    w.stop_section();
    ...
    w.start_section("mod_rdp");
    {
        w.field(A, type_<int_>(), "rdp_compression", rdp_compression_desc, set(4));
        w.sep();
        w.field(A, type_<bool_>(), "disconnect_on_logon_user_change", set(false));
        w.sep();
        w.field(A, type_<uint32_>(), "open_session_timeout", set(0));
        w.sep();
        w.field(A, type_<uint_>(), "certificate_change_action", desc{
        ...
        w.sep();
        w.field(V, type_<bool_>(), "enable_nla", desc{"NLA authentication in secondary target."}, set(true));
        w.field(V, type_<bool_>(), "enable_kerberos", desc{
            "If enabled, NLA authentication will try Kerberos before NTLM.\n"
            "(if enable_nla is disabled, this value is ignored)."
        }, set(false));
        w.sep();
        w.field(A, type_<bool_>(), "persistent_disk_bitmap_cache", desc{"Persistent Disk Bitmap Cache on the mod side."}, set(false));
        w.field(A, type_<bool_>(), "cache_waiting_list", desc{"Support of Cache Waiting List (this value is ignored if Persistent Disk Bitmap Cache is disabled)."}, set(true));
        w.field(A, type_<bool_>(), "persist_bitmap_cache_on_disk", desc{"If enabled, the contents of Persistent Bitmap Caches are stored on disk."}, set(false));
        w.sep();
        ...
        w.sep();
        w.field(A, type_<bool_>(), "fast_path", desc{"Enables support of Server Fast-Path Update PDUs."}, set(true));
        w.sep();
        w.field(A, type_<bool_>(), "server_redirection_support", desc{"Enables Server Redirection Support."}, set(false));
        w.sep();
        w.field(type_<RedirectionInfo>(), "redir_info");
        w.sep();
        w.field(A, type_<BoolField>(), "bogus_sc_net_size", desc{"Needed to connect with VirtualBox, based on bogus TS_UD_SC_NET data block."}, attached, set(true));
        w.sep();
        w.field(A, type_<UnsignedField>(), "client_device_announce_timeout", attached, set(1000));
        w.sep();
        w.field(type_<StringField>(), "proxy_managed_drives", attached);
    }
    w.stop_section();

    w.start_section("mod_vnc");
    {
        w.field(V, type_<BoolField>(), "clipboard_up", desc{"Enable or disable the clipboard from client (client to server)."}, attached);
        w.field(V, type_<BoolField>(), "clipboard_down", desc{"Enable or disable the clipboard from server (server to client)."}, attached);
        w.sep();
        ...
        w.sep();
        w.field(A, type_<bool_>(), "allow_authentification_retries", set(false));
        w.sep();
        ...
        w.sep();
        w.field(A, type_<UnsignedField>(), "bogus_clipboard_infinite_loop", attached, set(0));
    }
    w.stop_section();

    w.start_section("mod_replay");
    {
        w.field(A, type_<int_>(), "on_end_of_data", desc{"0 - Wait for Escape, 1 - End session"}, set(0));
    }
    w.stop_section();

    w.start_section("video");
    {
        w.field(A, type_<uint_>(), "capture_groupid", set(33));
        w.sep();
        w.field(A, type_<uint_>(), "capture_flags", desc{
        ...
        w.sep();
//         w.field(type_<bool_>(), "capture_png", set(true));
//         w.field(type_<bool_>(), "capture_wrm", set(true));
//         w.field(type_<bool_>(), "capture_flv", set(false));
//         w.field(type_<bool_>(), "capture_ocr", set(false));
//         w.field(type_<bool_>(), "capture_ppocr", set(false));
        w.sep();
        w.field(A, type_<std::string>(), "ocr_locale", desc{"latin (default) or cyrillic"});
        w.field(A, type_<uint_>(), "ocr_interval", desc{"Is in 1/100 s"}, set(100));
        w.field(A, type_<bool_>(), "ocr_on_title_bar_only", set(false));
        w.field(A, type_<uint_>(), "ocr_max_unrecog_char_rate", desc{
            "Expressed in percentage,\n"
          "  0   - all of characters need be recognized\n"
          "  100 - accept all results"
        }, set(40));
        w.sep();
        w.field(A, type_<uint_>(), "png_interval", desc{"Frame interval is in 1/10 s."}, set(3000));
        w.field(A, type_<uint_>(), "frame_interval", desc{"Frame interval is in 1/100 s."}, set(40));
        w.field(A, type_<uint_>(), "break_interval", desc{"Time between 2 wrm movies (in seconds)."}, set(600));
        w.field(A, type_<uint_>(), "png_limit", desc{"Number of png captures to keep."}, set(5));
        w.sep();
        w.field(type_<uint64_>(), "flv_break_interval", set(0));
        w.sep();
        w.field(A, type_<StaticString<1024>>(), "replay_path", set("/tmp/"));
        w.sep();
        w.field(A, type_<uint_>(), "l_bitrate", desc{"Bitrate for low quality."}, set(10000));
        w.field(A, type_<uint_>(), "l_framerate", desc{"Framerate for low quality."}, set(5));
        w.field(A, type_<uint_>(), "l_height", desc{"Height for low quality."}, set(480));
        w.field(A, type_<uint_>(), "l_width", desc{"Width for low quality."}, set(640));
        w.field(A, type_<uint_>(), "l_qscale", desc{"Qscale (parameter given to ffmpeg) for low quality."}, set(28));
        w.sep();
        w.field(A, type_<uint_>(), "m_bitrate", desc{"Bitrate for medium quality."}, set(20000));
        w.field(A, type_<uint_>(), "m_framerate", desc{"Framerate for medium quality."}, set(5));
        w.field(A, type_<uint_>(), "m_height", desc{"Height for medium quality."}, set(768));
        w.field(A, type_<uint_>(), "m_width", desc{"Width for medium quality."}, set(1024));
        w.field(A, type_<uint_>(), "m_qscale", desc{"Qscale (parameter given to ffmpeg) for medium quality."}, set(14));
        w.sep();
        w.field(A, type_<uint_>(), "h_bitrate", desc{"Bitrate for high quality."}, set(30000));
        w.field(A, type_<uint_>(), "h_framerate", desc{"Framerate for high quality."}, set(5));
        w.field(A, type_<uint_>(), "h_height", desc{"Height for high quality."}, set(2048));
        w.field(A, type_<uint_>(), "h_width", desc{"Width for high quality."}, set(2048));
        w.field(A, type_<uint_>(), "h_qscale", desc{"Qscale (parameter given to ffmpeg) for high quality."}, set(7));
        w.sep();
        ...
        w.sep();
        w.field(type_<bool_>(), "inactivity_pause", set(false));
        w.field(type_<uint_>(), "inactivity_timeout", set(300));
        w.sep();
        w.field(type_<UnsignedField>(), "disable_keyboard_log", desc{
        ...
        w.field(type_<bool_>(), "disable_keyboard_log_syslog", set(false));
        w.field(type_<bool_>(), "disable_keyboard_log_wrm", set(false));
        w.field(type_<bool_>(), "disable_keyboard_log_ocr", set(false));
        w.sep();
        w.field(type_<UnsignedField>(), "disable_clipboard_log", desc{
            "Disable clipboard log:\n"
            "  1: disable clipboard log in syslog"
        }, attached, set(0));
        w.field(type_<bool_>(), "disable_clipboard_log_syslog", set(false));
        w.sep();
        w.field(H, type_<UnsignedField>(), "rt_display", attached, set(0));
        w.sep();
        w.field(A, type_<uint_>(), "wrm_color_depth_selection_strategy", desc{
            "The method by which the proxy RDP establishes criteria on which to chosse a color depth for native video capture:\n"
            "  0: 24-bit\n"
            "  1: 16-bit"
        }, set(0));
        w.field(A, type_<uint_>(), "wrm_compression_algorithm", desc{
    ...
    w.start_section("debug");
    {
        ...
        w.sep();
        w.field(A, type_<uint32_>(), "config", desc{"0 = disable, 1 = enable, 2 = enable but no specified"}, set(2));
    }
    w.stop_section();

    w.start_section("translation");
    {
        w.field(A, type_<StringField>(), "language", set("en"), attached);
    }
    w.stop_section();

    w.start_section("internal_mod");
    {
        w.field(A | G, type_<std::string>(), "load_theme", set(""));
    }
    w.stop_section();
    ...
    w.start_section("context");
    {
        ...
        w.sep();
        w.field(type_<UnsignedField>(), "opt_bitrate", set(40000), attached);
        w.field(type_<UnsignedField>(), "opt_framerate", set(5), attached);
        w.field(type_<UnsignedField>(), "opt_qscale", set(15), attached);
        w.sep();
        w.field(type_<UnsignedField>(), "opt_bpp", linked, set(24), attached);
        w.field(type_<UnsignedField>(), "opt_height", linked, set(600), attached);
        w.field(type_<UnsignedField>(), "opt_width", linked, set(800), attached);
        w.sep();
        ...
        w.field(type_<StringField>(), "target_protocol", linked, set("RDP"), asked, attached);
        w.sep();
        ...
        w.sep();
        w.field(type_<UnsignedField>(), "end_date_cnx", set(0), attached);
    ...
    w.field(type_<IniAccount>(), "account");
