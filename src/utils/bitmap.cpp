...
void Bitmap::decompress(const uint8_t* input, uint16_t src_cx, uint16_t src_cy, size_t size) const
{
    (void)src_cy;
    switch (this->bpp()) {
...
template<class TBpp>
void Bitmap::decompress_(TBpp Bpp, const uint8_t* input, uint16_t src_cx, size_t size) const
{
...
void Bitmap::decompress_color_plane(
...
void Bitmap::in_copy_color_plan(
    uint16_t src_cx, uint16_t src_cy, const uint8_t * & data,
    size_t & data_size, uint16_t cx, uint8_t * color_plane)
{
    uint8_t * line_start  = color_plane;
...
void Bitmap::decompress60(uint16_t src_cx, uint16_t src_cy, const uint8_t * data, size_t data_size) const
{
