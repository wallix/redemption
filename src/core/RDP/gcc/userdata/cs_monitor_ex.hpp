...
struct CSMonitorEx {
   ...
   struct {
    ...
    {
        // header(4) + flags(4) + monitorAttributeSize(4) + monitorCount(4)
        // + monitorCount * monitorAttributesArray(20)
    ...
    void emit(OutStream & stream) const
    {
        ...
        stream.out_uint16_le(this->compute_length());
    ...
    void recv(InStream & stream)
    {
        ...
        // monitorCount * monitorAttributesArray(20)
        if (!stream.in_check_rem(this->monitorCount * 20)) {
