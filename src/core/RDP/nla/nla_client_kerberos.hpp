...
//        auto magic_hash = make_array_view("CredSSP Client-To-Server Binding Hash");
    ...
    SEC_STATUS credssp_encrypt_public_key_echo() {
        ...
        return this->table.sspi_EncryptMessage(
    ...
    SEC_STATUS credssp_decrypt_public_key_echo() {
        ...
        SEC_STATUS const status = this->table.sspi_DecryptMessage(
    ...
    Res sm_credssp_client_authenticate_send()
    {
        ...
        SEC_STATUS status = this->table.sspi_InitializeSecurityContext(
...
public:
        ...
        , trans(transport.get_transport())
    {
        ...
        SEC_STATUS status = this->table.sspi_AcquireCredentialsHandle(this->target_host, &this->ServicePrincipalName, &this->identity);
