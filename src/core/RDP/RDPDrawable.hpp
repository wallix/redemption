...
public:
    ...
    void trace_mouse(void)
    {
        ...
        return this->drawable.trace_mouse(this->current_pointer, this->mouse_cursor_pos_x, this->mouse_cursor_pos_y, this->save_mouse);
    }
    ...
    void clear_mouse(void)
    {
        ...
        return this->drawable.clear_mouse(this->current_pointer, this->save_mouse_x, this->save_mouse_y, this->save_mouse);
    }
    ...
    void set_pointer(const Pointer & cursor) override {
        ...
        this->dynamic_pointer.initialize(hotspot.x, hotspot.y, dimensions.width, dimensions.height, av_xor.data(), av_and.data());
