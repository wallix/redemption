...
struct WidgetHeaderGrid : public WidgetGrid {
    ...
    WidgetHeaderGrid(gdi::GraphicApi & drawable, Widget2 & parent,
        ...
        : WidgetGrid(drawable, parent, notifier, 2, nb_columns,
