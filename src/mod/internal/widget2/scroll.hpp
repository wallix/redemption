...
public:
    ...
    WidgetFrame(mod_api & drawable, const Rect& rect, Widget2 & parent,
...
public:
    ...
    WidgetVScrollBar(mod_api & drawable, Widget2 & parent, NotifyApi * notifier,
...
public:
    ...
    WidgetHScrollBar(mod_api & drawable, Widget2 & parent, NotifyApi * notifier,
                     int fg_color, int bg_color, int focus_color, int group_id = 0)
