...
// class DynamicSelector : public WidgetParent
// {
//
...
//
//
//     DynamicSelector(gdi::GraphicApi & drawable, Widget2 & parent, NotifyApi* notifier,
//                     const char * device_name,
//                     int16_t left, int16_t top, uint16_t width, uint16_t height,
//                     const char * number_of_page, const char ** column_names, const int nb_column,
