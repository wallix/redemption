...
public:
    WidgetSelectorFlat2(DrawApi& drawable, const char * device_name, uint16_t width,
        ...
        , device_label(drawable, TEXT_MARGIN, VERTICAL_MARGIN, *this, nullptr, device_name,
                       true, -10, ini.get<cfg::theme>().global.fgcolor, ini.get<cfg::theme>().global.bgcolor, ini.get<cfg::font>())
        , target_group_label(drawable, 0, 0, *this, nullptr, TR("target_group", ini), true,
                              -10, ini.get<cfg::theme>().selector_label.fgcolor,
                             ini.get<cfg::theme>().selector_label.bgcolor, ini.get<cfg::font>(), 5)
        ...
        , filter_target_group(drawable, 0, 0, 120, *this, this,
                              ...
                              ini.get<cfg::theme>().edit.focus_color, ini.get<cfg::font>(), -1, 1, 1)
        ...
        , first_page(drawable, 0, 0, *this, notifier, "◀◂", true, -15,
                     ...
                     ini.get<cfg::theme>().global.focus_color, ini.get<cfg::font>(), 6, 2, true)
