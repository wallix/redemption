...
BGRColor FlatVNCAuthentification::get_bg_color() const
{
    return this->bgcolor;
}

void FlatVNCAuthentification::notify(Widget* widget, NotifyApi::notify_event_t event)
{
...
void FlatVNCAuthentification::rdp_input_scancode(
