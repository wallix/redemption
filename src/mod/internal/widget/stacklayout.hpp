...
struct WidgetStackLayout : public WidgetLayout {
    ...
    WidgetStackLayout(gdi::GraphicApi & drawable, const Rect rect, Widget & parent,
    ...
    virtual void draw(const Rect clip) {
        if (this->selected < this->nb_items) {
            Widget *w = this->items[this->selected];
    ...
    virtual void notify(Widget * from, notify_event_t event) {
