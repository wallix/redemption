...
class WidgetRadioButton : public Widget
{
public:
    WidgetLabel label;
    bool selected;
    ...
    WidgetRadioButton(gdi::GraphicApi & drawable,
        ...
        : Widget(drawable, Rect(x,y,1,1), parent, notifier, group_id)
...
class WidgetRadioList : public Widget
{
    enum {
        AUTOSIZE = 256
    };
...
public:
    WidgetRadioList(mod_api & drawable, int x, int y, Widget & parent,
