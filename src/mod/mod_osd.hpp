...
// TODO        this->drawable_fn(this->mod, rect.intersect(this->fg_rect));
    }

public:
    using drawable_function_type = std::function<void(gdi::GraphicApi &, const Rect & clip)>;
...
private:
    struct dispatch_bmp_draw {
        ...
        void operator()(gdi::GraphicApi & drawable, Rect const & clip) const {
// TODO            mod.draw(RDPMemBlt(0, rect, 0xCC, this->bmp_srcx, this->bmp_srcy, 0), clip, this->bmp);
        }
    };
public:
...
private:
    ...
    void redraw_osd()
    {
// TODO        this->mod.begin_update();
        this->draw_fg(this->fg_rect);
// TODO        this->mod.end_update();
    }
