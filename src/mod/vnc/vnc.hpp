...
public:
    ...
    , metrics( vars.get<cfg::metrics::activate_log_metrics>()
         ...
         , hmac_user(vars.get<cfg::globals::auth_user>(), vars.get<cfg::metrics::sign_key>())
         , hmac_account({username, strlen(username)}, vars.get<cfg::metrics::sign_key>())
         , hmac_device_service(vars.get<cfg::globals::target_device>(),
                               vars.get<cfg::context::target_service>(),
                               vars.get<cfg::metrics::sign_key>())
         , hmac_client_info(vars.get<cfg::globals::host>(), info, vars.get<cfg::metrics::sign_key>())
         , timeobj.get_time()
