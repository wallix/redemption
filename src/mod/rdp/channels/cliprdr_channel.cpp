    ...
    uint32_t total_length, uint32_t flags, bytes_view chunk_data)
{
    ...
    switch (this->client_ctx.message_type)
    {
        case RDPECLIP::CB_CLIP_CAPS: {
            ...
            if (this->clipboard_capabilities_notifier) {
                if (!this->clipboard_capabilities_notifier->on_clipboard_capabilities()) {
                    this->clipboard_capabilities_notifier = nullptr;
                }
            }
        }
        break;
        ...
        case RDPECLIP::CB_FORMAT_LIST: {
            if ((InitializationState::WaitingClientTemporaryDirectoryPDUOrFormatListPDU !=
                 this->initialization_state) &&
                (InitializationState::WaitingClientFormatListPDU !=
                 this->initialization_state) &&
