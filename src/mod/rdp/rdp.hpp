    ...
    explicit mod_rdp(
      ...
      , ModRdpVariables vars
        ...
        , metrics( tvtime().tv_sec
                 ...
                 , hmac_device_service(vars.get<cfg::globals::target_device>(),         vars.get<cfg::context::target_service>(), vars.get<cfg::rdp_metrics::sign_key>().data())
                 , hmac_client_info(mod_rdp_params.target_host, info, vars.get<cfg::rdp_metrics::sign_key>().data())
