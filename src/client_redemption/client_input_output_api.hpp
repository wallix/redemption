...
#define CLIENT_REDMPTION_REPLAY_PATH "/DATA/replay"
#define CLIENT_REDMPTION_LOGINS_PATH "/DATA/config/login.config"
#define CLIENT_REDMPTION_WINODW_CONF_PATH "/DATA/config/windows_config.config"
#define CLIENT_REDMPTION_SHARE_PATH "/DATA/share"
#define CLIENT_REDMPTION_CB_FILE_TEMP_PATH "/DATA/clipboard_temp"
#define CLIENT_REDMPTION_KEY_SETTING_PATH "/DATA/config/keySetting.config"
#define CLIENT_REDMPTION_USER_CONF_PATH "/DATA/config/userConfig.config"
#define CLIENT_REDMPTION_SOUND_TEMP_PATH "DATA/sound_temp"


#define CLIENT_REDMPTION_DATA_PATH "/DATA"
#define CLIENT_REDMPTION_DATA_CONF_PATH "/DATA/config"
...
public:
    ...
    , keymap()
    , _timer(0)
    , MAIN_DIR(CLIENT_REDMPTION_MAIN_PATH)
    , REPLAY_DIR(CLIENT_REDMPTION_MAIN_PATH CLIENT_REDMPTION_REPLAY_PATH)
    , USER_CONF_LOG(CLIENT_REDMPTION_MAIN_PATH CLIENT_REDMPTION_LOGINS_PATH)
    , WINDOWS_CONF(CLIENT_REDMPTION_MAIN_PATH CLIENT_REDMPTION_WINODW_CONF_PATH)
    , CB_TEMP_DIR(MAIN_DIR + std::string(CLIENT_REDMPTION_CB_FILE_TEMP_PATH))
    , SHARE_DIR(MAIN_DIR + std::string(CLIENT_REDMPTION_SHARE_PATH))
    , USER_CONF_DIR(MAIN_DIR + std::string(CLIENT_REDMPTION_USER_CONF_PATH))
    , SOUND_TEMP_DIR(std::string(CLIENT_REDMPTION_SOUND_TEMP_PATH))
    , DATA_DIR(MAIN_DIR + std::string(CLIENT_REDMPTION_DATA_PATH))
    , DATA_CONF_DIR(MAIN_DIR + std::string(CLIENT_REDMPTION_DATA_CONF_PATH))
    , port(0)
