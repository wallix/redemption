...
void ClientChannelRDPDRManager::FremoveDriveDevice(const DeviceData * devices, const size_t deviceCount) {
    StaticOutStream<1024> out_stream;
...
void ClientChannelRDPDRManager::process_server_annnounce_request(InStream & chunk) {
...
void ClientChannelRDPDRManager::process_core_server_capabilities(InStream & chunk) {
...
void ClientChannelRDPDRManager::process_core_clientID_confirm() {
    {
        StaticOutStream<1024> out_stream;
        rdpdr::SharedHeader sharedHeader( rdpdr::Component::RDPDR_CTYP_CORE
...
void ClientChannelRDPDRManager::process_core_device_reply(InStream & chunk) {
    rdpdr::ServerDeviceAnnounceResponse sdar;
    sdar.receive(chunk);
...
void ClientChannelRDPDRManager::process_iorequest_lock_control(rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream) {
...
void ClientChannelRDPDRManager::process_iorequest_create(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::process_iorequest_query_information(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::process_iorequest_close(rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
    this->paths.erase(id);
...
void ClientChannelRDPDRManager::process_iorequest_read(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::process_iorequest_directory_control(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id, uint32_t minor_function) {
...
void ClientChannelRDPDRManager::process_iorequest_query_volume_information(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::provess_iorequest_write(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::process_iorequest_set_information(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream, uint32_t id) {
...
void ClientChannelRDPDRManager::process_iorequest_device_control(InStream & chunk, rdpdr::DeviceIOResponse &  deviceIOResponse, OutStream & out_stream) {
...
void ClientChannelRDPDRManager::process_core_device_iorequest(InStream & chunk) {
    rdpdr::DeviceIORequest deviceIORequest;
    deviceIORequest.receive(chunk);
