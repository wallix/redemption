...
class CryptoContext {
    ...
    {
        printf("get_crypto_key_from_ini\n");
        char tmp_buf[512] = {0};
    ...
    {
        printf("get_crypto_key_from_ini_derivated_hmac\n");
