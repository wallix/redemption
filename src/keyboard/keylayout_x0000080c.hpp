...
#ifndef _REDEMPTION_KEYLAYOUT_X0000080C_HPP_
#define _REDEMPTION_KEYLAYOUT_X0000080C_HPP_

#include "keylayout.hpp"

namespace x0000080c {    // French (Belgium) // Belgian French

const static int LCID = 0x0000080c;

const Keylayout::KeyLayout_t noMod = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0026, 0x00E9, 0x0022, 0x0027, 0x0028, 0x00A7,
    /* x08 - x0F */    0x00E8, 0x0021, 0x00E7, 0x00E0, 0x0029, 0x002D, 0x0008, 0x0009,
    /* x10 - x17 */       'a',    'z',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x005E, 0x0024, 0x000D, 0x0000,    'q',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l',    'm',
    /* x28 - x2F */    0x00F9, 0x00B2, 0x0000, 0x00B5,    'w',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n', 0x002C, 0x003B, 0x003A, 0x003D, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x00B0, 0x005F, 0x0008, 0x0000,
    /* x10 - x17 */       'A',    'Z',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00A8, 0x002A, 0x000D, 0x0000,    'Q',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L',    'M',
    /* x28 - x2F */    0x0025, 0x00B3, 0x0000, 0x00A3,    'W',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N', 0x003F, 0x002E, 0x002F, 0x002B, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x007C, 0x0040, 0x0023, 0x007B, 0x005B, 0x005E,
    /* x08 - x0F */    0x0000, 0x0000, 0x007B, 0x007D, 0x0000, 0x0000, 0x0008, 0x0009,
    ...
    /* x28 - x2F */    0x00B4, 0x0000, 0x0000, 0x0060, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x007E, 0x0000,    '*',
...
const Keylayout::KeyLayout_t capslock_noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x00B0, 0x005F, 0x0008, 0x0009,
    /* x10 - x17 */       'A',    'Z',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00A8, 0x002A, 0x000D, 0x0000,    'Q',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L',    'M',
    /* x28 - x2F */    0x0025, 0x00B2, 0x0000, 0x00A3,    'W',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N', 0x003F, 0x002E, 0x002F, 0x002B, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x18 - x1F */       'o',    'p', 0x005E, 0x0024, 0x000D, 0x0000,    'q',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l',    'm',
    /* x28 - x2F */    0x00F9, 0x00B3, 0x0000, 0x00B5,    'w',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n', 0x002C, 0x003B, 0x003A, 0x003D, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
} // END NAMESPACE - x0000080c

static const Keylayout keylayout_x0000080c( x0000080c::LCID
                                          , x0000080c::noMod
                                          , x0000080c::shift
                                          , x0000080c::altGr
                                          , x0000080c::shiftAltGr
                                          , x0000080c::ctrl
                                          , x0000080c::capslock_noMod
                                          , x0000080c::capslock_shift
                                          , x0000080c::capslock_altGr
                                          , x0000080c::capslock_shiftAltGr
                                          , x0000080c::deadkeys
                                          , x0000080c::nbDeadkeys
);
