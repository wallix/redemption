...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000440_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000440_HPP_
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x10 - x17 */    0x0000, 0x0000, 0x04AF, 0x0000, 0x0000, 0x04A3, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x04E9, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x04AE, 0x0000, 0x0000, 0x04A2, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x04E8, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
static const Keylayout keylayout_x00000440( x00000440::LCID
                                          ...
                                          , x00000440::shift
                                          , x00000440::altGr
                                          , x00000440::shiftAltGr
                                          , x00000440::ctrl
                                          , x00000440::capslock_noMod
                                          , x00000440::capslock_shift
                                          , x00000440::capslock_altGr
                                          , x00000440::capslock_shiftAltGr
                                          , x00000440::deadkeys
