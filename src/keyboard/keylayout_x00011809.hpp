...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00011809_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00011809_HPP_

#include "keylayout.hpp"

namespace x00011809 {    // English (Ireland) // Gaelic

const static int LCID = 0x00011809;
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x28 - x2F */    0x0040, 0x0060, 0x0000, 0x007E,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x10 - x17 */    0x0000, 0x0000, 0x00E9, 0x0000, 0x0000, 0x00FD, 0x00FA, 0x00ED,
    ...
    /* x28 - x2F */    0x0027, 0x00A6, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x00C9, 0x0000, 0x0000, 0x00DD, 0x00DA, 0x00CD,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x0027, 0x28, 13, { {0x006f, 0x00f3}  // 'o' = 'ó'
                        , {0x0049, 0x00cd}  // 'I' = 'Í'
                        , {0x0059, 0x00dd}  // 'Y' = 'Ý'
                        , {0x0041, 0x00c1}  // 'A' = 'Á'
                        , {0x0045, 0x00c9}  // 'E' = 'É'
...
} // END NAMESPACE - x00011809

static const Keylayout keylayout_x00011809( x00011809::LCID
                                          , x00011809::locale_name
                                          , x00011809::noMod
                                          , x00011809::shift
                                          , x00011809::altGr
                                          , x00011809::shiftAltGr
                                          , x00011809::ctrl
                                          , x00011809::capslock_noMod
                                          , x00011809::capslock_shift
                                          , x00011809::capslock_altGr
                                          , x00011809::capslock_shiftAltGr
                                          , x00011809::deadkeys
                                          , x00011809::nbDeadkeys
);
