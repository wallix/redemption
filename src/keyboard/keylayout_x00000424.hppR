...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000424_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000424_HPP_
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x28 - x2F */    0x0107, 0x00B8, 0x0000, 0x017E,    'y',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x28 - x2F */    0x0106, 0x00A8, 0x0000, 0x017D,    'Y',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x18 - x1F */       'O',    'P', 0x0160, 0x0110, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x010C,
    /* x28 - x2F */    0x0106, 0x00B8, 0x0000, 0x017D,    'Y',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x002C, 0x002E, 0x002D, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x18 - x1F */       'o',    'p', 0x0161, 0x0111, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x010D,
    /* x28 - x2F */    0x0107, 0x00A8, 0x0000, 0x017E,    'y',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x003B, 0x003A, 0x005F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout keylayout_x00000424( x00000424::LCID
                                          ...
                                          , x00000424::shift
                                          , x00000424::altGr
                                          , x00000424::shiftAltGr
                                          , x00000424::ctrl
                                          , x00000424::capslock_noMod
                                          , x00000424::capslock_shift
                                          , x00000424::capslock_altGr
                                          , x00000424::capslock_shiftAltGr
                                          , x00000424::deadkeys
