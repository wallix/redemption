...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000C0C_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000C0C_HPP_

#include "keylayout.hpp"

namespace x00000c0c {    // French (Canada) // Canadian French (Legacy)

const static int LCID = 0x00000c0c;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */       'o',    'p', 0x005E, 0x00E7, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x003B,
    /* x28 - x2F */    0x00E8, 0x00B0, 0x0000, 0x00E0,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x002C, 0x002E, 0x00E9, 0x0000,    '*',
    ...
    /* x48 - x4F */       '8',    '9',    '-',    '4',    '5',    '6',    '+',    '1',
    /* x50 - x57 */       '2',    '3',    '0', 0x002E, 0x0000, 0x0000, 0x00F9, 0x0000,
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x003F,
    /* x08 - x0F */    0x0026, 0x002A, 0x0028, 0x0029, 0x005F, 0x002B, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x005E, 0x00C7, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x003A,
    /* x28 - x2F */    0x00C8, 0x00B0, 0x0000, 0x00C0,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x0027, 0x002E, 0x00C9, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002E, 0x0000, 0x0000, 0x00D9, 0x0000,
    /* x58 - x5F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00B9, 0x0040, 0x00B3, 0x00BC, 0x00BD, 0x00BE,
    /* x08 - x0F */    0x007B, 0x005B, 0x005D, 0x007D, 0x007C, 0x00B8, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x00B6, 0x0000, 0x00A5, 0x0000, 0x0000,
    /* x18 - x1F */    0x00F8, 0x00FE, 0x00B0, 0x007E, 0x000D, 0x0000, 0x00E6, 0x00DF,
    /* x20 - x27 */    0x00F0, 0x00AA, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x00AC, 0x0000, 0x0060, 0x00AB, 0x00BB, 0x00A2, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x00B5, 0x003C, 0x003E, 0x002F, 0x0000,    '*',
...
const Keylayout::KeyLayout_t shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x00A1, 0x00B2, 0x00A3, 0x00A4, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x00B1, 0x0000, 0x00BF, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x00AE, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x00D8, 0x00DE, 0x0000, 0x00A8, 0x000D, 0x0000, 0x00C6, 0x00A7,
    /* x20 - x27 */    0x00D0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0060, 0x0000, 0x0000, 0x00A9, 0x0000,
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x003B,
    /* x28 - x2F */    0x00C8, 0x00B0, 0x0000, 0x00C0,    'Z',    'X',    'C',    'V',
    /* x30 - x37 */       'B',    'N',    'M', 0x002C, 0x002E, 0x00C9, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002E, 0x0000, 0x0000, 0x00D9, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x003A,
    /* x28 - x2F */    0x00E8, 0x00B0, 0x0000, 0x00E0,    'z',    'x',    'c',    'v',
    /* x30 - x37 */       'b',    'n',    'm', 0x0027, 0x002E, 0x00E9, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002E, 0x0000, 0x0000, 0x00F9, 0x0000,
    /* x58 - x5F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x60 - x67 */    0x0000, 0x0000,    '/', 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x68 - x6F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x70 - x77 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_altGr = {
    ...
    /* x08 - x0F */    0x007B, 0x005B, 0x005D, 0x007D, 0x007C, 0x00B8, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x00B6, 0x0000, 0x00A5, 0x0000, 0x0000,
    /* x18 - x1F */    0x00D8, 0x00DE, 0x00B0, 0x007E, 0x000D, 0x0000, 0x00C6, 0x00DF,
    /* x20 - x27 */    0x00D0, 0x00AA, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x00AC, 0x0000, 0x0060, 0x00AB, 0x00BB, 0x00A2, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x00B5, 0x003C, 0x003E, 0x002F, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t capslock_shiftAltGr = {
    ...
    /* x08 - x0F */    0x0000, 0x0000, 0x00B1, 0x0000, 0x00BF, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x00AE, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x00F8, 0x00FE, 0x0000, 0x00A8, 0x000D, 0x0000, 0x00E6, 0x00A7,
    /* x20 - x27 */    0x00F0, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00B4,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0060, 0x0000, 0x0000, 0x00A9, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x00BA, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x00b8, 0x0d,  2, { {0x0043, 0x00c7}  // 'C' = 'Ç'
                        , {0x0063, 0x00e7}  // 'c' = 'ç'
                        }
    },
    ...
    { 0x0060, 0x2b, 11, { {0x006f, 0x00f2}  // 'o' = 'ò'
                        , {0x0049, 0x00cc}  // 'I' = 'Ì'
                        , {0x0020, 0x0060}  // ' ' = '`'
                        , {0x0041, 0x00c0}  // 'A' = 'À'
                        , {0x0045, 0x00c8}  // 'E' = 'È'
...
} // END NAMESPACE - x00000c0c

static const Keylayout keylayout_x00000c0c( x00000c0c::LCID
                                          , x00000c0c::locale_name
                                          , x00000c0c::noMod
                                          , x00000c0c::shift
                                          , x00000c0c::altGr
                                          , x00000c0c::shiftAltGr
                                          , x00000c0c::ctrl
                                          , x00000c0c::capslock_noMod
                                          , x00000c0c::capslock_shift
                                          , x00000c0c::capslock_altGr
                                          , x00000c0c::capslock_shiftAltGr
                                          , x00000c0c::deadkeys
                                          , x00000c0c::nbDeadkeys
);
