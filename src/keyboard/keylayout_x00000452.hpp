...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000452_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000452_HPP_

#include "keylayout.hpp"

namespace x00000452 {    // Welsh (United Kingdom) // United Kingdom Extended

const static int LCID = 0x00000452;

const static char * const locale_name = "cy-GB";
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x28 - x2F */    0x0027, 0x0060, 0x0000, 0x0023,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x00A3, 0x0024, 0x0025, 0x005E,
    ...
    /* x28 - x2F */    0x0040, 0x00AC, 0x0000, 0x007E,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x00A8, 0x0000, 0x20AC, 0x0000, 0x005E,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x1E83, 0x00E9, 0x0000, 0x0000, 0x00FD, 0x00FA, 0x00ED,
    /* x18 - x1F */    0x00F3, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00E1, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x00B4, 0x00A6, 0x0000, 0x007E, 0x0000, 0x0000, 0x00E7, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    ...
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x1E82, 0x00C9, 0x0000, 0x0000, 0x00DD, 0x00DA, 0x00CD,
    /* x18 - x1F */    0x00D3, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00C1, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0060, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00C7, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_altGr = {
    ...
    /* x18 - x1F */    0x00D3, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00C1, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x00B4, 0x00A6, 0x0000, 0x007E, 0x0000, 0x0000, 0x00C7, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shiftAltGr = {
    ...
    /* x18 - x1F */    0x00F3, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x00E1, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0060, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x00E7, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::dkey_t deadkeys[] = {
    { 0x00a8, 0x03, 15, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0059, 0x0178}  // 'Y' = 'Ÿ'
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0057, 0x1e84}  // 'W' = 'Ẅ'
    ...
    { 0x005e, 0x07, 15, { {0x006f, 0x00f4}  // 'o' = 'ô'
                        , {0x0049, 0x00ce}  // 'I' = 'Î'
                        , {0x0059, 0x0176}  // 'Y' = 'Ŷ'
                        , {0x0041, 0x00c2}  // 'A' = 'Â'
                        , {0x0057, 0x0174}  // 'W' = 'Ŵ'
    ...
    { 0x0060, 0x29, 15, { {0x006f, 0x00f2}  // 'o' = 'ò'
                        , {0x0049, 0x00cc}  // 'I' = 'Ì'
                        , {0x0059, 0x1ef2}  // 'Y' = 'Ỳ'
                        , {0x0041, 0x00c0}  // 'A' = 'À'
                        , {0x0057, 0x1e80}  // 'W' = 'Ẁ'
    ...
    { 0x007e, 0x2b,  7, { {0x006f, 0x00f5}  // 'o' = 'õ'
                        , {0x0020, 0x007e}  // ' ' = '~'
                        , {0x006e, 0x00f1}  // 'n' = 'ñ'
                        , {0x0041, 0x00c3}  // 'A' = 'Ã'
                        , {0x0061, 0x00e3}  // 'a' = 'ã'
...
} // END NAMESPACE - x00000452

static const Keylayout keylayout_x00000452( x00000452::LCID
                                          , x00000452::locale_name
                                          , x00000452::noMod
                                          , x00000452::shift
                                          , x00000452::altGr
                                          , x00000452::shiftAltGr
                                          , x00000452::ctrl
                                          , x00000452::capslock_noMod
                                          , x00000452::capslock_shift
                                          , x00000452::capslock_altGr
                                          , x00000452::capslock_shiftAltGr
                                          , x00000452::deadkeys
                                          , x00000452::nbDeadkeys
);
