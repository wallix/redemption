...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000422_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00000422_HPP_

#include "keylayout.hpp"

namespace x00000422 {    // Ukrainian (Ukraine) // Ukrainian

const static int LCID = 0x00000422;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x18 - x1F */    0x0449, 0x0437, 0x0445, 0x0457, 0x000D, 0x0000, 0x0444, 0x0456,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x0454, 0x0451, 0x0000, 0x005C, 0x044F, 0x0447, 0x0441, 0x043C,
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x18 - x1F */    0x0429, 0x0417, 0x0425, 0x0407, 0x000D, 0x0000, 0x0424, 0x0406,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x0404, 0x0401, 0x0000, 0x002F, 0x042F, 0x0427, 0x0421, 0x041C,
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0491, 0x0000,
...
const Keylayout::KeyLayout_t shiftAltGr = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0490, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
...
const Keylayout::KeyLayout_t capslock_noMod = {
    ...
    /* x18 - x1F */    0x0429, 0x0417, 0x0425, 0x0407, 0x000D, 0x0000, 0x0424, 0x0406,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x0404, 0x0401, 0x0000, 0x005C, 0x042F, 0x0427, 0x0421, 0x041C,
...
const Keylayout::KeyLayout_t capslock_shift = {
    ...
    /* x18 - x1F */    0x0449, 0x0437, 0x0445, 0x0457, 0x000D, 0x0000, 0x0444, 0x0456,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x0454, 0x0451, 0x0000, 0x002F, 0x044F, 0x0447, 0x0441, 0x043C,
...
} // END NAMESPACE - x00000422

static const Keylayout keylayout_x00000422( x00000422::LCID
                                          , x00000422::locale_name
                                          , x00000422::noMod
                                          , x00000422::shift
                                          , x00000422::altGr
                                          , x00000422::shiftAltGr
                                          , x00000422::ctrl
                                          , x00000422::capslock_noMod
                                          , x00000422::capslock_shift
                                          , x00000422::capslock_altGr
                                          , x00000422::capslock_shiftAltGr
                                          , x00000422::deadkeys
                                          , x00000422::nbDeadkeys
);
