...
namespace x00000843 {    // Uzbek (Cyrillic, Uzbekistan) // Uzbek Cyrillic

const static int LCID = 0x00000843;

const static char * const locale_name = "uz-Cy";

static const Keylayout::KeyLayout_t noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x0493, 0x04B3, 0x0008, 0x0009,
    /* x10 - x17 */    0x0439, 0x0446, 0x0443, 0x043A, 0x0435, 0x043D, 0x0433, 0x0448,
    /* x18 - x1F */    0x045E, 0x0437, 0x0445, 0x044A, 0x000D, 0x0000, 0x0444, 0x049B,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x044D, 0x0451, 0x0000, 0x005C, 0x044F, 0x0447, 0x0441, 0x043C,
    /* x30 - x37 */    0x0438, 0x0442, 0x044C, 0x0431, 0x044E, 0x002E, 0x0000,    '*',
...
static const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */    0x003F, 0x002A, 0x0028, 0x0029, 0x0492, 0x04B2, 0x0008, 0x0000,
    /* x10 - x17 */    0x0419, 0x0426, 0x0423, 0x041A, 0x0415, 0x041D, 0x0413, 0x0428,
    /* x18 - x1F */    0x040E, 0x0417, 0x0425, 0x042A, 0x000D, 0x0000, 0x0424, 0x049A,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x042D, 0x0401, 0x0000, 0x002F, 0x042F, 0x0427, 0x0421, 0x041C,
    /* x30 - x37 */    0x0418, 0x0422, 0x042C, 0x0411, 0x042E, 0x002C, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002E, 0x0000, 0x0000, 0x002F, 0x0000,
    /* x58 - x5F */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
static const Keylayout::KeyLayout_t capslock_noMod = {
    /* x00 - x07 */    0x0000, 0x001B,    '1',    '2',    '3',    '4',    '5',    '6',
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x0492, 0x04B2, 0x0008, 0x0009,
    /* x10 - x17 */    0x0419, 0x0426, 0x0423, 0x041A, 0x0415, 0x041D, 0x0413, 0x0428,
    /* x18 - x1F */    0x040E, 0x0417, 0x0425, 0x042A, 0x000D, 0x0000, 0x0424, 0x049A,
    /* x20 - x27 */    0x0412, 0x0410, 0x041F, 0x0420, 0x041E, 0x041B, 0x0414, 0x0416,
    /* x28 - x2F */    0x042D, 0x0401, 0x0000, 0x005C, 0x042F, 0x0427, 0x0421, 0x041C,
    /* x30 - x37 */    0x0418, 0x0422, 0x042C, 0x0411, 0x042E, 0x002E, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
static const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x2116, 0x003B, 0x0025, 0x003A,
    /* x08 - x0F */    0x003F, 0x002A, 0x0028, 0x0029, 0x0493, 0x04B3, 0x0008, 0x0009,
    /* x10 - x17 */    0x0439, 0x0446, 0x0443, 0x043A, 0x0435, 0x043D, 0x0433, 0x0448,
    /* x18 - x1F */    0x045E, 0x0437, 0x0445, 0x044A, 0x000D, 0x0000, 0x0444, 0x049B,
    /* x20 - x27 */    0x0432, 0x0430, 0x043F, 0x0440, 0x043E, 0x043B, 0x0434, 0x0436,
    /* x28 - x2F */    0x044D, 0x0451, 0x0000, 0x002F, 0x044F, 0x0447, 0x0441, 0x043C,
    /* x30 - x37 */    0x0438, 0x0442, 0x044C, 0x0431, 0x044E, 0x002C, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
    /* x50 - x57 */    0x0000, 0x0000, 0x0000, 0x002E, 0x0000, 0x0000, 0x002F, 0x0000,
...
} // END NAMESPACE - x00000843

static const Keylayout keylayout_x00000843( x00000843::LCID
                                          , x00000843::locale_name
                                          , x00000843::noMod
                                          , x00000843::shift
                                          , x00000843::altGr
                                          , x00000843::shiftAltGr
                                          , x00000843::ctrl
                                          , x00000843::capslock_noMod
                                          , x00000843::capslock_shift
                                          , x00000843::capslock_altGr
                                          , x00000843::capslock_shiftAltGr
                                          , x00000843::deadkeys
                                          , x00000843::nbDeadkeys
);
