...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X00040408_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X00040408_HPP_

#include "keylayout.hpp"

namespace x00040408 {    // Greek (Greece) // Greek (319) Latin

const static int LCID = 0x00040408;
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00B4,
    /* x28 - x2F */    0x005E, 0x005C, 0x0000, 0x0060,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x28 - x2F */    0x007E, 0x007C, 0x0000, 0x0040,    'Z',    'X',    'C',    'V',
...
const Keylayout::dkey_t deadkeys[] = {
    ...
    { 0x00a8, 0x27, 12, { {0x006f, 0x00f6}  // 'o' = 'ö'
                        , {0x0049, 0x00cf}  // 'I' = 'Ï'
                        , {0x0020, 0x00a8}  // ' ' = '¨'
                        , {0x0041, 0x00c4}  // 'A' = 'Ä'
                        , {0x0045, 0x00cb}  // 'E' = 'Ë'
...
} // END NAMESPACE - x00040408

static const Keylayout keylayout_x00040408( x00040408::LCID
                                          , x00040408::locale_name
                                          , x00040408::noMod
                                          , x00040408::shift
                                          , x00040408::altGr
                                          , x00040408::shiftAltGr
                                          , x00040408::ctrl
                                          , x00040408::capslock_noMod
                                          , x00040408::capslock_shift
                                          , x00040408::capslock_altGr
                                          , x00040408::capslock_shiftAltGr
                                          , x00040408::deadkeys
                                          , x00040408::nbDeadkeys
);
