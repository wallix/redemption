...
// see: https://www.cl.cam.ac.uk/~mgk25/ucs/keysymdef.h for missing definitions
...
// TODO: define symbolic names for keysyms, this source is unreadable with all the magical constants



// using namespace std;

KeymapSym::KeymapSym(int verbose, bool remove_server_alt_state_for_char, bool apple_server)
: ibuf_sym(0)
, nbuf_sym(0)
, dead_key(DEADKEY_NONE)
, verbose(verbose)
, remove_server_alt_state_for_char(remove_server_alt_state_for_char)
, apple_server(apple_server)
, keylayout(0)
, remove_state_mode(false)
, add_state_mode(false)
{
...
//                    }
                ...
                if ((ksym == 0xFE52 ) || (ksym == 0xFE57) || /*(ksym == 0x60)||*/ (ksym == 0x7E)) {
                    ...
                    if (this->dead_key != DEADKEY_NONE){
                        ...
                        if (this->remove_server_alt_state_for_char && this->is_right_alt_pressed()
                            && (ksym == '#'
                            || ksym == '{'
                            || ksym == '['
                            || ksym == '|'
                            ...
                            || ksym == '}'
                                ...
                                this->remove_state_mode = true;
                                this->push_sym(KS_Alt_R);
                                this->push_sym(ksym);
                                this->push_sym(KS_Alt_R);

                        } else if (this->apple_server) {
...
//                                                 this->remove_state_mode = true;
//                                                 this->push_sym(this->is_right_alt_pressed() ? KS_Alt_R : KS_Alt_LL);
//                                                 this->push_sym(0xa4); /* @ */
//                                                 this->push_sym(this->is_right_alt_pressed() ? KS_Alt_R : KS_Alt_L);
//                                             } else {
//                                                 this->push_sym(ksym);
//                                             }
//                                             break;
...
//                                         case '#':
//                                             if (this->is_alt_pressed()) {
//                                                 this->add_state_mode = true;
//                                                 this->remove_state_mode = true;
//                                                 this->push_sym(this->is_right_alt_pressed() ? KS_Alt_R : KS_Alt_L);
//                                                 this->push_sym(KS_Shift_R);
//                                                 this->push_sym(0xa4); /* # */
//                                                 this->push_sym(KS_Shift_R);
//                                                 this->push_sym(this->is_right_alt_pressed() ? KS_Alt_R : KS_Alt_L);
//                                             } else {
...
bool KeymapSym::is_add_state_mode() {
    return this->add_state_mode;
}

bool KeymapSym::is_remove_state_mode() {
    return this->remove_state_mode;
}
...
0x0,              KS_Escape,        0x31,             0x32,             0x33,             0x34,             0x35,             0x36,
0x37,             0x38,             0x39,             0x30,             0xdf,             0xfe51,           KS_BackSpace,     KS_Tab,
0x71,             0x77,             0x65,             0x72,             0x74,             0x7a,             0x75,             0x69,
0x6f,             0x70,             0xfc,             0x2b,             KS_Return,        KS_Control_L,     0x61,             0x73,
0x64,             0x66,             0x67,             0x68,             0x6a,             0x6b,             0x6c,             0xf6,
0xe4,             0xfe52,           KS_Shift_L,       0x23,             0x79,             0x78,             0x63,             0x76,
0x62,             0x6e,             0x6d,             0x2c,             0x2e,             0x2d,             KS_Shift_R,       KS_KP_Multiply,
KS_Alt_L,         0x20,             KS_Caps_Lock,     KS_F1,            KS_F2,            KS_F3,            KS_F4,            KS_F5,
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           KS_Num_Lock,      KS_Scroll_Lock,   0xff95,
0xff97,           0xff9a,           KS_KP_Subtract,   0xff96,           0xff9d,           0xff98,           KS_KP_Add,        0xff9c,
0xff99,           0xff9b,           0xff9e,           0xff9f,           0x0,              KS_Hebrew_switch, 0x3c,             KS_L1,
KS_L2,            KS_Home,          KS_Up,            KS_Prior,         KS_Left,          0x0,              KS_Right,         KS_End,
KS_Down,          KS_Next,          KS_Insert,        KS_Delete,        KS_KP_Enter,      KS_Control_R,     KS_Pause,         KS_Print,
KS_KP_Divide,     0xfe03,           0x0,              KS_Super_L,       KS_Super_R,       KS_Menu,          0x0,              0x0,
0x0,              0x0,              0x0,              0x0,              0xfe03,           0x0,              KS_KP_Equal,      0x0,
    } ;

    const KeyLayout_t DEFAULT_shift_sym = {
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0x21,             0x22,             0xa7,             0x24,             0x25,             0x26,
0x2f,             0x28,             0x29,             0x3d,             0x3f,             0xfe50,           KS_BackSpace,     0xfe20,
0x51,             0x57,             0x45,             0x52,             0x54,             0x5a,             0x55,             0x49,
0x4f,             0x50,             0xdc,             0x2a,             KS_Return,        KS_Control_L,     0x41,             0x53,
0x44,             0x46,             0x47,             0x48,             0x4a,             0x4b,             0x4c,             0xd6,
0xc4,             0xb0,             KS_Shift_L,       0x27,             0x59,             0x58,             0x43,             0x56,
0x42,             0x4e,             0x4d,             0x3b,             0x3a,             0x5f,             KS_Shift_R,       KS_KP_Multiply,
KS_Meta_L,        0x20,             KS_Caps_Lock,     KS_F1,            KS_F2,            KS_F3,            KS_F4,            KS_F5,
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           0xfef9,           KS_Scroll_Lock,   KS_KP_7,
KS_KP_8,          KS_KP_9,          KS_KP_Subtract,   KS_KP_4,          KS_KP_5,          KS_KP_6,          KS_KP_Add,        KS_KP_1,
KS_KP_2,          KS_KP_3,          KS_KP_0,          KS_KP_Separator,  0x0,              KS_Hebrew_switch, 0x3e,             KS_L1,
KS_L2,            KS_Home,          KS_Up,            KS_Prior,         KS_Left,          0x0,              KS_Right,         KS_End,
KS_Down,          KS_Next,          KS_Insert,        KS_Delete,        KS_KP_Enter,      KS_Control_R,     KS_Pause,         KS_Print,
KS_KP_Divide,     0xfe03,           0x0,              KS_Super_L,       KS_Super_R,       KS_Menu,          0x0,              0x0,
0x0,              0x0,              0x0,              0x0,              0xfe03,           KS_Alt_L,         KS_KP_Equal,      KS_Super_L,
    } ;

    const KeyLayout_t DEFAULT_altgr_sym = {
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0xb9,             0xb2,             0xb3,             0xbc,             0xbd,             0xac,
0x7b,             0x5b,             0x5d,             0x7d,             0x5c,             0xfe5b,           KS_BackSpace,     KS_Tab,
0x40,             0x1b3,            XK_EuroSign,      0xb6,             0x3bc,            0x8fb,            0x8fe,            0x8fd,
0xf8,             0xfe,             0xfe57,           0xfe53,           KS_Return,        KS_Control_L,     0xe6,             0xdf,
0xf0,             0x1f0,            0x3bf,            0x2b1,            0x6a,             0x3a2,            0x1b3,            0xfe59,
0xfe52,           0xac,             KS_Shift_L,       0xfe50,           0xab,             0xbb,             0xa2,             0xad2,
0xad3,            0x6e,             0xb5,             0x8a3,            0xb7,             0xfe60,           KS_Shift_R,       KS_KP_Multiply,
KS_Alt_L,         0x20,             KS_Caps_Lock,     KS_F1,            KS_F2,            KS_F3,            KS_F4,            KS_F5,
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           KS_Num_Lock,      KS_Scroll_Lock,   0xff95,
0xff97,           0xff9a,           KS_KP_Subtract,   0xff96,           0xff9d,           0xff98,           KS_KP_Add,        0xff9c,
0xff99,           0xff9b,           0xff9e,           0xff9f,           0x0,              KS_Hebrew_switch, 0x7c,             KS_L1,
KS_L2,            KS_Home,          KS_Up,            KS_Prior,         KS_Left,          0x0,              KS_Right,         KS_End,
KS_Down,          KS_Next,          KS_Insert,        KS_Delete,        KS_KP_Enter,      KS_Control_R,     KS_Pause,         0x0,
KS_KP_Divide,     0xfe03,           0x0,              KS_Super_L,       KS_Super_R,       KS_Menu,          0x0,              0x0,
0x0,              0x0,              0x0,              0x0,              0xfe03,           0x0,              KS_KP_Equal,      0x0,
    } ;
...
0x37,             0x38,             0x39,             0x30,             0xdf,             0xfe51,           KS_BackSpace,     KS_Tab,
0x51,             0x57,             0x45,             0x52,             0x54,             0x5a,             0x55,             0x49,
0x4f,             0x50,             0xdc,             0x2b,             KS_Return,        KS_Control_L,     0x41,             0x53,
0x44,             0x46,             0x47,             0x48,             0x4a,             0x4b,             0x4c,             0xd6,
0xc4,             0xfe52,           KS_Shift_L,       0x23,             0x59,             0x58,             0x43,             0x56,
0x42,             0x4e,             0x4d,             0x2c,             0x2e,             0x2d,             KS_Shift_R,       KS_KP_Multiply,
KS_Alt_L,         0x20,             KS_Caps_Lock,     KS_F1,            KS_F2,            KS_F3,            KS_F4,            KS_F5,
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           KS_Num_Lock,      KS_Scroll_Lock,   0xff95,
0xff97,           0xff9a,           KS_KP_Subtract,   0xff96,           0xff9d,           0xff98,           KS_KP_Add,        0xff9c,
0xff99,           0xff9b,           0xff9e,           0xff9f,           0x0,              KS_Hebrew_switch, 0x3c,             KS_L1,
    ...
    switch (keyb){
        ...
        case 0x0407: // GERMAN
        {
                const KeyLayout_t x0407_noshift_sym = {
                        ...
                        0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,   // 08 - 0F
                        0x37,    0x38,    0x39,    0x30,    0xdf,    0xfe51,  KS_BackSpace,  KS_Tab, // 10 - 17
                        0x71,    0x77,    0x65,    0x72,    0x74,    0x7a,    0x75,    0x69,   // 18 - 1F
                        0x6f,    0x70,    0xfc,    0x2b,    KS_Return,  KS_Control_L,  0x61,    0x73,   // 20 - 27
                        0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,   // 28 - 2F
                        0xe4,    0xfe52,  KS_Shift_L,  0x23,    0x79,    0x78,    0x63,    0x76,   // 30 - 37
                        0x62,    0x6e,    0x6d,    0x2c,    0x2e,    0x2d,    KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                        KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95, // 48 - 4F
                        0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c, // 50 - 57
                        0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1, // 58 - 5F
                        KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End, // 60 - 67
                        KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print, // 68 - 6F
                        KS_KP_Divide,  0xfe03,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,    // 70 - 77
                        0x0,     0x0,     0x0,     0x0,     0xfe03,  0x0,     KS_KP_Equal,  0x0,    // 78 - 7F
                };
                const KeyLayout_t x0407_shift_sym = {
                        0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,    // 00 - 07
                        0x0,     KS_Escape,  0x21,    0x22,    0xa7,    0x24,    0x25,    0x26,   // 08 - 0F
                        0x2f,    0x28,    0x29,    0x3d,    0x3f,    0xfe50,  KS_BackSpace,  0xfe20, // 10 - 17
                        0x51,    0x57,    0x45,    0x52,    0x54,    0x5a,    0x55,    0x49,   // 18 - 1F
                        0x4f,    0x50,    0xdc,    0x2a,    KS_Return,  KS_Control_L,  0x41,    0x53,   // 20 - 27
                        0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0xd6,   // 28 - 2F
                        0xc4,    0xb0,    KS_Shift_L,  0x27,    0x59,    0x58,    0x43,    0x56,   // 30 - 37
                        0x42,    0x4e,    0x4d,    0x3b,    0x3a,    0x5f,    KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                        KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7, // 48 - 4F
                        KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1, // 50 - 57
                        KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Separator,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1, // 58 - 5F
                        KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End, // 60 - 67
                        KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print, // 68 - 6F
                        KS_KP_Divide,  0xfe03,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,    // 70 - 77
                        0x0,     0x0,     0x0,     0x0,     0xfe03,  KS_Alt_L,  KS_KP_Equal,  KS_Super_L, // 78 - 7F
                };
                const KeyLayout_t x0407_altgr_sym = {
                        0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,    // 00 - 07
                        0x0,     KS_Escape,  0xb9,    0xb2,    0xb3,    0xbc,    0xbd,    0xac,   // 08 - 0F
                        0x7b,    0x5b,    0x5d,    0x7d,    0x5c,    0xfe5b,  KS_BackSpace,  KS_Tab, // 10 - 17
                        0x40,    0x1b3,   XK_EuroSign,  0xb6,    0x3bc,   0x8fb,   0x8fe,   0x8fd,  // 18 - 1F
                        0xf8,    0xfe,    0xfe57,  0xfe53,  KS_Return,  KS_Control_L,  0xe6,    0xdf,   // 20 - 27
                        0xf0,    0x1f0,   0x3bf,   0x2b1,   0x6a,    0x3a2,   0x1b3,   0xfe59, // 28 - 2F
                        0xfe52,  0xac,    KS_Shift_L,  0xfe50,  0xab,    0xbb,    0xa2,    0xad2,  // 30 - 37
                        0xad3,   0x6e,    0xb5,    0x8a3,   0xb7,    0xfe60,  KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                        KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95, // 48 - 4F
                        0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c, // 50 - 57
                        0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x7c,    KS_L1, // 58 - 5F
                        KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End, // 60 - 67
                        KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  0x0,    // 68 - 6F
                        KS_KP_Divide,  0xfe03,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,    // 70 - 77
                        0x0,     0x0,     0x0,     0x0,  0xfe03,     0x0,     KS_KP_Equal,  0x0,    // 78 - 7F
                };
                const KeyLayout_t x0407_capslock_sym = {
                        ...
                        0x37,    0x38,    0x39,    0x30,    0xdf,    0xfe51,  KS_BackSpace,  KS_Tab, // 10 - 17
                        0x51,    0x57,    0x45,    0x52,    0x54,    0x5a,    0x55,    0x49,   // 18 - 1F
                        0x4f,    0x50,    0xdc,    0x2b,    KS_Return,  KS_Control_L,  0x41,    0x53,   // 20 - 27
                        0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0xd6,   // 28 - 2F
                        0xc4,    0xfe52,  KS_Shift_L,  0x23,    0x59,    0x58,    0x43,    0x56,   // 30 - 37
                        0x42,    0x4e,    0x4d,    0x2c,    0x2e,    0x2d,    KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                        KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95, // 48 - 4F
                        0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c, // 50 - 57
                        0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1, // 58 - 5F
                ...
                const KeyLayout_t x0407_shiftcapslock_sym = {
                        ...
                        0x2f,    0x28,    0x29,    0x3d,    0x3f,    0xfe50,  KS_BackSpace,  0xfe20, // 10 - 17
                        0x71,    0x77,    0x65,    0x72,    0x74,    0x7a,    0x75,    0x69,   // 18 - 1F
                        0x6f,    0x70,    0xfc,    0x2a,    KS_Return,  KS_Control_L,  0x61,    0x73,   // 20 - 27
                        0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,   // 28 - 2F
                        0xe4,    0xb0,    KS_Shift_L,  0x27,    0x79,    0x78,    0x63,    0x76,   // 30 - 37
                        0x62,    0x6e,    0x6d,    0x3b,    0x3a,    0x5f,    KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                        KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7, // 48 - 4F
                        KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1, // 50 - 57
                        KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Separator,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1, // 58 - 5F
        ...
        case 0x0409: // United States
        {
                const KeyLayout_t x0409_noshift_sym = {
                        0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                        0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                        0x37,    0x38,    0x39,    0x30,    0x2d,    0x3d,    KS_BackSpace,  KS_Tab,
                        0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                        0x6f,    0x70,    0x5b,    0x5d,    KS_Return,  KS_Control_L,  0x61,    0x73,
                        0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x3b,
                        0x27,    0x60,    KS_Shift_L,  0x5c,    0x7a,    0x78,    0x63,    0x76,
                        0x62,    0x6e,    0x6d,    0x2c,    0x2e,    0x2f,    KS_Shift_R,  KS_KP_Multiply,
                        KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                        0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                        0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1,
                        KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End,
                        KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print,
                        KS_KP_Divide,  KS_Alt_R,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,
                        0x0,     0x0,     0x0,     0x0,     0xfe03,  0x0,     KS_KP_Equal,  0x0,

                };
                const KeyLayout_t x0409_shift_sym = {
                        0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                        0x0,     KS_Escape,  0x21,    0x40,    0x23,    0x24,    0x25,    0x5e,
                        0x26,    0x2a,    0x28,    0x29,    0x5f,    0x2b,    KS_BackSpace,  0xfe20,
                        0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                        0x4f,    0x50,    0x7b,    0x7d,    KS_Return,  KS_Control_L,  0x41,    0x53,
                        0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x3a,
                        0x22,    0x7e,    KS_Shift_L,  0x7c,    0x5a,    0x58,    0x43,    0x56,
                        0x42,    0x4e,    0x4d,    0x3c,    0x3e,    0x3f,    KS_Shift_R,  KS_KP_Multiply,
                        KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                        KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                        KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
                        KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End,
                        KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print,
                        KS_KP_Divide,  KS_Meta_R,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,
                        0x0,     0x0,     0x0,     0x0,     0xfe03,  KS_Alt_L,  KS_KP_Equal,  KS_Super_L,
                };
                ...
                const KeyLayout_t x0409_capslock_sym = {
                        ...
                        0x37,    0x38,    0x39,    0x30,    0x2d,    0x3d,    KS_BackSpace,  KS_Tab,
                        0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                        0x4f,    0x50,    0x5b,    0x5d,    KS_Return,  KS_Control_L,  0x41,    0x53,
                        0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x3b,
                        0x27,    0x60,    KS_Shift_L,  0x5c,    0x5a,    0x58,    0x43,    0x56,
                        0x42,    0x4e,    0x4d,    0x2c,    0x2e,    0x2f,    KS_Shift_R,  KS_KP_Multiply,
                        KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                        0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                        0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1,
                ...
                const KeyLayout_t x0409_shiftcapslock_sym = {
                        ...
                        0x26,    0x2a,    0x28,    0x29,    0x5f,    0x2b,    KS_BackSpace,  0xfe20,
                        0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                        0x6f,    0x70,    0x7b,    0x7d,    KS_Return,  KS_Control_L,  0x61,    0x73,
                        0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x3a,
                        0x22,    0x7e,    KS_Shift_L,  0x7c,    0x7a,    0x78,    0x63,    0x76,
                        0x62,    0x6e,    0x6d,    0x3c,    0x3e,    0x3f,    KS_Shift_R,  KS_KP_Multiply,
                        KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                        KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                        KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                        KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
...
// +------+------+----+------------------------+-------+------+------+-------+  +----+----+----+  +---------+----+-----+
                ...
                // This table translates the RDP scancodes to X11 scancodes :
                //  - the block (0-127) simply applies the +8 Windows to X11 translation and forces some 0 values

                const KeyLayout_t x040c_noshift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,    // 00 - 07
                            0x0,     KS_Escape,  0x26,    0xe9,    0x22,    0x27,    0x28,    0x2d,   // 08 - 0F
                            0xe8,    0x5f,    0xe7,    0xe0,    0x29,    0x3d,    KS_BackSpace,  KS_Tab, // 10 - 17
                            0x61,    0x7a,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,   // 18 - 1F
                            0x6f,    0x70,    0xfe52,  0x24,    KS_Return,  KS_Control_L,  0x71,    0x73,   // 20 - 27
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x6d,   // 28 - 2F
                            0xf9,    0xb2,    KS_Shift_L,  0x2a,    0x77,    0x78,    0x63,    0x76,   // 30 - 37
                            0x62,    0x6e,    0x2c,    0x3b,    0x3a,    0x21,    KS_Shift_R,  KS_KP_Multiply, // 38 - 3F
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5, // 40 - 47
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95, // 48 - 4F
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c, // 50 - 57
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1, // 58 - 5F
                ...
                const KeyLayout_t x040c_shift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0, // 00 - 07
                            0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0xb0,    0x2b,    KS_BackSpace,  0xfe20,
                            0x41,    0x5a,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xfe57,  0xa3,    KS_Return,  KS_Control_L,  0x51,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x4d,
                            0x25,    0x7e,    KS_Shift_L,  0xb5,    0x57,    0x58,    0x43,    0x56,
                            0x42,    0x4e,    0x3f,    0x2e,    0x2f,    0xa7,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
                ...
                const KeyLayout_t x040c_capslock_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x26,    0xc9,    0x22,    0x27,    0x28,    0x2d,
                            0xc8,    0x5f,    0xc7,    0xc0,    0x29,    0x3d,    KS_BackSpace,  KS_Tab,
                            0x41,    0x5a,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xfe52,  0x24,    KS_Return,  KS_Control_L,  0x51,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x4d,
                            0xd9,    0xb2,    KS_Shift_L,  0x2a,    0x57,    0x58,    0x43,    0x56,
                            0x42,    0x4e,    0x2c,    0x3b,    0x3a,    0x21,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1,
                ...
                const KeyLayout_t x040c_altgr_sym = {
                            ...
                            // `      \\       ^        @         ]       }
                            0x60,    0x5c,    0x5e,    0x40,    0x5d,    0x7d,    KS_BackSpace,  KS_Tab,
                            0xe6,    0xab,    XK_EuroSign,  0xb6,    0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0xf8,    0xfe,    0xfe57,  0xa4,    KS_Return,  KS_Control_L,  0x40,    0xdf,
                            0xf0,    0x1f0,   0x3bf,   0x2b1,   0x6a,    0x3a2,   0x1b3,   0xb5,
                            0xfe52,  0xac,    KS_Shift_L,  0xfe50,  0x1b3,   0xbb,    0xa2,    0xad2,
                            0xad3,   0x6e,    0xfe51,  0x8a3,   0xb7,    0xfe60,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x7c,    KS_L1,
                ...
                const KeyLayout_t x040c_shiftcapslock_sym = {
                            ...
                            0x6f,    0x70,    0xfe57,  0xa3,    KS_Return,  KS_Control_L,  0x71,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x6d,
                            0x25,    0x7e,    KS_Shift_L,  0x39c,   0x77,    0x78,    0x63,    0x76,
                            0x62,    0x6e,    0x3f,    0x2e,    0x2f,    0xa7,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
        ...
        case 0x0410: // Italian
        {
                const KeyLayout_t x0410_noshift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0x27,    0xec,    KS_BackSpace,  KS_Tab,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,    0xe8,    0x2b,    KS_Return,  KS_Control_L,  0x61,    0x73,
                ...
                const KeyLayout_t x0410_shift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x21,    0x22,    0xa3,    0x24,    0x25,    0x26,
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,    0x5e,    KS_BackSpace,  0xfe20,
                            0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xe9,    0x2a,    KS_Return,  KS_Control_L,  0x41,    0x53,
                ...
                const KeyLayout_t x0410_altgr_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0xb9,    0xb2,    0xb3,    0xbc,    0xbd,    0xac,
                            0x7b,    0x5b,    0x5d,    0x7d,    0x60,    0x7e,    KS_BackSpace,  KS_Tab,
                            0x40,    0x1b3,   XK_EuroSign,  0xb6,    0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0xf8,    0xfe,    0x5b,    0x5d,    KS_Return,  KS_Control_L,  0xe6,    0xdf,
                            0xf0,    0x1f0,   0x3bf,   0x2b1,   0x6a,    0x3a2,   0x1b3,   0x40,
                            0x23,    0xac,    KS_Shift_L,  0xfe50,  0xab,    0xbb,    0xa2,    0xad2,
                            0xad3,   0xf1,    0xb5,    0xfe51,  0xb7,    0xfe54,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,   0x0,    KS_Hebrew_switch,  0xab,    KS_L1,
                            KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End,
                            KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  0x0,
                            KS_KP_Divide,  0xfe03,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,
                            0x0,     0x0,     0x0,     0x0,     0xfe03,  0x0,     KS_KP_Equal,  0x0,
                ...
                const KeyLayout_t x0410_capslock_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0x27,    0xcc,    KS_BackSpace,  KS_Tab,
                            0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xc8,    0x2b,    KS_Return,  KS_Control_L,  0x41,    0x53,
                ...
                const KeyLayout_t x0410_shiftcapslock_sym = {
                            ...
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,    0x5e,    KS_BackSpace,  0xfe20,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,    0xc9,    0x2a,    KS_Return,  KS_Control_L,  0x61,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xc7,
                            0xb0,    0x7c,    KS_Shift_L,  0xa7,    0x7a,    0x78,    0x63,    0x76,
                            0x62,    0x6e,    0x6d,    0x3b,    0x3a,    0x5f,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
        ...
        case 0x0419: // Russian
        {
                const KeyLayout_t x0419_noshift_sym = {
                            ...
                            0x6dd,   0x6da,   0x6c8,   0x6df,   KS_Return,  KS_Control_L,  0x6c6,   0x6d9,
                            0x6d7,   0x6c1,   0x6d0,   0x6d2,   0x6cf,   0x6cc,   0x6c4,   0x6d6,
                            0x6dc,   0x6a3,   KS_Shift_L,  0x5c,    0x6d1,   0x6de,   0x6d3,   0x6cd,
                            0x6c9,   0x6d4,   0x6d8,   0x6c2,   0x6c0,   0x2f,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x2f,    KS_L1,
                            KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End,
                            KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print,
                            KS_KP_Divide,  KS_Alt_R,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,
                            0x0,     0x0,     0x0,     0x0,     0xfe03,  0x0,     KS_KP_Equal,  0x0,
                ...
                const KeyLayout_t x0419_shift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x21,    0x22,    0x23,    0x2a,    0x3a,    0x2c,
                            0x2e,    0x3b,    0x28,    0x29,    0x5f,    0x2b,    KS_BackSpace,  0xfe20,
                            0x6ea,   0x6e3,   0x6f5,   0x6eb,   0x6e5,   0x6ee,   0x6e7,   0x6fb,
                            0x6fd,   0x6fa,   0x6e8,   0x6ff,   KS_Return,  KS_Control_L,  0x6e6,   0x6f9,
                            0x6f7,   0x6e1,   0x6f0,   0x6f2,   0x6ef,   0x6ec,   0x6e4,   0x6f6,
                            0x6fc,   0x6b3,   KS_Shift_L,  0x7c,    0x6f1,   0x6fe,   0x6f3,   0x6ed,
                            0x6e9,   0x6f4,   0x6f8,   0x6e2,   0x6e0,   0x3f,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Separator,  0x0,     KS_Hebrew_switch,  0x7c,    KS_L1,
                            KS_L2,  KS_Home,  KS_Up,  KS_Prior,  KS_Left,  0x0,     KS_Right,  KS_End,
                            KS_Down,  KS_Next,  KS_Insert,  KS_Delete,  KS_KP_Enter,  KS_Control_R,  KS_Pause,  KS_Print,
                            KS_KP_Divide,  KS_Meta_R,  0x0,     KS_Super_L,  KS_Super_R,  KS_Menu,  0x0,     0x0,
                            0x0,     0x0,     0x0,     0x0,     0xfe03,  KS_Alt_L,  KS_KP_Equal,  KS_Super_L,
                ...
                const KeyLayout_t x0419_capslock_sym = {
                            ...
                            0x6e9,   0x6f4,   0x6f8,   0x6e2,   0x6e0,    0x2f,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,    0x20,  KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,     0x0,  KS_Hebrew_switch,    0x2f,  KS_L1,
                ...
                const KeyLayout_t x0419_shiftcapslock_sym = {
                            ...
                            0x6c9,   0x6d4,   0x6d8,   0x6c2,   0x6c0,    0x3f,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,    0x20,  KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Separator,     0x0,  KS_Hebrew_switch,    0x7c,  KS_L1,
        ...
        case 0x041d: // Swedish
        {
                const KeyLayout_t x041d_noshift_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0x2b,  0xfe51,  KS_BackSpace,  KS_Tab,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,    0xe5,  0xfe57,  KS_Return,  KS_Control_L,    0x61,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,
                ...
                const KeyLayout_t x041d_shift_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x21,    0x22,    0x23,    0xa4,    0x25,    0x26,
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,  0xfe50,  KS_BackSpace,  0xfe20,
                            0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xc5,  0xfe52,  KS_Return,  KS_Control_L,    0x41,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0xd6,
                ...
                const KeyLayout_t x041d_altgr_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0xa1,    0x40,    0xa3,    0x24,  XK_EuroSign,    0xa5,
                            0x7b,    0x5b,    0x5d,    0x7d,    0x5c,    0xb1,  KS_BackSpace,  KS_Tab,
                            0x40,   0x1b3,  XK_EuroSign,    0xae,    0xfe,   0x8fb,   0x8fe,   0x8fd,
                            0x13bd,    0xfe,  0xfe57,  0xfe53,  KS_Return,  KS_Control_L,    0xaa,    0xdf,
                            0xf0,   0x1f0,   0x3bf,   0x2b1,    0x6a,   0x3a2,   0x1b3,    0xf8,
                            0xe6,    0xb6,  KS_Shift_L,    0xb4,    0xab,    0xbb,    0xa9,   0xad2,
                            0xad3,    0x6e,    0xb5,  0xfe5b,    0xb7,  0xfe60,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,    0x20,  KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,     0x0,  KS_Hebrew_switch,    0x7c,  KS_L1,
                ...
                const KeyLayout_t x041d_capslock_sym = {
                            ...
                            0x37,    0x38,    0x39,    0x30,    0x2b,  0xfe51,  KS_BackSpace,  KS_Tab,
                            0x51,    0x57,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xc5,  0xfe57,  KS_Return,  KS_Control_L,    0x41,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0xd6,
                ...
                const KeyLayout_t x041d_shiftcapslock_sym = {
                            ...
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,  0xfe50,  KS_BackSpace,  0xfe20,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,    0xe5,  0xfe52,  KS_Return,  KS_Control_L,    0x61,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,
        ...
        case 0x046e: // Luxemburgish
        {
                const KeyLayout_t x046e_noshift_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0x27,    0x5e,  KS_BackSpace,  KS_Tab,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x7a,    0x75,    0x69,
                            0x6f,    0x70,    0x5b,    0x5d,  KS_Return,  KS_Control_L,    0x61,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,
                ...
                const KeyLayout_t x046e_shift_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x2b,    0x22,    0x2a,     0x0,    0x25,    0x26,
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,    0x60,  KS_BackSpace,  0xfe20,
                            0x51,    0x57,    0x45,    0x52,    0x54,    0x5a,    0x55,    0x49,
                            0x4f,    0x50,    0x7b,    0x21,  KS_Return,  KS_Control_L,    0x41,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x3a,
                ...
                const KeyLayout_t x046e_altgr_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x7e,    0x23,    0x7b,    0x5b,    0x7c,    0x60,
                            0x5c,    0x5e,    0x40,    0x5d,    0x7d,    0x3d,  KS_BackSpace,  KS_Tab,
                            0x40,   0x1b3,  XK_EuroSign,    0xb6,   0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0xf8,    0xfe,  0xfe57,  0xfe53,  KS_Return,  KS_Control_L,    0xe6,    0xdf,
                            0xf0,   0x1f0,   0x3bf,   0x2b1,    0x6a,   0x3a2,   0x1b3,  0xfe59,
                ...
                const KeyLayout_t x046e_shiftcapslock_sym = {
                            ...
                            0x2f,    0x28,    0x29,    0x3d,    0x3f,  0xfe50,  KS_BackSpace,  0xfe20,
                            0x71,    0x77,    0x65,    0x72,    0x74,    0x7a,    0x75,    0x69,
                            0x6f,    0x70,    0xfc,    0x2a,  KS_Return,  KS_Control_L,    0x61,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0xf6,
        ...
        case 0x0807: // German Swizerland
        {
                ...
                const KeyLayout_t x0807_altgr_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x7c,    0x40,    0x23,     0x0,     0x0,     0x0,
                            0x7c,     0x0,     0x0,    0x5d,    0x60,    0x7e,  KS_BackSpace,  KS_Tab,
                            0x40,   0x1b3,  XK_EuroSign,    0xb6,   0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0x5b,    0x5b,    0x5b,    0x5d,  KS_Return,  KS_Control_L,    0xe6,    0xdf,
                            0xf0,   0x1f0,   0x3bf,   0x2b1,    0x6a,   0x3a2,   0x1b3,  0xfe59,
...
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           KS_Num_Lock,      KS_Scroll_Lock,   0xff95,
0xff97,           0xff9a,           KS_KP_Subtract,   0xff96,           0xff9d,           0xff98,           KS_KP_Add,        0xff9c,
0xff99,           0xff9b,           0xff9e,           0xff9f,           0x0,              KS_Hebrew_switch, 0x5c,             KS_L1,
KS_L2,            KS_Home,          KS_Up,            KS_Prior,         KS_Left,          0x0,              KS_Right,         KS_End,
KS_Down,          KS_Next,          KS_Insert,        KS_Delete,        KS_KP_Enter,      KS_Control_R,     KS_Pause,         KS_Print,
KS_KP_Divide,     0xfe03,           0x0,              KS_Super_L,       KS_Super_R,       KS_Menu,          0x0,              0x0,
0x0,              0x0,              0x0,              0x0,              0xfe03,           0x0,              KS_KP_Equal,      0x0,
...
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0x21,             0x22,             0xa3,             0x24,             0x25,             0x5e,
0x26,             0x2a,             0x28,             0x29,             0x5f,             0x2b,             KS_BackSpace,     0xfe20,
0x51,             0x57,             0x45,             0x52,             0x54,             0x59,             0x55,             0x49,
0x4f,             0x50,             0x7b,             0x7d,             KS_Return,        KS_Control_L,     0x41,             0x53,
0x44,             0x46,             0x47,             0x48,             0x4a,             0x4b,             0x4c,             0x3a,
...
KS_F6,            KS_F7,            KS_F8,            KS_F9,            KS_F10,           0xfef9,           KS_Scroll_Lock,   KS_KP_7,
KS_KP_8,          KS_KP_9,          KS_KP_Subtract,   KS_KP_4,          KS_KP_5,          KS_KP_6,          KS_KP_Add,        KS_KP_1,
KS_KP_2,          KS_KP_3,          KS_KP_0,          KS_KP_Decimal,    0x0,              KS_Hebrew_switch, 0x7c,             KS_L1,
KS_L2,            KS_Home,          KS_Up,            KS_Prior,         KS_Left,          0x0,              KS_Right,         KS_End,
KS_Down,          KS_Next,          KS_Insert,        KS_Delete,        KS_KP_Enter,      KS_Control_R,     KS_Pause,         KS_Print,
KS_KP_Divide,     KS_Meta_R,        0x0,              KS_Super_L,       KS_Super_R,       KS_Menu,          0x0,              0x0,
0x0,              0x0,              0x0,              0x0,              0xfe03,           KS_Alt_L,         KS_KP_Equal,      KS_Super_L,
...
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0x31,             0x32,             0x33,             XK_EuroSign,      0x35,             0x36,
0x37,             0x38,             0x39,             0x30,             0x2d,             0x3d,             KS_BackSpace,     KS_Tab,
0x71,             0x77,             0xe9,             0x72,             0x74,             0x79,             0xfa,             0xed,
0xf3,             0x70,             0x5b,             0x5d,             KS_Return,        KS_Control_L,     0xe1,             0x73,
0x64,             0x66,             0x67,             0x68,             0x6a,             0x6b,             0x6c,             0x3b,
...
0x0,              0x0,              0x0,              0x0,              0xfe03,           KS_Alt_L,         KS_KP_Equal,      KS_Super_L,
        ...
        case 0x080c: // French Belgium
        {
                const KeyLayout_t x080c_noshift_sym = {
                                0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                                0x0,  KS_Escape,    0x26,    0xe9,    0x22,    0x27,    0x28,    0x2d,
                            0xe8,    0x5f,    0xe7,    0xe0,    0x29,    0x3d,  KS_BackSpace,  KS_Tab,
                            0x61,    0x7a,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,  0xfe52,    0x24,  KS_Return,  KS_Control_L,    0x71,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x6d,
                            0xf9,    0xb2,  KS_Shift_L,    0x2a,    0x77,    0x78,    0x63,    0x76,
                            0x62,    0x6e,    0x2c,    0x3b,    0x3a,    0x21,  KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,    0x20,  KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,     0x0,  KS_Hebrew_switch,    0x3c,  KS_L1,
                ...
                const KeyLayout_t x080c_altgr_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0xb9,    0x7e,    0x24,    0x7b,    0x5b,    0x7c,
                            0x60,    0x5c,    0x5e,    0x40,    0x5d,    0x7d,    KS_BackSpace,  KS_Tab,
                            0xe6,    0xab,    XK_EuroSign,  0xb6,    0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0xf8,    0xfe,    0xfe57,  0xa4,    KS_Return,  KS_Control_L,  0x40,    0xdf,
                            0xf0,    0x1f0,   0x3bf,   0x2b1,   0x6a,    0x3a2,   0x1b3,   0xb5,
        ...
        case 0x0813: // Dutch Belgium
        {
                const KeyLayout_t x0813_noshift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x26,    0xe9,    0x22,    0x27,    0x28,    0x2d,
                            0xe8,    0x21,    0xe7,    0xe0,    0x29,    0x2d,    KS_BackSpace,  KS_Tab,
                            0x61,    0x7a,    0x65,    0x72,    0x74,    0x79,    0x75,    0x69,
                            0x6f,    0x70,    0xfe52,  0x24,    KS_Return,  KS_Control_L,  0x71,    0x73,
                            0x64,    0x66,    0x67,    0x68,    0x6a,    0x6b,    0x6c,    0x6d,
                            0xf9,    0xb2,    KS_Shift_L,  0x2a,    0x77,    0x78,    0x63,    0x76,
                            0x62,    0x6e,    0x2c,    0x3b,    0x3a,    0x3d,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x3c,    KS_L1,
                ...
                const KeyLayout_t x0813_shift_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0x31,    0x32,    0x33,    0x34,    0x35,    0x36,
                            0x37,    0x38,    0x39,    0x30,    0xb0,    0x5f,    KS_BackSpace,  0xfe20,
                            0x41,    0x5a,    0x45,    0x52,    0x54,    0x59,    0x55,    0x49,
                            0x4f,    0x50,    0xfe57,  0xa3,    KS_Return,  KS_Control_L,  0x51,    0x53,
                            0x44,    0x46,    0x47,    0x48,    0x4a,    0x4b,    0x4c,    0x4d,
                            0x25,    0x7e,    KS_Shift_L,  0xb5,    0x57,    0x58,    0x43,    0x56,
                            0x42,    0x4e,    0x3f,    0x2e,    0x2f,    0x2b,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Meta_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  0xfef9,  KS_Scroll_Lock,  KS_KP_7,
                            KS_KP_8,  KS_KP_9,  KS_KP_Subtract,  KS_KP_4,  KS_KP_5,  KS_KP_6,  KS_KP_Add,  KS_KP_1,
                            KS_KP_2,  KS_KP_3,  KS_KP_0,  KS_KP_Decimal,  0x0,     KS_Hebrew_switch,  0x3e,    KS_L1,
                ...
                const KeyLayout_t x0813_altgr_sym = {
                            0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,     0x0,
                            0x0,     KS_Escape,  0xb9,    0x40,    0x23,    0x7b,    0x5b,    0x5e,
                            0x0,     0x0,     0x7b,    0x7d,    0x0,     0x0,     KS_BackSpace,  KS_Tab,
                            0xe6,    0xab,    XK_EuroSign,  0xb6,    0x3bc,   0x8fb,   0x8fe,   0x8fd,
                            0xf8,    0xfe,    0x5b,    0x5d,    KS_Return,  KS_Control_L,  0x40,    0xdf,
                            0xf0,    0x1f0,   0x3bf,   0x2b1,   0x6a,    0x3a2,   0x1b3,   0xb5,
                            0x27,    0x60,    KS_Shift_L,  0xfe50,  0x1b3,   0xbb,    0xa2,    0xad2,
                            0xad3,   0x6e,    0xfe51,  0x8a3,   0xb7,    0x7e,    KS_Shift_R,  KS_KP_Multiply,
                            KS_Alt_L,  0x20,    KS_Caps_Lock,  KS_F1,  KS_F2,  KS_F3,  KS_F4,  KS_F5,
                            KS_F6,  KS_F7,  KS_F8,  KS_F9,  KS_F10,  KS_Num_Lock,  KS_Scroll_Lock,  0xff95,
                            0xff97,  0xff9a,  KS_KP_Subtract,  0xff96,  0xff9d,  0xff98,  KS_KP_Add,  0xff9c,
                            0xff99,  0xff9b,  0xff9e,  0xff9f,  0x0,     KS_Hebrew_switch,  0x7c,    KS_L1,
...
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0x31,             0x32,             0x33,             0x34,             0x35,             0x36,
0x37,             0x38,             0x39,             0x30,             0x27,             0x3d,             KS_BackSpace,     KS_Tab,
0x71,             0x77,             0x65,             0x72,             0x74,             0x7a,             0x75,             0x69,
0x6f,             0x70,             0x5b,             0x5d,             KS_Return,        KS_Control_L,     0x61,             0x73,
0x64,             0x66,             0x67,             0x68,             0x6a,             0x6b,             0x6c,             0xf6,
0xe4,             0x5f,             KS_Shift_L,       0x24,             0x79,             0x78,             0x63,             0x76,
...
0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,              0x0,
0x0,              KS_Escape,        0x7c,             0x40,             0x23,             0x0,              0x0,              0x0,
0x0,              0x7c,             0x0,              0x5d,             0x60,             0x7e,             KS_BackSpace,     KS_Tab,
0x40,             0x1b3,            XK_EuroSign,      0xb6,             0x3bc,            0x8fb,            0x8fe,            0x8fd,
0x0,              0x0,              0x5b,             0x5d,             KS_Return,        KS_Control_L,     0xe6,             0xdf,
0xf0,             0x1f0,            0x3bf,            0x2b1,            0x6a,             0x3a2,            0x1b3,            0xfe59,
0x7b,             0xac,             KS_Shift_L,       0x7d,             0xab,             0xbb,             0xa2,             0xad2,
0xad3,            0x6e,             0xb5,             0x8a3,            0xb7,             0xfe60,           KS_Shift_R,       KS_KP_Multiply,
KS_Alt_L,         0x20,             KS_Caps_Lock,     KS_F1,            KS_F2,            KS_F3,            KS_F4,            KS_F5,
