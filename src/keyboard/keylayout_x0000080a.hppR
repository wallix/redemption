...
#ifndef _REDEMPTION_KEYBOARD_KEYLAYOUT_X0000080A_HPP_
#define _REDEMPTION_KEYBOARD_KEYLAYOUT_X0000080A_HPP_
...
const Keylayout::KeyLayout_t noMod = {
    ...
    /* x08 - x0F */       '7',    '8',    '9',    '0', 0x0027, 0x00BF, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00B4, 0x002B, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x28 - x2F */    0x007B, 0x007C, 0x0000, 0x007D,    'z',    'x',    'c',    'v',
...
const Keylayout::KeyLayout_t shift = {
    ...
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x00A1, 0x0008, 0x0000,
    /* x10 - x17 */       'Q',    'W',    'E',    'R',    'T',    'Y',    'U',    'I',
    /* x18 - x1F */       'O',    'P', 0x00A8, 0x002A, 0x000D, 0x0000,    'A',    'S',
    /* x20 - x27 */       'D',    'F',    'G',    'H',    'J',    'K',    'L', 0x00D1,
    /* x28 - x2F */    0x005B, 0x00B0, 0x0000, 0x005D,    'Z',    'X',    'C',    'V',
...
const Keylayout::KeyLayout_t altGr = {
    ...
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x005C, 0x0000, 0x0008, 0x0009,
    ...
    /* x28 - x2F */    0x005E, 0x00AC, 0x0000, 0x0060, 0x0000, 0x0000, 0x0000, 0x0000,
...
const Keylayout::KeyLayout_t ctrl = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x08 - x0F */    0x0000, 0x0000, 0x0000, 0x0000, 0x001C, 0x0000, 0x0008, 0x0009,
    /* x10 - x17 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x18 - x1F */    0x0000, 0x0000, 0x0000, 0x0000, 0x000D, 0x0000, 0x0000, 0x0000,
    /* x20 - x27 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x28 - x2F */    0x001B, 0x0000, 0x0000, 0x001D, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x30 - x37 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,    '*',
    /* x38 - x3F */    0x0000, 0x0020, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x40 - x47 */    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* x48 - x4F */    0x0000, 0x0000,    '-', 0x0000, 0x0000, 0x0000,    '+', 0x0000,
...
const Keylayout::KeyLayout_t capslock_shift = {
    /* x00 - x07 */    0x0000, 0x001B, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026,
    /* x08 - x0F */    0x002F, 0x0028, 0x0029, 0x003D, 0x003F, 0x00A1, 0x0008, 0x0009,
    /* x10 - x17 */       'q',    'w',    'e',    'r',    't',    'y',    'u',    'i',
    /* x18 - x1F */       'o',    'p', 0x00A8, 0x002A, 0x000D, 0x0000,    'a',    's',
    /* x20 - x27 */       'd',    'f',    'g',    'h',    'j',    'k',    'l', 0x00F1,
    /* x28 - x2F */    0x005B, 0x00B0, 0x0000, 0x005D,    'z',    'x',    'c',    'v',
...
static const Keylayout keylayout_x0000080a( x0000080a::LCID
                                          ...
                                          , x0000080a::shift
                                          , x0000080a::altGr
                                          , x0000080a::shiftAltGr
                                          , x0000080a::ctrl
                                          , x0000080a::capslock_noMod
                                          , x0000080a::capslock_shift
                                          , x0000080a::capslock_altGr
                                          , x0000080a::capslock_shiftAltGr
                                          , x0000080a::deadkeys
