 ...
 * @{
 */
inline void scale_data_rgb_to_bgr(uint8_t *dest, const uint8_t *src,
...
inline void scale_data(uint8_t *dest, const uint8_t *src,
                            unsigned int dest_width, unsigned int src_width,
                            unsigned int dest_height, unsigned int src_height,
                            unsigned int src_rowsize)
{
...
//printf("dest_width=%u dest_height=%u  Bpp=%u data=%p\n", dest_width, dest_height, Bpp, this->_data);
