namespace cfg {
    ...
    struct client {
        ...
        struct keyboard_layout_proposals {
            ...
            using spec_type = ::configs::spec_types::list<std::basic_string<char>>;
        ...
        struct rdp_compression {
            ...
            using spec_type = configs::RdpCompression;
        ...
        struct max_color_depth {
            ...
            using spec_type = configs::ColorDepth;
    ...
    struct context {
        ...
        struct auth_error_message {
            ...
            using spec_type = std::basic_string<char>;
            type value{};
        };
    ...
    struct crypto {
        ...
        struct key0 {
            ...
            using spec_type = ::configs::spec_types::fixed_binary<32>;
    ...
    struct globals {
        ...
        struct trace_type {
            ...
            using spec_type = configs::TraceType;
        ...
        struct listen_address {
            ...
            static constexpr bool is_writable() { return 0; }
            using type = std::string;
            using spec_type = ::configs::spec_types::ip;
            type value = "0.0.0.0";
        };
        ...
        struct png_path {
            ...
            static constexpr bool is_writable() { return 0; }
            using type = ::configs::spec_types::directory_path;
            using spec_type = ::configs::spec_types::directory_path;
            type value = PNG_PATH;
        };
        struct wrm_path {
            static constexpr bool is_readable() { return 0; }
    ...
    struct mod_rdp {
        ...
        struct extra_orders {
            ...
            static constexpr bool is_writable() { return 0; }
            using type = std::string;
            using spec_type = ::configs::spec_types::list<unsigned int>;
        ...
        struct session_probe_on_launch_failure {
            ...
            using spec_type = configs::SessionProbeOnLaunchFailure;
        ...
        struct server_cert_check {
            ...
            using spec_type = configs::ServerCertCheck;
            type value{static_cast<type>(1)};
        };
        ...
        struct server_access_allowed_message {
            ...
            using spec_type = configs::ServerNotification;
            type value{static_cast<type>(1)};
        };
    ...
    struct mod_vnc {
        ...
        struct encodings {
            ...
            static constexpr bool is_writable() { return 0; }
            using type = std::string;
            using spec_type = ::configs::spec_types::list<int>;
            type value{};
        };
        ...
        struct server_clipboard_encoding_type {
            ...
            using spec_type = configs::ClipboardEncodingType;
            type value{static_cast<type>(1)};
        };
        ...
        struct bogus_clipboard_infinite_loop {
            ...
            using spec_type = configs::VncBogusClipboardInfiniteLoop;
            type value{static_cast<type>(0)};
        };
    };
    ...
    struct session_log {
        ...
        struct keyboard_input_masking_level {
            ...
            using spec_type = configs::KeyboardInputMaskingLevel;
    ...
    struct translation {
        ...
        struct language {
            ...
            using spec_type = configs::Language;
            type value{static_cast<type>(0)};
        };
    ...
    struct video {
        ...
        struct capture_flags {
            ...
            using spec_type = configs::CaptureFlags;
            type value{static_cast<type>(3)};
        };
        ...
        struct disable_keyboard_log {
            ...
            using spec_type = configs::KeyboardLogFlags;
            type value{static_cast<type>(1)};
        };
        ...
        struct disable_clipboard_log {
            ...
            using spec_type = configs::ClipboardLogFlags;
            type value{static_cast<type>(1)};
        };
        ...
        struct disable_file_system_log {
            ...
            using spec_type = configs::FileSystemLogFlags;
            type value{static_cast<type>(1)};
        };
        ...
        struct wrm_color_depth_selection_strategy {
            ...
            using spec_type = configs::ColorDepthSelectionStrategy;
            type value{static_cast<type>(1)};
        };
        struct wrm_compression_algorithm {
            ...
            using spec_type = configs::WrmCompressionAlgorithm;
            type value{static_cast<type>(1)};
        };
    };
