    ...
    if (0) {}
        ...
        if (0) {}
            ...
            ::configs::parse(
                ...
                ::configs::spec_type<::configs::list<std::basic_string<char>>>{},
                value
            );
        }
        ...
        if (0) {}
            ...
            ::configs::parse(
                ...
                ::configs::spec_type<::configs::fixed_binary<32>>{},
                value
            );
        }
        ...
        if (0) {}
            ...
            ::configs::parse(
                ...
                ::configs::spec_type<::configs::path>{},
                value
            );
        }
        ...
        if (0) {}
            ...
            ::configs::parse(
                ...
                ::configs::spec_type<::configs::list<unsigned int>>{},
                value
            );
        }
        ...
        if (0) {}
            ...
            ::configs::parse(
                ...
                ::configs::spec_type<::configs::list<int>>{},
                value
            );
        }
