...
namespace cfg {
    ...
    /// AUTHID_GLOBALS_FRONT_CONNECTION_TIME <br/>
    ...
    struct globals::front_connection_time {
        ...
        static constexpr char const * name() { return "front_connection_time"; }
        // for old cppcheck
    ...
    /// AUTHID_GLOBALS_TARGET_CONNECTION_TIME <br/>
    /// type: std::chrono::milliseconds <br/>
    /// sesman <- proxy <br/>
    /// value{} <br/>
    struct globals::target_connection_time {
        ...
        static constexpr bool is_proxy_to_sesman() { return 1; }
        static constexpr char const * section() { return "globals"; }
        static constexpr char const * name() { return "target_connection_time"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct globals::support_connection_redirection_during_recording {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "globals"; }
        static constexpr char const * name() { return "support_connection_redirection_during_recording"; }
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{1};
    ...
    struct globals::rdp_keepalive_connection_interval {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "globals"; }
        static constexpr char const * name() { return "rdp_keepalive_connection_interval"; }
        using type = std::chrono::milliseconds;
        using sesman_and_spec_type = std::chrono::milliseconds;
        using mapped_type = sesman_and_spec_type;
        type value{0};
    ...
    /// AUTHID_SESSION_LOG_KEYBOARD_INPUT_MASKING_LEVEL <br/>
    ...
    struct mod_rdp::session_probe_disabled_features {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "session_probe_disabled_features"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct mod_rdp::session_probe_ignore_ui_less_processes_during_end_of_session_check {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "session_probe_ignore_ui_less_processes_during_end_of_session_check"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// AUTHID_MOD_RDP_SESSION_PROBE_CHILDLESS_WINDOW_AS_UNIDENTIFIED_INPUT_FIELD <br/>
    /// type: bool <br/>
    /// sesman -> proxy <br/>
    /// value{1} <br/>
    struct mod_rdp::session_probe_childless_window_as_unidentified_input_field {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "session_probe_childless_window_as_unidentified_input_field"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// AUTHID_MOD_RDP_SESSION_PROBE_LAUNCHER_ABORT_DELAY <br/>
    /// type: std::chrono::milliseconds <br/>
    /// sesman -> proxy <br/>
    /// value{2000} <br/>
    struct mod_rdp::session_probe_launcher_abort_delay {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "session_probe_launcher_abort_delay"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// AUTHID_MOD_RDP_WABAM_USES_TRANSLATED_REMOTEAPP <br/>
    /// type: bool <br/>
    /// sesman -> proxy <br/>
    /// value{0} <br/>
    struct mod_rdp::wabam_uses_translated_remoteapp {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "wabam_uses_translated_remoteapp"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct mod_rdp::use_license_store {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "use_license_store"; }
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{1};
    ...
    /// AUTHID_MOD_RDP_ENABLE_RESTRICTED_ADMIN_MODE <br/>
    /// type: bool <br/>
    /// sesman -> proxy <br/>
    /// value{0} <br/>
    struct mod_rdp::enable_restricted_admin_mode {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_rdp"; }
        static constexpr char const * name() { return "enable_restricted_admin_mode"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// AUTHID_MOD_VNC_SERVER_UNIX_ALT <br/>
    /// type: bool <br/>
    /// sesman -> proxy <br/>
    /// value{0} <br/>
    struct mod_vnc::server_unix_alt {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "mod_vnc"; }
        static constexpr char const * name() { return "server_unix_alt"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct context::psid {
        ...
        static constexpr bool is_proxy_to_sesman() { return 1; }
        static constexpr char const * section() { return "context"; }
        static constexpr char const * name() { return "psid"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// AUTHID_CONTEXT_SESSION_PROBE_WINDOWS_OF_THESE_APPLICATIONS_AS_UNIDENTIFIED_INPUT_FIELD <br/>
    /// type: std::string <br/>
    /// sesman -> proxy <br/>
    /// value{} <br/>
    struct context::session_probe_windows_of_these_applications_as_unidentified_input_field {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "context"; }
        static constexpr char const * name() { return "session_probe_windows_of_these_applications_as_unidentified_input_field"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct context::auth_notify_rail_exec_flags {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(147); }
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_notify_rail_exec_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(148); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_exec_result {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(149); }
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_flags {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(150); }
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_original_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(151); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(152); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_working_dir {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(153); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_arguments {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(154); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_account {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(155); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::auth_command_rail_exec_password {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(156); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rail_disconnect_message_delay {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(157); }
        using type = std::chrono::milliseconds;
    ...
    struct context::use_session_probe_to_launch_remote_program {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(158); }
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{1};
    ...
    struct context::session_probe_launch_error_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(159); }
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::is_wabam {
        ...
        static constexpr bool is_proxy_to_sesman() { return 0; }
        static constexpr char const * section() { return "context"; }
        static constexpr char const * name() { return "is_wabam"; }
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index() { return authid_t(160); }
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{0};
