...
void config_spec_definition(Writer && W)
{
    ...
    W.section("metrics", [&]
    {
        ...
        W.member(advanced_in_gui, no_sesman, type_<types::dirpath>(), "log_dir_path", set(CPP_EXPR(app_path(AppPath::Metrics))));
    ...
    W.section("debug", [&]
    {
        W.member(hidden_in_gui, no_sesman, type_<std::string>(), "fake_target_ip");
