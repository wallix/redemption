...
void config_spec_definition(Writer && W)
{
    ...
    W.section("globals", [&]
    {
        ...
        W.member(ini_and_gui, no_sesman, L, type_<bool>(), "allow_scale_factor", set(true));
        W.sep();
    ...
    W.section(W.names("mod_rdp", connpolicy::name{"rdp"}), [&]
    {
        ...
        W.member(hidden_in_gui, rdp_connpolicy | advanced_in_connpolicy, co_probe, L, type_<types::range<std::chrono::milliseconds, 0, 300000>>(), "session_probe_launcher_abort_delay", connpolicy::name{"launcher_abort_delay"}, sesman::name{"session_probe_launcher_abort_delay"}, set(2000));
        W.sep();
    ...
    W.section(W.names("mod_vnc", connpolicy::name{"vnc"}), [&]
    {
        ...
        W.member(hidden_in_gui, vnc_connpolicy, L, type_<bool>(), "server_unix_alt", set(true));
    });
    ...
    W.section("video", [&]
    {
        ...
        W.member(advanced_in_gui, rdp_connpolicy, sesman::authorize_ini_and_connpolicy{},  L, type_<KeyboardLogFlags>{}, sesman::type_<KeyboardLogFlagsCP>{}, "disable_keyboard_log", desc{
        ...
        W.sep();
        W.member(advanced_in_gui, no_sesman, L, type_<bool>(), "play_video_with_corrupted_bitmap", desc{"Needed to play a video with corrupted Bitmap Update."}, set(false));
    });
