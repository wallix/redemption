...
void config_spec_definition(Writer && W)
{
    ...
    W.section("globals", [&]
    {
        ...
        W.member(advanced_in_gui | iptables_in_gui | public_in_gui, no_sesman, L, type_<types::unsigned_>(), names{"port"}, desc{"Warning: Service will be automatically restarted and active sessions will be disconnected\nThe port set in this field must not be already used, otherwise the service will not run.\nChanging the port number will prevent WALLIX Access Manager from working properly."}, set(3389));
        ...
        W.member(advanced_in_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<bool>(), names{"enable_osd_display_remote_target"}, set(true), desc{"Show target address with F12."});
    ...
    W.section("audit", [&]
    {
        ...
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<std::string>(), names{"redis_address"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<types::unsigned_>(), names{"redis_port"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<std::string>(), names{"redis_password"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<types::unsigned_>(), names{"redis_db"});

        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<bool>(), names{"redis_use_tls"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<std::string>(), names{"redis_tls_cacert"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<std::string>(), names{"redis_tls_cert"});
        W.member(no_ini_no_gui, sesman_to_proxy, no_reset_back_to_selector, L, type_<std::string>(), names{"redis_tls_key"});
    });
