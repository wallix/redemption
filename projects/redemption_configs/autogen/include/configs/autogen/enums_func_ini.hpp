...
parse_error parse(CaptureFlags & x, spec_type<CaptureFlags> /*type*/, chars_view value)
;
...
parse_error parse(Level & x, spec_type<Level> /*type*/, chars_view value)
;
...
parse_error parse(Language & x, spec_type<Language> /*type*/, chars_view value)
;
...
parse_error parse(ClipboardEncodingType & x, spec_type<ClipboardEncodingType> /*type*/, chars_view value)
;
...
parse_error parse(KeyboardLogFlagsCP & x, spec_type<KeyboardLogFlagsCP> /*type*/, chars_view value)
;
...
parse_error parse(KeyboardLogFlags & x, spec_type<KeyboardLogFlags> /*type*/, chars_view value)
;
...
parse_error parse(ClipboardLogFlags & x, spec_type<ClipboardLogFlags> /*type*/, chars_view value)
;
...
parse_error parse(FileSystemLogFlags & x, spec_type<FileSystemLogFlags> /*type*/, chars_view value)
;
...
parse_error parse(ServerNotification & x, spec_type<ServerNotification> /*type*/, chars_view value)
;
...
parse_error parse(ServerCertCheck & x, spec_type<ServerCertCheck> /*type*/, chars_view value)
;
...
parse_error parse(TraceType & x, spec_type<TraceType> /*type*/, chars_view value)
;
...
parse_error parse(KeyboardInputMaskingLevel & x, spec_type<KeyboardInputMaskingLevel> /*type*/, chars_view value)
;
...
parse_error parse(SessionProbeOnLaunchFailure & x, spec_type<SessionProbeOnLaunchFailure> /*type*/, chars_view value)
;
...
parse_error parse(VncBogusClipboardInfiniteLoop & x, spec_type<VncBogusClipboardInfiniteLoop> /*type*/, chars_view value)
;
...
parse_error parse(ColorDepthSelectionStrategy & x, spec_type<ColorDepthSelectionStrategy> /*type*/, chars_view value)
;
...
parse_error parse(WrmCompressionAlgorithm & x, spec_type<WrmCompressionAlgorithm> /*type*/, chars_view value)
;
...
parse_error parse(RdpCompression & x, spec_type<RdpCompression> /*type*/, chars_view value)
;
...
parse_error parse(OcrLocale & x, spec_type<OcrLocale> /*type*/, chars_view value)
;
...
parse_error parse(BogusNumberOfFastpathInputEvent & x, spec_type<BogusNumberOfFastpathInputEvent> /*type*/, chars_view value)
;
...
parse_error parse(SessionProbeOnKeepaliveTimeout & x, spec_type<SessionProbeOnKeepaliveTimeout> /*type*/, chars_view value)
;
...
parse_error parse(SmartVideoCropping & x, spec_type<SmartVideoCropping> /*type*/, chars_view value)
;
...
parse_error parse(RdpModeConsole & x, spec_type<RdpModeConsole> /*type*/, chars_view value)
;
...
parse_error parse(SessionProbeDisabledFeature & x, spec_type<SessionProbeDisabledFeature> /*type*/, chars_view value)
;
...
parse_error parse(RdpStoreFile & x, spec_type<RdpStoreFile> /*type*/, chars_view value)
;
...
parse_error parse(SessionProbeOnAccountManipulation & x, spec_type<SessionProbeOnAccountManipulation> /*type*/, chars_view value)
;

template<> struct zstr_buffer_traits<ClientAddressSent> : zstr_buffer_traits<unsigned long> {};
...
parse_error parse(ClientAddressSent & x, spec_type<ClientAddressSent> /*type*/, chars_view value)
;
...
parse_error parse(ColorDepth & x, spec_type<ColorDepth> /*type*/, chars_view value)
;
...
parse_error parse(OcrVersion & x, spec_type<OcrVersion> /*type*/, chars_view value)
;
