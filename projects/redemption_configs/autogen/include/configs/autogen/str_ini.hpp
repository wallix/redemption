...
"#   0x0: none\n"
"#   0x1: disable keyboard log in syslog (not-applicable)\n"
"#   0x2: disable keyboard log in recorded sessions (not-applicable)\n"
...
"#   0x0: none\n"
"#   0x1: disable clipboard log in syslog (not-applicable)\n"
"#   0x2: disable clipboard log in recorded sessions (not-applicable)\n"
...
"#   0x0: none\n"
"#   0x1: disable (redirected) file system log in syslog (not-applicable)\n"
"#   0x2: disable (redirected) file system log in recorded sessions (not-applicable)\n"
