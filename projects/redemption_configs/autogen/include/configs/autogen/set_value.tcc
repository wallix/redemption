...
void Inifile::ConfigurationHolder::set_value(zstring_view key, zstring_view value) {
    if (0) {}
        ...
        else if (key == "ignore_password_field_of_server_redirection_packet"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::mod_rdp::ignore_password_field_of_server_redirection_packet&>(this->variables).value,
                ::configs::spec_type<bool>{},
                value
            );
        }
        ...
        if (0) {}
        ...
        else if (key == "redis_address"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::audit::redis_address&>(this->variables).value,
                ::configs::spec_type<std::string>{},
                value
            );
        }
            ...
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::audit::redis_password&>(this->variables).value,
                ::configs::spec_type<std::string>{},
                value
            );
        }
