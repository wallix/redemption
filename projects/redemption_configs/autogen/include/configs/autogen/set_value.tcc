...
void Inifile::ConfigurationHolder::set_value(zstring_view key, zstring_view value) {
    if (0) {}
        ...
        else if (key == "session_probe_clipboard_based_launcher_enable_wabam_affinity"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
        ...
        else if (key == "session_probe_process_command_line_retrieve_method"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::mod_rdp::session_probe_process_command_line_retrieve_method&>(this->variables).value,
                ::configs::spec_type<SessionProbeProcessCommandLineRetrieveMethod>{},
                value
            );
        }
        else if (key == "session_probe_periodic_task_run_interval"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::mod_rdp::session_probe_periodic_task_run_interval&>(this->variables).value,
                ::configs::spec_type<std::chrono::milliseconds>{},
                value
            );
        }
        else if (key == "session_probe_pause_if_session_is_disconnected"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::mod_rdp::session_probe_pause_if_session_is_disconnected&>(this->variables).value,
                ::configs::spec_type<bool>{},
                value
            );
        }
        else if (key == "session_probe_monitor_own_resources_consumption"_zv) {
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::mod_rdp::session_probe_monitor_own_resources_consumption&>(this->variables).value,
                ::configs::spec_type<bool>{},
                value
            );
        }
        ...
        if (0) {}
            ...
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::crypto::encryption_key&>(this->variables).value,
            ...
            ::config_parse_and_log(
                this->section_name, key.c_str(),
                static_cast<cfg::crypto::sign_key&>(this->variables).value,
                ::configs::spec_type<::configs::spec_types::fixed_binary>{},
                value
            );
        }
