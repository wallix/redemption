...
constexpr array_view_const_char const authstr[] = {
    ...
    "server_redirection_support"_av,
    ...
    "session_probe_clipboard_based_launcher_clipboard_initialization_delay"_av,
    "session_probe_clipboard_based_launcher_start_delay"_av,
    "session_probe_clipboard_based_launcher_long_delay"_av,
    "session_probe_clipboard_based_launcher_short_delay"_av,
