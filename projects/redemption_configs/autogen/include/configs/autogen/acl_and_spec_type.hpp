...
template<> struct acl_and_spec_type<cfg::globals::enable_close_box> { using type = bool; };
template<> struct acl_and_spec_type<cfg::globals::close_timeout> { using type = std::chrono::seconds; };
template<> struct acl_and_spec_type<cfg::globals::enable_osd> { using type = bool; };
...
template<> struct acl_and_spec_type<cfg::globals::allow_using_multiple_monitors> { using type = bool; };
...
template<> struct acl_and_spec_type<cfg::client::force_performance_flags> { using type = RdpPerformanceFlags; };
...
template<> struct acl_and_spec_type<cfg::client::show_target_user_in_f12_message> { using type = bool; };
