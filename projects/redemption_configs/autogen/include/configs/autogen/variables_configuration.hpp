...
namespace cfg {
    ...
    struct mod_rdp::application_driver_enable_cleaner {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "application_driver_enable_cleaner";
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{true};
    ...
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    /// sesman::name: file_verification:verify_before_transfer <br/>
    /// value{false} <br/>
    struct file_verification::verify_before_transfer {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "file_verification";
        static constexpr char const * name = "verify_before_transfer";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// type: uint32_t <br/>
    /// connpolicy -> proxy <br/>
    /// sesman::name: file_verification:max_file_size_rejected <br/>
    /// value{50} <br/>
    struct file_verification::max_file_size_rejected {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "file_verification";
        static constexpr char const * name = "max_file_size_rejected";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
...
, 0b1111111111111001111111111111111111111111111111111111111111111111
, 0b1111111011111111111111111111111111111111111111111111011011111011
