...
namespace cfg {
    ...
    /// Control host OS specific behaviors of VNC, notably for keyboard. <br/>
    /// type: HostOS <br/>
    /// sesman -> proxy <br/>
    /// value = static_cast<type>(0) <br/>
    struct mod_vnc::host_OS {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_vnc";
        static constexpr char const * name = "host_OS";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(70);
        using type = HostOS;
        using sesman_and_spec_type = HostOS;
        using mapped_type = sesman_and_spec_type;
        type value = static_cast<type>(0);
    };
...
, 0b1111111111111111111111111101011111011111111111111111001111111111
, 0b0000000000000000000000000000000000000001110111111111111111111111
}};
