...
namespace cfg {
    ...
    struct globals::front_connection_time {
        ...
        static constexpr char const * name = "front_connection_time";
        // for old cppcheck
    ...
    struct globals::target_connection_time {
        ...
        static constexpr bool is_proxy_to_sesman = true;
        static constexpr char const * section = "globals";
        static constexpr char const * name = "target_connection_time";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// List of enabled (static) virtual channels (example: channel1,channel2,etc). Character * only, activate all with low priority. <br/>
    /// type: std::string <br/>
    /// sesman ⇒ proxy <br/>
    /// value = "*" <br/>
    ...
    /// List of disabled (static) virtual channels (example: channel1,channel2,etc). Character * only, deactivate all with low priority. <br/>
    /// type: std::string <br/>
    /// sesman ⇒ proxy <br/>
    /// value{} <br/>
    ...
    /// List of enabled dynamic virtual channels (example: channel1,channel2,etc). Character * only, activate all. <br/>
    /// type: std::string <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// List of disabled dynamic virtual channels (example: channel1,channel2,etc). Character * only, deactivate all. <br/>
    /// type: std::string <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// type: bool <br/>
    /// connpolicy -> proxy    [name: session_probe::enable_launch_assistance_under_wabam] <br/>
    /// sesman::name: mod_rdp:session_probe_clipboard_based_launcher_enable_launch_assistance_under_wabam <br/>
    /// value{true} <br/>
    struct mod_rdp::session_probe_clipboard_based_launcher_enable_launch_assistance_under_wabam {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_clipboard_based_launcher_enable_launch_assistance_under_wabam";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// type: bool <br/>
    /// connpolicy -> proxy    [name: session_probe::wabam_bogus_clipboard_initialization] <br/>
    /// sesman::name: mod_rdp:session_probe_clipboard_based_launcher_wabam_bogus_clipboard_initialization <br/>
    /// value{true} <br/>
    struct mod_rdp::session_probe_clipboard_based_launcher_wabam_bogus_clipboard_initialization {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_clipboard_based_launcher_wabam_bogus_clipboard_initialization";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// sesman::name: mod_rdp:session_probe_update_disabled_features <br/>
    /// value{true} <br/>
    struct mod_rdp::session_probe_update_disabled_features {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_update_disabled_features";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct mod_rdp::session_probe_bestsafe_integration {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_bestsafe_integration";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct mod_rdp::session_probe_alternate_directory_environment_variable {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_alternate_directory_environment_variable";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// connpolicy -> proxy <br/>
    /// sesman::name: mod_rdp:mode_console <br/>
    /// value = static_cast<type>(0) <br/>
    ...
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    /// sesman::name: mod_rdp:auto_reconnection_on_losing_target_link <br/>
    /// value{false} <br/>
    struct mod_rdp::auto_reconnection_on_losing_target_link {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "auto_reconnection_on_losing_target_link";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    struct mod_rdp::forward_client_build_number {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "forward_client_build_number";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    /// sesman::name: mod_rdp:bogus_monitor_layout_treatment <br/>
    /// value{false} <br/>
    struct mod_rdp::bogus_monitor_layout_treatment {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "bogus_monitor_layout_treatment";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// type: std::string <br/>
    /// value = "crf=35 preset=superfast" <br/>
    ...
    struct video::enhanced_mode {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "video";
        static constexpr char const * name = "enhanced_mode";
    ...
    struct debug::mod_rdp_use_failure_simulation_socket_transport {
        ...
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "debug";
        static constexpr char const * name = "mod_rdp_use_failure_simulation_socket_transport";
    ...
    struct context::pm_request {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(196);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::native_session_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(197);
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_available {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(198);
        using type = bool;
        using sesman_and_spec_type = bool;
        using mapped_type = sesman_and_spec_type;
        type value{false};
    ...
    struct context::rd_shadow_userdata {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(199);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_type {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(200);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_invitation_error_code {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(201);
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_invitation_error_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(202);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_invitation_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(203);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_invitation_addr {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(204);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::rd_shadow_invitation_port {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(205);
        using type = unsigned int;
        using sesman_and_spec_type = unsigned int;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    struct context::smartcard_login {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr authid_t index = authid_t(206);
        using type = std::string;
        using sesman_and_spec_type = std::string;
        using mapped_type = sesman_and_spec_type;
        type value{};
    ...
    /// type: bool <br/>
    /// value{false} <br/>
    struct context::clipboard_virtual_channel_already_initialized {
        static constexpr bool is_sesman_to_proxy = false;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "context";
        static constexpr char const * name = "clipboard_virtual_channel_already_initialized";
        using type = bool;
        using mapped_type = type;
        type value{false};
    };
...
, cfg::mod_rdp::session_probe_clipboard_based_launcher_enable_launch_assistance_under_wabam
, cfg::mod_rdp::session_probe_clipboard_based_launcher_wabam_bogus_clipboard_initialization
...
, cfg::context::clipboard_virtual_channel_already_initialized
{ static constexpr bool is_section = true; };
...
, 0b1011111111111111111111111111111111111111111111011011111011111111
