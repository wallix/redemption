...
namespace cfg {
    ...
    /// sesman::name: mod_rdp:session_probe_cpu_usage_alarm_threshold <br/>
    /// value{0} <br/>
    struct mod_rdp::session_probe_cpu_usage_alarm_threshold {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_cpu_usage_alarm_threshold";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// sesman::name: mod_rdp:session_probe_cpu_usage_alarm_action <br/>
    /// value = static_cast<type>(0) <br/>
    struct mod_rdp::session_probe_cpu_usage_alarm_action {
        static constexpr bool is_sesman_to_proxy = true;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "mod_rdp";
        static constexpr char const * name = "session_probe_cpu_usage_alarm_action";
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
