...
namespace cfg {
    ...
    /// type: bool <br/>
    /// value{false} <br/>
    struct validator::enable_interrupting {
        static constexpr bool is_sesman_to_proxy = false;
        static constexpr bool is_proxy_to_sesman = false;
        static constexpr char const * section = "validator";
...
, 0b1111111111111111110101111101111111111111111110011111111111111111
, 0b0000000000000000000000000000011111110111111111111111111111111111
}};
