...
zstring_view assign_zbuf_from_cfg(
    ...
    (void)zbuf;
    assert(is_valid_enum_value<SessionProbeProcessCommandLineRetrieveMethod>::is_valid(uint8_t(x)));
    return enum_zint_SessionProbeProcessCommandLineRetrieveMethod[uint8_t(x)];
}
...
zstring_view assign_zbuf_from_cfg(
    ...
    (void)zbuf;
    assert(is_valid_enum_value<SessionProbeProcessCommandLineRetrieveMethod>::is_valid(uint8_t(x)));
    return enum_zstr_SessionProbeProcessCommandLineRetrieveMethod[uint8_t(x)];
}
