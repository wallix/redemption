...
class ClientRedemptionQT : public ClientRedemptionAPI
{
        ...
        try {
            ...
            case ClientRedemptionConfig::MOD_VNC:
                this->unique_mod = new_mod_vnc(
                  ...
                  // TODO: ClientExecute client_execute: moving that away from mod_vnc in progress
                  , nullptr 
                  , this->ini
