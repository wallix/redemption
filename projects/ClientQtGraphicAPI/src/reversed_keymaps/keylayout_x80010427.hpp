...
const static int LCID = 0x10427;

const static char * const locale_name = "lt-LT";
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0030, 0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036,
    0x0037, 0x0038, 0x0039, 0x0039, 0x003b, 0x005b, 0x005c, 0x005c,
    ...
    0x0077, 0x0078, 0x0079, 0x007a, 0x0105, 0x010d, 0x0117, 0x0119,
    0x012f, 0x0161, 0x016b, 0x0173, 0x017e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,    100,     28,      1,     57,     40,     55,
        78,     83,     51,     74,     12,     52,     53,     98,
        11,     82,     79,     80,     81,     75,     76,     77,
        71,     72,     10,     73,     39,     26,     43,     86,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    0x0008, 0x000d, 0x000d, 0x001b, 0x0020, 0x0022, 0x0028, 0x0029,
    0x002a, 0x002b, 0x002c, 0x002d, 0x002f, 0x003a, 0x003c, 0x003e,
    0x003f, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047,
    0x0048, 0x0049, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 0x004f,
    0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057,
    0x0058, 0x0059, 0x005a, 0x005f, 0x007b, 0x007c, 0x007c, 0x007d,
    0x007e, 0x007f, 0x0104, 0x010c, 0x0116, 0x0118, 0x012e, 0x0160,
    0x016a, 0x0172, 0x017d, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,     40,     10,     11,
        55,     78,     83,     74,    104,     39,     51,     52,
        53,     30,     48,     46,     32,     18,     33,     34,
        35,     23,     36,     37,     38,     50,     49,     24,
        25,     16,     19,     31,     20,     22,     47,     17,
        45,     21,     44,     12,     26,     43,     86,     27,
        41,     99,      2,      3,      5,      4,      6,      7,
         9,      8,     13, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x0037, 0x0038, 0x0039, 0x003d, 0x20ac, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0027, 0x002a,
    0x002b, 0x002c, 0x002c, 0x002d, 0x002d, 0x002e, 0x002f, 0x002f,
    0x0030, 0x0039, 0x003b, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045,
    0x0046, 0x0047, 0x0048, 0x0049, 0x004a, 0x004b, 0x004c, 0x004d,
    0x004e, 0x004f, 0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055,
    0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x005b, 0x005c, 0x005c,
    0x005d, 0x0060, 0x0104, 0x010c, 0x0116, 0x0118, 0x012e, 0x0160,
    0x016a, 0x0172, 0x017d, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,    100,     28,      1,     57,     40,     55,
        78,     83,     51,     12,     74,     52,     53,     98,
        11,     10,     39,     30,     48,     46,     32,     18,
        33,     34,     35,     23,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     21,     44,     26,     43,     86,
        27,     41,      2,      3,      5,      4,      6,      7,
         9,      8,     13, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0022, 0x0028,
    0x0029, 0x002a, 0x002b, 0x002c, 0x002d, 0x002f, 0x003a, 0x003c,
    ...
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x007b, 0x007c, 0x007c,
    0x007d, 0x007e, 0x0105, 0x010d, 0x0117, 0x0119, 0x012f, 0x0161,
    0x016b, 0x0173, 0x017e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,     40,     10,
        11,     55,     78,     83,     74,     98,     39,     51,
        52,     53,     12,     30,     48,     46,     32,     18,
        33,     34,     35,     23,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     21,     44,     26,     43,     86,
        27,     41,      2,      3,      5,      4,      6,      7,
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 21};
...
static const Keylayout_r keylayout_x80010427(
    x80010427::LCID,
    x80010427::locale_name,
    x80010427::noMod,
    x80010427::shift,
    x80010427::altGr,
    x80010427::shiftAltGr,
    x80010427::ctrl,
    x80010427::capslock_noMod,
    x80010427::capslock_shift,
    x80010427::capslock_altGr,
    x80010427::capslock_shiftAltGr,
    x80010427::deadkeys,
    x80010427::nbDeadkeys
);
