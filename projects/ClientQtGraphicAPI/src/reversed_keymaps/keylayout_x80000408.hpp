...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x005c, 0x005d, 0x0060, 0x0384, 0x03b1, 0x03b2, 0x03b3, 0x03b4,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x003f, 0x0040, 0x005e, 0x005f, 0x007b, 0x007c, 0x007d, 0x007e,
...
constexpr Keylayout_r::KeyLayoutMap_t altGr{uchar_altGr, scancode_altGr, 27};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0060, 0x0384, 0x0391, 0x0392, 0x0393, 0x0394, 0x0395, 0x0396,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x003e, 0x003f, 0x0040, 0x005e, 0x005f, 0x007b, 0x007c, 0x007d,
    0x007e, 0x00a8, 0x0385, 0x03b1, 0x03b2, 0x03b3, 0x03b4, 0x03b5,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        ...
        52,     53,      3,      7,     12,     26,     43,     27,
        41,     39,     17,     30,     48,     34,     32,     18,
        44,     35,     22,     23,     37,     38,     50,     49,
        36,     24,     25,     19,     31,     20,     21,     33,
        45,     46,     47, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 27};
