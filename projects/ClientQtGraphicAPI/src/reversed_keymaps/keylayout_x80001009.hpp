...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x002b, 0x002d, 0x002e, 0x002e, 0x002f, 0x002f, 0x003a, 0x003e,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x00a2, 0x00a3, 0x00a4, 0x00a6, 0x00a7, 0x00ac, 0x00ad, 0x00af,
    0x00b0, 0x00b1, 0x00b2, 0x00b3, 0x00b4, 0x00b5, 0x00b6, 0x00bc,
    0x00bd, 0x00be, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,      3,     26,     41,     27,     40,     43,     39,
         5,      4,      6,      8,     24,      7,     52,     51,
        86,      2,      9,     10,     53,     50,     25,     11,
        12,     13, 
};
constexpr Keylayout_r::KeyLayoutMap_t altGr{uchar_altGr, scancode_altGr, 34};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002b, 0x002b, 0x002d, 0x002e, 0x002e, 0x002f, 0x002f, 0x003a,
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 34};
...
static const Keylayout_r keylayout_x80001009(
    x80001009::LCID,
    x80001009::locale_name,
    x80001009::noMod,
    x80001009::shift,
    x80001009::altGr,
    x80001009::shiftAltGr,
    x80001009::ctrl,
    x80001009::capslock_noMod,
    x80001009::capslock_shift,
    x80001009::capslock_altGr,
    x80001009::capslock_shiftAltGr,
    x80001009::deadkeys,
    x80001009::nbDeadkeys
);
