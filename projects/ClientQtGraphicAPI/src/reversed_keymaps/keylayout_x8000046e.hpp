...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x003f, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065,
    0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c, 0x006d,
    0x006e, 0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075,
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a3, 0x00b0, 0x00e4,
    0x00e7, 0x00f6, 0x00fc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,     27,      3,
         6,      7,      9,     10,      4,     55,      2,     78,
        74,     83,      8,     98,     52,     51,     11,     86,
        12,     53,     13,     30,     48,     46,     32,     18,
        33,     34,     35,     23,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     44,     21,     43,     41,     40,
         5,     39,     26, 
};
...
static const Keylayout_r keylayout_x8000046e(
    x8000046e::LCID,
    x8000046e::locale_name,
    x8000046e::noMod,
    x8000046e::shift,
    x8000046e::altGr,
    x8000046e::shiftAltGr,
    x8000046e::ctrl,
    x8000046e::capslock_noMod,
    x8000046e::capslock_shift,
    x8000046e::capslock_altGr,
    x8000046e::capslock_shiftAltGr,
    x8000046e::deadkeys,
    x8000046e::nbDeadkeys
);
