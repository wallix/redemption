...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x0106, 0x010c,
    0x0110, 0x0160, 0x017d, 0x201a, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002b, 0x002d, 0x002e, 0x002e, 0x002f, 0x002f, 0x003a, 0x003b,
    ...
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x007e, 0x0107,
