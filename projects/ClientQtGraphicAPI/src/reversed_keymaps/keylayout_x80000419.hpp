...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0039, 0x0039, 0x003d, 0x005c, 0x005c, 0x0430, 0x0431, 0x0432,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        ...
        79,      2,      3,     80,      4,     81,      5,     75,
         6,     76,      7,     77,      8,     71,      9,     72,
        10,     73,     13,     43,     86,     33,     51,     32,
        22,     38,     20,     39,     25,     48,     16,     19,
        37,     47,     21,     36,     34,     35,     46,     49,
        18,     30,     26,     17,     45,     23,     24,     27,
        31,     50,     40,     52,     44,     41, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x002d, 0x002e, 0x002f, 0x002f, 0x002f, 0x003a, 0x003b, 0x003f,
    0x005f, 0x007f, 0x0401, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        ...
        74,    126,     43,    104,     86,      7,      5,      8,
        12,     99,     41,     33,     51,     32,     22,     38,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x003d, 0x005c, 0x005c, 0x0401, 0x0410, 0x0411, 0x0412, 0x0413,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002c, 0x002d, 0x002e, 0x002f, 0x002f, 0x002f, 0x003a, 0x003b,
    0x003f, 0x005f, 0x0430, 0x0431, 0x0432, 0x0433, 0x0434, 0x0435,
    0x0436, 0x0437, 0x0438, 0x0439, 0x043a, 0x043b, 0x043c, 0x043d,
    0x043e, 0x043f, 0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445,
    0x0446, 0x0447, 0x0448, 0x0449, 0x044a, 0x044b, 0x044c, 0x044d,
    0x044e, 0x044f, 0x0451, 0x2116, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,      2,      3,
         6,     10,     11,      9,     55,     78,     13,     83,
        53,     74,    126,     98,     86,     43,      7,      5,
         8,     12,     33,     51,     32,     22,     38,     20,
...
static const Keylayout_r keylayout_x80000419(
    x80000419::LCID,
