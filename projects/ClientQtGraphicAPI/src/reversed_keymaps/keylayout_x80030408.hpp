...
const static int LCID = 0x30408;

const static char * const locale_name = "el-GR.220_latin";
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0037, 0x0038, 0x0038, 0x0039, 0x0039, 0x003c, 0x005c, 0x005d,
    0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, 0x0068,
    0x0069, 0x006a, 0x006b, 0x006c, 0x006d, 0x006e, 0x006f, 0x0070,
    0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078,
    0x0079, 0x007a, 0x007d, 0x00a8, 0x0384, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0057, 0x0058, 0x0059, 0x005a, 0x005b, 0x005f, 0x007b, 0x007c,
    0x007f, 0x00a8, 0x0385, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002f, 0x00a3, 0x00a4, 0x00a6, 0x00a7, 0x00ab, 0x00ac, 0x00b0,
    0x00b1, 0x00b2, 0x00b3, 0x00b6, 0x00bb, 0x00bd, 0x0385, 0x0385,
    0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,      5,      9,     10,      6,     26,     43,     11,
        12,      3,      4,      7,     27,     13,     39,     40,
        18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x005c, 0x005d,
    0x007d, 0x00a8, 0x0384, 
};
...
static const Keylayout_r keylayout_x80030408(
    x80030408::LCID,
    x80030408::locale_name,
    x80030408::noMod,
    x80030408::shift,
    x80030408::altGr,
    x80030408::shiftAltGr,
    x80030408::ctrl,
    x80030408::capslock_noMod,
    x80030408::capslock_shift,
    x80030408::capslock_altGr,
    x80030408::capslock_shiftAltGr,
    x80030408::deadkeys,
    x80030408::nbDeadkeys
);
