...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x005c, 0x005d, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066,
    0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c, 0x006d, 0x006e,
    0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076,
    0x0077, 0x0078, 0x0079, 0x007a, 0x007e, 0x00b4, 0x00e7, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,     28,    100,      1,     57,     41,     55,
        78,     83,     51,     12,     74,    126,     52,     98,
       115,     82,     11,     79,      2,      3,     80,      4,
        81,      5,     75,      6,     76,      7,     77,     71,
         8,      9,     72,     10,     73,     53,     13,     27,
        86,     43,     30,     48,     46,     32,     18,     33,
        34,     35,     23,     36,     37,     38,     50,     49,
        24,     25,     16,     19,     31,     20,     22,     47,
        17,     45,     21,     44,     40,     26,     39, 
};
constexpr Keylayout_r::KeyLayoutMap_t noMod{uchar_noMod, scancode_noMod, 71};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x002b, 0x002c, 0x002d, 0x002e, 0x002f, 0x003a, 0x003c, 0x003e,
    ...
    0x0057, 0x0058, 0x0059, 0x005a, 0x005e, 0x005f, 0x0060, 0x007b,
    0x007c, 0x007d, 0x007f, 0x00a8, 0x00c7, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,      2,     41,      4,
         5,      6,      8,     10,     11,      9,     55,     13,
        78,     83,     74,    126,    104,     53,     51,     52,
       115,      3,     30,     48,     46,     32,     18,     33,
        34,     35,     23,     36,     37,     38,     50,     49,
        24,     25,     16,     19,     31,     20,     22,     47,
        17,     45,     21,     44,     40,     12,     26,     27,
        86,     43,     99,      7,     39, 
};
constexpr Keylayout_r::KeyLayoutMap_t shift{uchar_shift, scancode_shift, 61};

constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x002f, 0x003f, 0x00a2, 0x00a3, 0x00a7, 0x00aa, 0x00ac,
    0x00b0, 0x00b0, 0x00b2, 0x00b3, 0x00b9, 0x00ba, 0x20a2, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,     28,    100,      1,     55,     78,     74,
        98,     16,     17,      6,      5,     13,     27,      7,
       115,     18,      3,      4,      2,     43,     46, 
};
constexpr Keylayout_r::KeyLayoutMap_t altGr{uchar_altGr, scancode_altGr, 23};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x005c, 0x005d, 0x007e, 0x00b4, 0x00c7, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,     28,    100,      1,     57,     41,     55,
        78,     83,     51,     74,     12,    126,     52,     98,
       115,     11,      2,      3,      4,      5,      6,      7,
         8,      9,     10,     53,     13,     30,     48,     46,
        32,     18,     33,     34,     35,     23,     36,     37,
        38,     50,     49,     24,     25,     16,     19,     31,
        20,     22,     47,     17,     45,     21,     44,     27,
        86,     43,     40,     26,     39, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_noMod{uchar_capslock_noMod, scancode_capslock_noMod, 61};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002b, 0x002b, 0x002c, 0x002d, 0x002e, 0x002f, 0x003a, 0x003c,
    0x003e, 0x003f, 0x0040, 0x005e, 0x005f, 0x0060, 0x0061, 0x0062,
    ...
    0x007b, 0x007c, 0x007d, 0x00a8, 0x00e7, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,      2,     41,
         4,      5,      6,      8,     10,     11,      9,     55,
        13,     78,     83,     74,    126,     98,     53,     51,
        52,    115,      3,     40,     12,     26,     30,     48,
        46,     32,     18,     33,     34,     35,     23,     36,
        37,     38,     50,     49,     24,     25,     16,     19,
        31,     20,     22,     47,     17,     45,     21,     44,
        27,     86,     43,      7,     39, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_shift{uchar_capslock_shift, scancode_capslock_shift, 61};
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 23};
...
static const Keylayout_r keylayout_x80000416(
    x80000416::LCID,
    x80000416::locale_name,
    x80000416::noMod,
    x80000416::shift,
    x80000416::altGr,
    x80000416::shiftAltGr,
    x80000416::ctrl,
    x80000416::capslock_noMod,
    x80000416::capslock_shift,
    x80000416::capslock_altGr,
    x80000416::capslock_shiftAltGr,
    x80000416::deadkeys,
    x80000416::nbDeadkeys
);
