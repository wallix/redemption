...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0038, 0x0038, 0x0039, 0x0039, 0x0061, 0x0062, 0x0063, 0x0064,
    0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c,
    0x006d, 0x006e, 0x006f, 0x0070, 0x0072, 0x0073, 0x0074, 0x0075,
    0x0076, 0x007a, 0x00a7, 0x00b4, 0x00e1, 0x00e4, 0x00e5, 0x00f6,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x00a4, 0x00bd, 0x00c1, 0x00c4, 0x00c5, 0x00d6, 0x010c, 0x0110,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002b, 0x002d, 0x002f, 0x003c, 0x003e, 0x0040, 0x005b, 0x005c,
    0x005d, 0x0071, 0x0077, 0x0078, 0x0079, 0x007b, 0x007c, 0x007d,
    0x007e, 0x00a3, 0x00a8, 0x00b5, 0x00e2, 0x00e6, 0x00ef, 0x00f5,
    0x00f8, 0x01e5, 0x01e7, 0x01e9, 0x01ef, 0x0292, 0x20ac, 0x20ac,

};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,     28,    100,      1,      5,     43,     55,
        78,     74,     98,     51,     52,      3,      9,     12,
        10,     16,     17,     45,     21,      8,     41,     11,
        27,      4,     26,     50,     30,     40,     23,     24,
        39,     35,     34,     37,     86,     44,     18,      6,

};
constexpr Keylayout_r::KeyLayoutMap_t altGr{uchar_altGr, scancode_altGr, 40};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    ...
    0x00c6, 0x00cf, 0x00d5, 0x00d8, 0x01b7, 0x01e4, 0x01e6, 0x01e8,
    0x01ee, 0x02c7, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x00a7, 0x00b4, 0x00c1, 0x00c4, 0x00c5, 0x00d6, 0x010c, 0x0110,
    0x014a, 0x0160, 0x0166, 0x017d, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x00a4, 0x00bd, 0x00e1, 0x00e4, 0x00e5, 0x00f6, 0x010d, 0x0111,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    ...
    0x0058, 0x0059, 0x005b, 0x005c, 0x005d, 0x007b, 0x007c, 0x007d,
    0x007e, 0x00a3, 0x00a8, 0x00b5, 0x00c2, 0x00c6, 0x00cf, 0x00d5,
    0x00d8, 0x01b7, 0x01e4, 0x01e6, 0x01e8, 0x01ee, 0x20ac, 0x20ac,

};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_altGr[] {
        14,     15,     28,    100,      1,      5,     43,     55,
        78,     74,     98,     51,     52,      3,     16,     17,
        45,     21,      9,     12,     10,      8,     41,     11,
        27,      4,     26,     50,     30,     40,     23,     24,
        39,     44,     35,     34,     37,     86,     18,      6,

};
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 40};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    ...
    0x00e6, 0x00ef, 0x00f5, 0x00f8, 0x01e5, 0x01e7, 0x01e9, 0x01ef,
    0x0292, 0x02c7, 
};
