...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0038, 0x0038, 0x0039, 0x0039, 0x003b, 0x003d, 0x0061, 0x0062,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        ...
        75,      5,     76,      6,     77,      7,     71,      8,
         9,     72,     73,     10,     39,     13,     30,     48,
        46,     32,     18,     33,     34,     35,     23,     36,
        37,     38,     50,     49,     24,     25,     16,     19,
        31,     20,     22,     47,     17,     45,     21,     44,
        41,     26,     27,     43, 
};
constexpr Keylayout_r::KeyLayoutMap_t noMod{uchar_noMod, scancode_noMod, 68};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x005a, 0x005e, 0x005f, 0x007f, 0x010a, 0x0120, 0x0126, 0x017b,
    0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,      2,     40,      5,
         6,      8,     10,     11,      9,     55,     78,     13,
        74,    104,     39,     51,     52,     53,      3,     30,
        48,     46,     32,     18,     33,     34,     35,     23,
        36,     37,     38,     50,     49,     24,     25,     16,
        19,     31,     20,     22,     47,     17,     45,     21,
        44,      7,     12,     99,     41,     26,     27,     43,
         4, 
};
constexpr Keylayout_r::KeyLayoutMap_t shift{uchar_shift, scancode_shift, 57};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x007b, 0x007c, 0x007d, 0x007e, 0x00c0, 0x00c8, 0x00cc,
    0x00d2, 0x00d9, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     26,     43,     27,     41,     30,     18,     23,
        24,     22, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x010a, 0x0120,
    0x0126, 0x017b, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        ...
        22,     47,     17,     45,     21,     44,     41,     26,
        27,     43, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_noMod{uchar_capslock_noMod, scancode_capslock_noMod, 58};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x007b, 0x007c, 0x007d, 0x007e, 0x00e0, 0x00e8, 0x00ec,
    0x00f2, 0x00f9, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t ctrl{uchar_ctrl, scancode_ctrl, 9};
