...
const static int LCID = 0x407;

const static char * const locale_name = "de-DE";

constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0023, 0x002a,
    0x002b, 0x002b, 0x002c, 0x002d, 0x002d, 0x002e, 0x002f, 0x0030,
    0x0030, 0x0031, 0x0031, 0x0032, 0x0032, 0x0033, 0x0033, 0x0034,
    0x0034, 0x0035, 0x0035, 0x0036, 0x0036, 0x0037, 0x0037, 0x0038,
    0x0038, 0x0039, 0x0039, 0x005e, 0x0061, 0x0062, 0x0063, 0x0064,
    0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c,
    0x006d, 0x006e, 0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074,
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00b4, 0x00df,
    0x00e4, 0x00f6, 0x00fc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,    100,     28,      1,     57,     43,     55,
        78,     27,     51,     74,     53,     52,     98,     11,
        82,      2,     79,      3,     80,      4,     81,      5,
        75,     76,      6,      7,     77,      8,     71,     72,
         9,     73,     10,     41,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     44,     21,     13,     12,
        40,     39,     26, 
};
constexpr Keylayout_r::KeyLayoutMap_t noMod{uchar_noMod, scancode_noMod, 67};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002f, 0x0040, 0x005b, 0x005c, 0x005d, 0x007b, 0x007d, 0x007e,
    0x00b2, 0x00b3, 0x00b5, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     16,      9,     12,     10,      8,     11,     27,
         3,      4,     50,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x002b, 0x002d, 0x002d, 0x002f, 0x002f, 0x003a, 0x003b, 0x003d,
    0x003f, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047,
    0x0048, 0x0049, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 0x004f,
    0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057,
    0x0058, 0x0059, 0x005a, 0x005e, 0x00a7, 0x00b4, 0x00c4, 0x00d6,
    0x00dc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,    100,     28,      1,     57,      2,      3,
         5,      6,      7,     43,      9,     10,     55,     27,
        78,     74,     53,      8,     98,     52,     51,     11,
        12,     30,     48,     46,     32,     18,     33,     34,
        35,     23,     36,     37,     38,     50,     49,     24,
        25,     16,     19,     31,     20,     22,     47,     17,
        45,     44,     21,     41,      4,     13,     40,     39,
        26, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_noMod{uchar_capslock_noMod, scancode_capslock_noMod, 57};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x003c, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065,
    0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c, 0x006d,
    0x006e, 0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075,
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00b0, 0x00df, 0x00e4,
    0x00f6, 0x00fc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,     43,     55,
        78,     27,     51,     74,     52,     98,     11,      2,
         3,      4,      5,      6,      7,      8,      9,     10,
        86,     53,     13,     30,     48,     46,     32,     18,
        33,     34,     35,     23,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     44,     21,     41,     12,     40,
        39,     26, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_shift{uchar_capslock_shift, scancode_capslock_shift, 58};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_ctrl[] {
    ...
    0x0020, 0x002a, 0x002b, 0x002d, 0x002f, 0x003e, 
};
...
static const Keylayout_r keylayout_x80000407(
    x80000407::LCID,
    x80000407::locale_name,
    x80000407::noMod,
    x80000407::shift,
    x80000407::altGr,
    x80000407::shiftAltGr,
    x80000407::ctrl,
    x80000407::capslock_noMod,
    x80000407::capslock_shift,
    x80000407::capslock_altGr,
    x80000407::capslock_shiftAltGr,
    x80000407::deadkeys,
    x80000407::nbDeadkeys
);
