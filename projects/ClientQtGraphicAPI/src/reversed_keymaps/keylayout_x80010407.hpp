...
const static int LCID = 0x10407;

const static char * const locale_name = "de-DE.ibm";
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0038, 0x0038, 0x0039, 0x0039, 0x003c, 0x005e, 0x0061, 0x0062,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0058, 0x0059, 0x005a, 0x005f, 0x0060, 0x007f, 0x00a7, 0x00b0,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002f, 0x0040, 0x005b, 0x005c, 0x005d, 0x007b, 0x007c, 0x007d,
    0x007e, 0x00b2, 0x00b3, 0x00b5, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     16,      9,     12,     10,      8,     86,     11,
        27,      3,      4,     50,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t shiftAltGr{uchar_shiftAltGr, scancode_shiftAltGr, 20};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x003e, 0x003f, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064,
    0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c,
    0x006d, 0x006e, 0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074,
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a7, 0x00b0,
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_shiftAltGr{uchar_capslock_shiftAltGr, scancode_capslock_shiftAltGr, 20};
...
static const Keylayout_r keylayout_x80010407(
    x80010407::LCID,
    x80010407::locale_name,
    x80010407::noMod,
    x80010407::shift,
    x80010407::altGr,
    x80010407::shiftAltGr,
    x80010407::ctrl,
    x80010407::capslock_noMod,
    x80010407::capslock_shift,
    x80010407::capslock_altGr,
    x80010407::capslock_shiftAltGr,
    x80010407::deadkeys,
    x80010407::nbDeadkeys
);
