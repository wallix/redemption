...
static const Keylayout_r keylayout_x8000041b(
    x8000041b::LCID,
    x8000041b::locale_name,
    x8000041b::noMod,
    x8000041b::shift,
    x8000041b::altGr,
    x8000041b::shiftAltGr,
    x8000041b::ctrl,
    x8000041b::capslock_noMod,
    x8000041b::capslock_shift,
    x8000041b::capslock_altGr,
    x8000041b::capslock_shiftAltGr,
    x8000041b::deadkeys,
    x8000041b::nbDeadkeys
);
