...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a8,
    0x00b4, 0x00bd, 0x00e5, 0x00e6, 0x00f8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x00a8, 0x00b4, 0x00bd,
    0x00c5, 0x00c6, 0x00d8, 
};
