...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0057, 0x0058, 0x0059, 0x005a, 0x005f, 0x007f, 0x00a8, 0x0106,
    0x010c, 0x0110, 0x0160, 0x017d, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,      2,      3,      4,
         5,      6,      7,      9,     10,     13,     55,     78,
        83,     74,    126,      8,    104,     52,     51,     11,
        86,     12,     30,     48,     46,     32,     18,     33,
        34,     35,     23,     36,     37,     38,     50,     49,
        24,     25,     16,     19,     31,     20,     22,     47,
        17,     45,     44,     21,     53,     99,     41,     40,
        39,     27,     26,     43, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x00b8, 0x0106,
    0x010c, 0x0110, 0x0160, 0x017d, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002b, 0x002c, 0x002d, 0x002e, 0x002f, 0x002f, 0x003a, 0x003b,
    ...
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a8, 0x0107,
    0x010d, 0x0111, 0x0161, 0x017e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,      2,      3,
         4,      5,      6,      7,      9,     10,     13,     55,
        78,     83,     74,    126,      8,     98,     52,     51,
        11,     86,     12,     53,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     44,     21,     41,     40,
        39,     27,     26,     43, 
...
static const Keylayout_r keylayout_x80000424(
    x80000424::LCID,
    x80000424::locale_name,
    x80000424::noMod,
    x80000424::shift,
    x80000424::altGr,
    x80000424::shiftAltGr,
    x80000424::ctrl,
    x80000424::capslock_noMod,
    x80000424::capslock_shift,
    x80000424::capslock_altGr,
    x80000424::capslock_shiftAltGr,
    x80000424::deadkeys,
    x80000424::nbDeadkeys
);
