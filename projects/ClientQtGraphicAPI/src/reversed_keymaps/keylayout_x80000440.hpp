...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0039, 0x003d, 0x005c, 0x005c, 0x0430, 0x0431, 0x0432, 0x0433,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        ...
        83,     74,     12,     53,     98,     82,     11,     79,
         2,      3,     80,      4,     81,     75,      5,     76,
         6,     77,      7,      8,     71,      9,     72,     10,
        73,     13,     86,     43,     33,     51,     32,     22,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003d,
    0x005c, 0x005c, 0x0401, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        ...
        83,     74,     12,     53,     98,     11,      2,      3,
         4,      5,      6,      7,      8,      9,     10,     13,
        86,     43,     41,     33,     51,     32,     22,     38,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002c, 0x002d, 0x002f, 0x002f, 0x002f, 0x003a, 0x003b, 0x003f,
...
static const Keylayout_r keylayout_x80000440(
    x80000440::LCID,
    x80000440::locale_name,
    x80000440::noMod,
    x80000440::shift,
    x80000440::altGr,
    x80000440::shiftAltGr,
    x80000440::ctrl,
    x80000440::capslock_noMod,
    x80000440::capslock_shift,
    x80000440::capslock_altGr,
    x80000440::capslock_shiftAltGr,
    x80000440::deadkeys,
    x80000440::nbDeadkeys
);
