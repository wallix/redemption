...
static const Keylayout_r keylayout_x8000041d(
    x8000041d::LCID,
    x8000041d::locale_name,
    x8000041d::noMod,
    x8000041d::shift,
    x8000041d::altGr,
    x8000041d::shiftAltGr,
    x8000041d::ctrl,
    x8000041d::capslock_noMod,
    x8000041d::capslock_shift,
    x8000041d::capslock_altGr,
    x8000041d::capslock_shiftAltGr,
    x8000041d::deadkeys,
    x8000041d::nbDeadkeys
);
