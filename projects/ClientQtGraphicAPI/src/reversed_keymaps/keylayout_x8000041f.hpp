...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0022, 0x002a,
    0x002a, 0x002b, 0x002c, 0x002c, 0x002d, 0x002d, 0x002e, 0x002e,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,     28,    100,      1,     57,     41,     12,
        55,     78,     83,     43,     74,     13,    126,     53,
        98,     82,     11,     79,      2,      3,     80,      4,
        81,      5,     75,      6,     76,      7,     77,     71,
         8,      9,     72,     10,     73,     86,     30,     48,
        46,     32,     18,     33,     34,     35,     40,     36,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0059, 0x005a, 0x005e, 0x005f, 0x007f, 0x00c7, 0x00d6, 0x00dc,
    0x00e9, 0x011e, 0x0130, 0x015e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,      2,      6,      7,
         3,      9,     10,     55,     78,      5,     83,     74,
       126,      8,    104,     53,     43,     11,     86,     12,
        30,     48,     46,     32,     18,     33,     34,     35,
        23,     36,     37,     38,     50,     49,     24,     25,
        16,     19,     31,     20,     22,     47,     17,     45,
        21,     44,      4,     13,     99,     52,     51,     27,
        41,     26,     40,     39, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x005d, 0x0060, 0x0069, 0x007b, 0x007c, 0x007c, 0x007d, 0x007e,
    0x00a3, 0x00a8, 0x00b4, 0x00bd, 0x00df, 0x00e6, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,      4,      5,     55,
        78,     74,     98,     41,      2,     16,      9,     12,
        10,     43,     23,      8,     13,     86,     11,     27,
         3,     26,     39,      6,     31,     30,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    ...
    0x002f, 0x00c6, 0x0130, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,     28,    100,      1,     55,     78,     74,
        98,     30,     23, 
};
constexpr Keylayout_r::KeyLayoutMap_t shiftAltGr{uchar_shiftAltGr, scancode_shiftAltGr, 11};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00e7, 0x00e9, 0x00f6,
    0x00fc, 0x011f, 0x0131, 0x015f, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,      2,      6,
         7,      3,      9,     10,     55,     78,      5,     83,
        74,    126,     98,      8,     53,     43,     11,     86,
        12,      4,     13,     30,     48,     46,     32,     18,
        33,     34,     35,     40,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     21,     44,     52,     41,     51,
        27,     26,     23,     39, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0023, 0x0024, 0x002a,
    0x002b, 0x002d, 0x002f, 0x003c, 0x003e, 0x0040, 0x005b, 0x005c,
    0x005d, 0x0060, 0x007b, 0x007c, 0x007c, 0x007d, 0x007e, 0x00a3,
    0x00a8, 0x00b4, 0x00bd, 0x00c6, 0x00df, 0x0130, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_altGr[] {
        14,     15,    100,     28,      1,      4,      5,     55,
        78,     74,     98,     41,      2,     16,      9,     12,
        10,     43,      8,     13,     86,     11,     27,      3,
        26,     39,      6,     30,     31,     23,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x0069, 0x00e6, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shiftAltGr[] {
        14,     15,     28,    100,      1,     55,     78,     74,
        98,     23,     30, 
};
constexpr Keylayout_r::KeyLayoutMap_t capslock_shiftAltGr{uchar_capslock_shiftAltGr, scancode_capslock_shiftAltGr, 11};
