...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a8, 0x00aa,
    0x00b7, 0x00bf, 0x00e7, 0x00f1, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,      2,      3,
         5,      6,      7,      9,     10,     55,     27,     78,
        74,     83,    126,     98,      8,     52,     51,     11,
        86,     12,     26,     53,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     21,     44,     40,     41,
         4,     13,     43,     39, 
};
...
static const Keylayout_r keylayout_x8000040a(
    x8000040a::LCID,
    x8000040a::locale_name,
    x8000040a::noMod,
    x8000040a::shift,
    x8000040a::altGr,
    x8000040a::shiftAltGr,
    x8000040a::ctrl,
    x8000040a::capslock_noMod,
    x8000040a::capslock_shift,
    x8000040a::capslock_altGr,
    x8000040a::capslock_shiftAltGr,
    x8000040a::deadkeys,
    x8000040a::nbDeadkeys
);
