...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0057, 0x0058, 0x0059, 0x005a, 0x005f, 0x007f, 0x00a8, 0x00c6,
    0x00d0, 0x00d6, 0x00de, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,    100,     28,      1,     57,      2,      3,      4,
         5,      6,      7,     40,      9,     10,     55,     43,
        78,     83,     74,    104,      8,     52,     51,     11,
        86,     27,     30,     48,     46,     32,     18,     33,
        34,     35,     23,     36,     37,     38,     50,     49,
        24,     25,     16,     19,     31,     20,     22,     47,
        17,     45,     21,     44,     13,     99,     41,     39,
        26,     12,     53, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002f, 0x0040, 0x005b, 0x005c, 0x005d, 0x005e, 0x0060, 0x007b,
    0x007c, 0x007d, 0x007e, 0x00b0, 0x00b5, 0x20ac, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     16,      9,     12,     10,     40,     43,      8,
        86,     11,     27,     41,     50,     18,      6, 
};
...
static const Keylayout_r keylayout_x8000040f(
    x8000040f::LCID,
    x8000040f::locale_name,
    x8000040f::noMod,
    x8000040f::shift,
    x8000040f::altGr,
    x8000040f::shiftAltGr,
    x8000040f::ctrl,
    x8000040f::capslock_noMod,
    x8000040f::capslock_shift,
    x8000040f::capslock_altGr,
    x8000040f::capslock_shiftAltGr,
    x8000040f::deadkeys,
    x8000040f::nbDeadkeys
);
