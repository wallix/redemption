...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0037, 0x0037, 0x0038, 0x0038, 0x0039, 0x0039, 0x003b, 0x003d,
    0x005b, 0x005c, 0x005d, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        ...
        55,     78,     51,     74,     12,     83,    126,     52,
        98,     53,     82,     11,     79,      2,      3,     80,
         4,     81,     75,      5,      6,     76,     77,      7,
        71,      8,     72,      9,     73,     10,     39,     13,
        26,     86,     27,     41,     30,     48,     46,     32,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002f, 0x005e, 0x007e, 0x00a6, 0x00a8, 0x00b4, 0x00e1, 0x00e7,
    0x00e9, 0x00ed, 0x00f3, 0x00fa, 0x00fd, 0x1e83, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,      7,     43,     41,      3,     40,     30,     46,
        18,     23,     24,     22,     21,     17,      5, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x0060, 0x00c1, 0x00c7, 0x00c9, 0x00cd, 0x00d3, 0x00da,
    0x00dd, 0x1e82, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     40,     30,     46,     18,     23,     24,     22,
        21,     17, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0036, 0x0037, 0x0038, 0x0039, 0x003b, 0x003d, 0x0041, 0x0042,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x005e, 0x007e, 0x00a6, 0x00a8, 0x00b4, 0x00c1, 0x00c7,
    0x00c9, 0x00cd, 0x00d3, 0x00da, 0x00dd, 0x1e82, 0x20ac, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x0060, 0x00e1, 0x00e7, 0x00e9, 0x00ed, 0x00f3, 0x00fa,
    0x00fd, 0x1e83, 
};
...
static const Keylayout_r keylayout_x80000452(
    x80000452::LCID,
    x80000452::locale_name,
    x80000452::noMod,
    x80000452::shift,
    x80000452::altGr,
    x80000452::shiftAltGr,
    x80000452::ctrl,
    x80000452::capslock_noMod,
    x80000452::capslock_shift,
    x80000452::capslock_altGr,
    x80000452::capslock_shiftAltGr,
    x80000452::deadkeys,
    x80000452::nbDeadkeys
);
