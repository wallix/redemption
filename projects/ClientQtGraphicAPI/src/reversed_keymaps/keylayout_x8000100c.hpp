...
const static int LCID = 0x100c;

const static char * const locale_name = "fr-CH";

constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0024, 0x0027,
    0x002a, 0x002b, 0x002c, 0x002d, 0x002d, 0x002e, 0x002e, 0x002e,
    0x002f, 0x0030, 0x0030, 0x0031, 0x0031, 0x0032, 0x0032, 0x0033,
    0x0033, 0x0034, 0x0034, 0x0035, 0x0035, 0x0036, 0x0036, 0x0037,
    0x0037, 0x0038, 0x0038, 0x0039, 0x0039, 0x003c, 0x005e, 0x0061,
    ...
    0x007a, 0x00a7, 0x00a8, 0x00e0, 0x00e8, 0x00e9, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,     28,    100,      1,     57,     43,     12,
        55,     78,     51,     74,     53,     83,    126,     52,
        98,     82,     11,     79,      2,      3,     80,      4,
        81,      5,     75,      6,     76,      7,     77,      8,
        71,      9,     72,     10,     73,     86,     13,     30,
        48,     46,     32,     18,     33,     34,     35,     23,
        36,     37,     38,     50,     49,     24,     25,     16,
        19,     31,     20,     22,     47,     17,     45,     44,
        21,     41,     27,     40,     26,     39, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0026, 0x0028, 0x0029, 0x002a, 0x002a, 0x002b, 0x002b, 0x002d,
    0x002e, 0x002e, 0x002f, 0x002f, 0x003a, 0x003b, 0x003d, 0x003e,
    0x003f, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047,
    0x0048, 0x0049, 0x004a, 0x004b, 0x004c, 0x004d, 0x004e, 0x004f,
    0x0050, 0x0051, 0x0052, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057,
    0x0058, 0x0059, 0x005a, 0x005f, 0x0060, 0x007f, 0x00a3, 0x00b0,
    0x00e4, 0x00e7, 0x00f6, 0x00fc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,     27,      3,      6,
         7,      9,     10,     55,      4,     78,      2,     74,
        83,    126,      8,    104,     52,     51,     11,     86,
        12,     30,     48,     46,     32,     18,     33,     34,
        35,     23,     36,     37,     38,     50,     49,     24,
        25,     16,     19,     31,     20,     22,     47,     17,
        45,     44,     21,     53,     13,     99,     43,     41,
        40,      5,     39,     26, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x005e, 0x00a7,
    0x00a8, 0x00e0, 0x00e8, 0x00e9, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,     28,    100,      1,     57,     43,     12,
        55,     78,     51,     74,     53,     83,    126,     52,
        98,     11,      2,      3,      4,      5,      6,      7,
         8,      9,     10,     86,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     44,     21,     13,     41,
        27,     40,     26,     39, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002d, 0x002e, 0x002e, 0x002f, 0x002f, 0x003a, 0x003b, 0x003d,
    ...
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a3, 0x00b0,
    0x00e4, 0x00e7, 0x00f6, 0x00fc, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,     27,      3,
         6,      7,      9,     10,     55,      4,     78,      2,
        74,     83,    126,     98,      8,     52,     51,     11,
        86,     12,     53,     13,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     44,     21,     43,     41,
        40,      5,     39,     26, 
};
...
static const Keylayout_r keylayout_x8000100c(
    x8000100c::LCID,
    x8000100c::locale_name,
    x8000100c::noMod,
    x8000100c::shift,
    x8000100c::altGr,
    x8000100c::shiftAltGr,
    x8000100c::ctrl,
    x8000100c::capslock_noMod,
    x8000100c::capslock_shift,
    x8000100c::capslock_altGr,
    x8000100c::capslock_shiftAltGr,
    x8000100c::deadkeys,
    x8000100c::nbDeadkeys
);
