...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x00bd, 0x00e5, 0x00e6, 0x00f0, 0x00f8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0059, 0x005a, 0x005f, 0x0060, 0x007f, 0x00a4, 0x00a7, 0x00c5,
    0x00c6, 0x00d0, 0x00d8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x007c, 0x007d, 0x007e, 0x00a3, 0x00a8, 0x00b5, 0x20ac, 0x20ac,

};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,      5,     55,     78,
        74,     98,      3,      9,     86,     10,     40,      8,
        13,     11,     27,      4,     26,     50,     18,      6,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x00b4, 0x00bd, 0x00c5,
    0x00c6, 0x00d0, 0x00d8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a4, 0x00a7, 0x00e5,
    0x00e6, 0x00f0, 0x00f8, 
};
...
static const Keylayout_r keylayout_x80000438(
    x80000438::LCID,
    x80000438::locale_name,
    x80000438::noMod,
    x80000438::shift,
    x80000438::altGr,
    x80000438::shiftAltGr,
    x80000438::ctrl,
    x80000438::capslock_noMod,
    x80000438::capslock_shift,
    x80000438::capslock_altGr,
    x80000438::capslock_shiftAltGr,
    x80000438::deadkeys,
    x80000438::nbDeadkeys
);
