...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x0037, 0x0038, 0x0038, 0x0039, 0x0039, 0x003c, 0x005d, 0x0061,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0058, 0x0059, 0x005a, 0x005b, 0x005f, 0x007f, 0x00a4, 0x00c2,
    0x00ce, 0x0102, 0x015e, 0x0162, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x007b, 0x007c, 0x007d, 0x007e, 0x00a7, 0x00a8, 0x00b0, 0x00b4,
    0x00b7, 0x00b8, 0x00d7, 0x00df, 0x00f7, 0x0110, 0x0111, 0x0141,
    0x0142, 0x02c7, 0x02d8, 0x02db, 0x02dd, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,     28,    100,      1,     39,     55,     78,
        74,     98,     51,     52,     47,     16,      4,      8,
        48,     17,     49,      2,     50,     12,      6,     10,
         9,     13,     27,     40,     26,     32,     31,     38,
        37,      3,      5,      7,     11, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0055, 0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x005d, 0x00c2,
    0x00ce, 0x0102, 0x015e, 0x0162, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x002c, 0x002d, 0x002e, 0x002f, 0x002f, 0x003a, 0x003b, 0x003d,
    0x003e, 0x003f, 0x005b, 0x005f, 0x0061, 0x0062, 0x0063, 0x0064,
    0x0065, 0x0066, 0x0067, 0x0068, 0x0069, 0x006a, 0x006b, 0x006c,
    0x006d, 0x006e, 0x006f, 0x0070, 0x0071, 0x0072, 0x0073, 0x0074,
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a4, 0x00e2,
    0x00ee, 0x0103, 0x015f, 0x0163, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,      2,      3,
         4,      6,      7,      9,     10,     13,     55,     78,
        83,     74,    126,      8,     98,     52,     51,     11,
        86,     12,     41,     53,     30,     48,     46,     32,
        18,     33,     34,     35,     23,     36,     37,     38,
        50,     49,     24,     25,     16,     19,     31,     20,
        22,     47,     17,     45,     44,     21,      5,     43,
        27,     26,     39,     40, 
};
