...
const static int LCID = 0x11809;

const static char * const locale_name = "en-IE";
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0059, 0x005a, 0x005e, 0x005f, 0x0060, 0x007b, 0x007c, 0x007d,
    0x007e, 0x007f, 0x00a3, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0027, 0x002a, 0x002b,
    0x002d, 0x002f, 0x00a6, 0x00e1, 0x00e9, 0x00ed, 0x00f3, 0x00fa,
    0x00fd, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,     28,    100,      1,     40,     55,     78,
        74,     98,     41,     30,     18,     23,     24,     22,
        21,      5, 
};
constexpr Keylayout_r::KeyLayoutMap_t altGr{uchar_altGr, scancode_altGr, 18};

constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x00ac, 0x00c1, 0x00c9, 0x00cd, 0x00d3, 0x00da, 0x00dd,

};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,     28,    100,      1,     55,     78,     74,
        98,     41,     30,     18,     23,     24,     22,     21,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0040, 0x005e, 0x005f, 0x0060, 0x0061, 0x0062, 0x0063, 0x0064,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0027, 0x002a, 0x002b,
    0x002d, 0x002f, 0x00a6, 0x00c1, 0x00c9, 0x00cd, 0x00d3, 0x00da,
    0x00dd, 0x20ac, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t capslock_altGr{uchar_capslock_altGr, scancode_capslock_altGr, 18};

constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x00ac, 0x00e1, 0x00e9, 0x00ed, 0x00f3, 0x00fa, 0x00fd,
...
static const Keylayout_r keylayout_x80011809(
    x80011809::LCID,
    x80011809::locale_name,
    x80011809::noMod,
    x80011809::shift,
    x80011809::altGr,
    x80011809::shiftAltGr,
    x80011809::ctrl,
    x80011809::capslock_noMod,
    x80011809::capslock_shift,
    x80011809::capslock_altGr,
    x80011809::capslock_shiftAltGr,
    x80011809::deadkeys,
    x80011809::nbDeadkeys
);
