...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x002a, 0x002b, 0x002c, 0x002c, 0x002d, 0x002e, 0x002f, 0x0030,
    0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038,
    0x0039, 0x005c, 0x005c, 0x0430, 0x0431, 0x0432, 0x0433, 0x0434,
    ...
    0x044d, 0x044e, 0x044f, 0x0456, 0x0493, 0x049b, 0x04a3, 0x04af,
    0x04b1, 0x04bb, 0x04d9, 0x04e9, 0x2116, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,    100,     28,      1,     57,      2,     41,
        55,     78,     83,      7,     74,      8,     98,     82,
        79,     80,     81,     75,     76,     77,     71,     72,
        73,     86,     43,     33,     51,     32,     22,     38,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    0x0008, 0x000d, 0x000d, 0x001b, 0x0020, 0x0021, 0x0029, 0x002a,
    0x002b, 0x002c, 0x002d, 0x002f, 0x002f, 0x003a, 0x003b, 0x003f,
    0x007c, 0x007f, 0x0406, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414,
    ...
    0x042d, 0x042e, 0x042f, 0x0492, 0x049a, 0x04a2, 0x04ae, 0x04b0,
    0x04ba, 0x04d8, 0x04e8, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,    100,     28,      1,     57,      2,     41,     55,
        78,     83,     74,    104,     43,      8,      7,     53,
        86,     99,      4,     33,     51,     32,     22,     38,
        20,     39,     25,     48,     16,     19,     37,     47,
        21,     36,     34,     35,     46,     49,     18,     30,
        26,     17,     45,     23,     24,     27,     31,     50,
        40,     52,     44,      6,     11,      5,      9,     10,
        13,      3,     12, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0022, 0x0028,
    0x002a, 0x002b, 0x002c, 0x002c, 0x002d, 0x002e, 0x002f, 0x005c,
    0x007c, 0x0406, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415,
    0x0416, 0x0417, 0x0418, 0x0419, 0x041a, 0x041b, 0x041c, 0x041d,
    0x041e, 0x041f, 0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425,
    0x0426, 0x0427, 0x0428, 0x0429, 0x042a, 0x042b, 0x042c, 0x042d,
    0x042e, 0x042f, 0x0492, 0x049a, 0x04a2, 0x04ae, 0x04b0, 0x04ba,
    0x04d8, 0x04e8, 0x2116, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,    100,     28,      1,     57,      2,     41,
        55,     78,     83,      7,     74,      8,     98,     43,
        86,      4,     33,     51,     32,     22,     38,     20,
        39,     25,     48,     16,     19,     37,     47,     21,
        36,     34,     35,     46,     49,     18,     30,     26,
        17,     45,     23,     24,     27,     31,     50,     40,
        52,     44,      6,     11,      5,      9,     10,     13,
         3,     12,     53, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0021, 0x0029,
    0x002a, 0x002b, 0x002c, 0x002d, 0x002f, 0x002f, 0x003a, 0x003b,
    0x003f, 0x005c, 0x0430, 0x0431, 0x0432, 0x0433, 0x0434, 0x0435,
    0x0436, 0x0437, 0x0438, 0x0439, 0x043a, 0x043b, 0x043c, 0x043d,
    0x043e, 0x043f, 0x0440, 0x0441, 0x0442, 0x0443, 0x0444, 0x0445,
    0x0446, 0x0447, 0x0448, 0x0449, 0x044a, 0x044b, 0x044c, 0x044d,
    0x044e, 0x044f, 0x0456, 0x0493, 0x049b, 0x04a3, 0x04af, 0x04b1,
    0x04bb, 0x04d9, 0x04e9, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,      2,     41,
        55,     78,     83,     74,     98,     43,      8,      7,
        53,     86,     33,     51,     32,     22,     38,     20,
        39,     25,     48,     16,     19,     37,     47,     21,
        36,     34,     35,     46,     49,     18,     30,     26,
        17,     45,     23,     24,     27,     31,     50,     40,
        52,     44,      4,      6,     11,      5,      9,     10,
...
static const Keylayout_r keylayout_x8000043f(
    x8000043f::LCID,
    x8000043f::locale_name,
    x8000043f::noMod,
    x8000043f::shift,
    x8000043f::altGr,
    x8000043f::shiftAltGr,
    x8000043f::ctrl,
    x8000043f::capslock_noMod,
    x8000043f::capslock_shift,
    x8000043f::capslock_altGr,
    x8000043f::capslock_shiftAltGr,
    x8000043f::deadkeys,
    x8000043f::nbDeadkeys
);
