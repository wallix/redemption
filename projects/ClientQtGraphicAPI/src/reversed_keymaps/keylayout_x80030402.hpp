...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0028, 0x002a,
    0x002b, 0x002c, 0x002c, 0x002d, 0x002d, 0x002e, 0x002f, 0x0030,
    0x0030, 0x0031, 0x0031, 0x0032, 0x0032, 0x0033, 0x0033, 0x0034,
    0x0034, 0x0035, 0x0035, 0x0036, 0x0036, 0x0037, 0x0037, 0x0038,
    0x0038, 0x0039, 0x0039, 0x003b, 0x0430, 0x0431, 0x0432, 0x0433,
    0x0434, 0x0435, 0x0436, 0x0437, 0x0438, 0x0439, 0x043a, 0x043b,
    0x043c, 0x043d, 0x043e, 0x043f, 0x0440, 0x0441, 0x0442, 0x0443,
    0x0444, 0x0445, 0x0446, 0x0447, 0x0448, 0x0449, 0x044a, 0x044c,
    0x044d, 0x044e, 0x044f, 0x045d, 0x201e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        14,     15,     28,    100,      1,     57,     41,     55,
        78,     83,     16,     74,     12,     13,     98,     82,
        11,     79,      2,     80,      3,     81,      4,     75,
         5,     76,      6,      7,     77,     71,      8,      9,
        72,     73,     10,     27,     32,     53,     38,     35,
        24,     18,     34,     25,     19,     45,     22,     52,
        39,     37,     33,     50,     51,     23,     36,     17,
        48,     49,     26,     40,     20,     21,     46,     30,
        47,     44,     31,     86,     43, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0025, 0x0029, 0x002a, 0x002b, 0x002b, 0x002c, 0x002d, 0x002f,
    0x002f, 0x003a, 0x003d, 0x003f, 0x007f, 0x00a7, 0x040d, 0x0410,
    ...
    0x0429, 0x042a, 0x042d, 0x042e, 0x042f, 0x044b, 0x045d, 0x2013,
    0x201c, 0x20ac, 0x2116, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,    100,     28,      1,     57,      2,      5,     12,
         6,     41,     55,      4,     78,     83,     74,    104,
         9,      8,      7,      3,     99,     27,     86,     32,
        53,     38,     35,     24,     18,     34,     25,     19,
        45,     22,     52,     39,     37,     33,     50,     51,
        23,     36,     17,     48,     49,     26,     40,     20,
        21,     46,     47,     44,     31,     16,     30,     10,
        43,     13,     11, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0020, 0x0028, 0x002a,
    0x002b, 0x002c, 0x002d, 0x002d, 0x002e, 0x002f, 0x0030, 0x0031,
    0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039,
    0x003b, 0x040d, 0x0410, 0x0411, 0x0412, 0x0413, 0x0414, 0x0415,
    0x0416, 0x0417, 0x0418, 0x0419, 0x041a, 0x041b, 0x041c, 0x041d,
    0x041e, 0x041f, 0x0420, 0x0421, 0x0422, 0x0423, 0x0424, 0x0425,
    0x0426, 0x0427, 0x0428, 0x0429, 0x042a, 0x042b, 0x042c, 0x042d,
    0x042e, 0x042f, 0x201e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_noMod[] {
        14,     15,    100,     28,      1,     57,     41,     55,
        78,     83,     74,     12,     13,     98,     11,      2,
         3,      4,      5,      6,      7,      8,      9,     10,
        27,     86,     32,     53,     38,     35,     24,     18,
        34,     25,     19,     45,     22,     52,     39,     37,
        33,     50,     51,     23,     36,     17,     48,     49,
        26,     40,     20,     21,     46,     16,     30,     47,
        44,     31,     43, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0024, 0x0025, 0x0029, 0x002a, 0x002b, 0x002b, 0x002c, 0x002d,
    0x002f, 0x002f, 0x003a, 0x003d, 0x003f, 0x00a7, 0x040d, 0x0430,
    ...
    0x0449, 0x044a, 0x044d, 0x044e, 0x044f, 0x045d, 0x2013, 0x201c,
    0x20ac, 0x2116, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,    100,     28,      1,     57,      2,      5,
        12,      6,     41,     55,     78,      4,     83,     74,
         9,     98,      8,      7,      3,     27,     30,     32,
        53,     38,     35,     24,     18,     34,     25,     19,
        45,     22,     52,     39,     37,     33,     50,     51,
        23,     36,     17,     48,     49,     26,     40,     20,
        21,     46,     47,     44,     31,     86,     10,     43,
        13,     11, 
};
