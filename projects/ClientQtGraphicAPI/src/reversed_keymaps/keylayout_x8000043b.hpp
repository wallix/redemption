...
const static int LCID = 0x43b;

const static char * const locale_name = "se-NO";
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x007c, 0x00a8, 0x00e5, 0x00e6, 0x00f8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shift[] {
    ...
    0x0059, 0x005a, 0x005e, 0x005f, 0x0060, 0x007f, 0x00a4, 0x00a7,
    0x00c5, 0x00c6, 0x00d8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002d, 0x002f, 0x0040, 0x005b, 0x005d, 0x007b, 0x007d, 0x007e,
    0x00a3, 0x00b4, 0x00b5, 0x00e1, 0x00e2, 0x00e4, 0x00ef, 0x00f5,
    0x00f6, 0x010d, 0x0111, 0x014b, 0x0161, 0x0167, 0x017e, 0x01e5,
    0x01e7, 0x01e9, 0x01ef, 0x021f, 0x0292, 0x20ac, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,      5,     55,     78,
        74,     98,      3,      9,     10,      8,     11,     27,
         4,     13,     50,     30,     16,     40,     23,     24,
        39,     46,     32,     49,     31,     20,     44,     33,
        34,     37,     47,     35,     48,      6,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    ...
    0x002f, 0x00c1, 0x00c2, 0x00c4, 0x00cf, 0x00d5, 0x00d6, 0x010c,
    0x0110, 0x014a, 0x0160, 0x0166, 0x017d, 0x01b7, 0x01e4, 0x01e6,
    0x01e8, 0x01ee, 0x021e, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     30,     16,     40,     23,     24,     39,     46,
        32,     49,     31,     20,     44,     48,     33,     34,
        37,     47,     35, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x005c, 0x007c, 0x00a8,
    0x00c5, 0x00c6, 0x00d8, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x00a4, 0x00a7,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0024, 0x002a, 0x002b,
    0x002d, 0x002f, 0x0040, 0x005b, 0x005d, 0x007b, 0x007d, 0x007e,
    0x00a3, 0x00b4, 0x00b5, 0x00c1, 0x00c2, 0x00c4, 0x00cf, 0x00d5,
    0x00d6, 0x010c, 0x0110, 0x014a, 0x0160, 0x0166, 0x017d, 0x01b7,
    0x01e4, 0x01e6, 0x01e8, 0x01ee, 0x021e, 0x20ac, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_altGr[] {
        14,     15,    100,     28,      1,      5,     55,     78,
        74,     98,      3,      9,     10,      8,     11,     27,
         4,     13,     50,     30,     16,     40,     23,     24,
        39,     46,     32,     49,     31,     20,     44,     48,
        33,     34,     37,     47,     35,      6,     18, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x00e1, 0x00e2, 0x00e4, 0x00ef, 0x00f5, 0x00f6, 0x010d,
    0x0111, 0x014b, 0x0161, 0x0167, 0x017e, 0x01e5, 0x01e7, 0x01e9,
    0x01ef, 0x021f, 0x0292, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shiftAltGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,     30,     16,     40,     23,     24,     39,     46,
        32,     49,     31,     20,     44,     33,     34,     37,
        47,     35,     48, 
};
...
static const Keylayout_r keylayout_x8000043b(
    x8000043b::LCID,
    x8000043b::locale_name,
    x8000043b::noMod,
    x8000043b::shift,
    x8000043b::altGr,
    x8000043b::shiftAltGr,
    x8000043b::ctrl,
    x8000043b::capslock_noMod,
    x8000043b::capslock_shift,
    x8000043b::capslock_altGr,
    x8000043b::capslock_shiftAltGr,
    x8000043b::deadkeys,
    x8000043b::nbDeadkeys
);
