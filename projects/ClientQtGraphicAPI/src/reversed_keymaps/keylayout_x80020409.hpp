...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_noMod[] {
        ...
        81,      5,     75,     76,      6,     77,      7,      8,
        71,      9,     72,     10,     73,     39,     13,     26,
        86,     43,     27,     41,     30,     48,     46,     32,
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shift[] {
        14,     28,    100,      1,     57,      2,     40,      4,
         5,      6,      8,     10,     11,      9,     55,     13,
        78,     74,     83,    126,    104,     39,     51,     52,
        53,      3,     30,     48,     46,     32,     18,     33,
        34,     35,     23,     36,     37,     38,     50,     49,
        24,     25,     16,     19,     31,     20,     22,     47,
        17,     45,     21,     44,      7,     12,     26,     86,
        43,     27,     41,     99, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        14,     15,     28,    100,      1,     57,      2,     40,
         4,      5,      6,      8,     10,     11,      9,     55,
        13,     78,     74,     83,    126,     98,     39,     51,
        52,     53,      3,      7,     12,     30,     48,     46,
        32,     18,     33,     34,     35,     23,     36,     37,
        38,     50,     49,     24,     25,     16,     19,     31,
        20,     22,     47,     17,     45,     21,     44,     26,
        86,     43,     27,     41, 
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_altGr[] {
    ...
    0x002f, 0x00a1, 0x00a4, 0x00a5, 0x00a9, 0x00ab, 0x00ac, 0x00ae,
    0x00b2, 0x00b3, 0x00b4, 0x00b5, 0x00b6, 0x00bb, 0x00bc, 0x00bd,
    0x00be, 0x00bf, 0x00c1, 0x00c4, 0x00c5, 0x00c6, 0x00c7, 0x00c9,
    0x00cd, 0x00d0, 0x00d1, 0x00d3, 0x00d6, 0x00d7, 0x00d8, 0x00da,
    0x00dc, 0x00de, 0x00df, 0x2018, 0x2019, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_altGr[] {
        14,     15,    100,     28,      1,     55,     78,     74,
        98,      2,      5,     12,     46,     26,     43,     19,
         3,      4,     40,     50,     39,     27,      7,      8,
         9,     53,     30,     16,     17,     44,     51,     18,
        23,     32,     49,     24,     25,     13,     38,     22,
        21,     20,     31,     10,     11,      6, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x002a, 0x002b, 0x002d,
    0x002f, 0x00a2, 0x00a3, 0x00a6, 0x00a7, 0x00a8, 0x00b0, 0x00b9,
    0x00e1, 0x00e4, 0x00e5, 0x00e6, 0x00e7, 0x00e9, 0x00ed, 0x00f0,
    0x00f1, 0x00f3, 0x00f6, 0x00f7, 0x00f8, 0x00fa, 0x00fc, 0x00fe,
