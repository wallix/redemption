...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002d, 0x002f, 0x0040, 0x005b, 0x005d, 0x0060, 0x007b, 0x007d,
    0x007e, 0x20ac, 0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,      4,     55,     78,
        74,     98,     16,      9,     10,     43,      8,     11,
        27,     18,      6, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x007c, 0x00a3, 0x00a7,
    0x00b0, 0x00e7, 0x00e9, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_capslock_shift[] {
        ...
        12,     13,     53,     30,     48,     46,     32,     18,
        33,     34,     35,     23,     36,     37,     38,     50,
        49,     24,     25,     16,     19,     31,     20,     22,
        47,     17,     45,     21,     44,     41,      4,     43,
        40,     39,     26, 
};
...
static const Keylayout_r keylayout_x80010410(
    x80010410::LCID,
    x80010410::locale_name,
    x80010410::noMod,
    x80010410::shift,
    x80010410::altGr,
    x80010410::shiftAltGr,
    x80010410::ctrl,
    x80010410::capslock_noMod,
    x80010410::capslock_shift,
    x80010410::capslock_altGr,
    x80010410::capslock_shiftAltGr,
    x80010410::deadkeys,
    x80010410::nbDeadkeys
);
