...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_noMod[] {
    ...
    0x00e4, 0x00f5, 0x00f6, 0x00fc, 0x02c7, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    ...
    0x002d, 0x002f, 0x0040, 0x005b, 0x005c, 0x005d, 0x005e, 0x007b,
    0x007c, 0x007d, 0x00a3, 0x00a7, 0x00bd, 0x0161, 0x017e, 0x20ac,
    0x20ac, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,      5,     55,     78,
        74,     98,      3,      9,     12,     10,     40,      8,
        86,     11,      4,     27,     43,     31,     44,     18,
         6, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0024, 0x002a, 0x002b,
    0x002d, 0x002f, 0x0040, 0x005b, 0x005c, 0x005d, 0x005e, 0x007b,
    0x007c, 0x007d, 0x00a3, 0x00a7, 0x00bd, 0x0160, 0x017d, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_noMod[] {
    ...
    0x0056, 0x0057, 0x0058, 0x0059, 0x005a, 0x00b4, 0x00c4, 0x00d5,
    0x00d6, 0x00dc, 0x02c7, 
};
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_capslock_shift[] {
    ...
    0x0076, 0x0077, 0x0078, 0x0079, 0x007a, 0x007e, 0x00a4, 0x00e4,
    0x00f5, 0x00f6, 0x00fc, 
};
...
static const Keylayout_r keylayout_x80000425(
    x80000425::LCID,
    x80000425::locale_name,
    x80000425::noMod,
    x80000425::shift,
    x80000425::altGr,
    x80000425::shiftAltGr,
    x80000425::ctrl,
    x80000425::capslock_noMod,
    x80000425::capslock_shift,
    x80000425::capslock_altGr,
    x80000425::capslock_shiftAltGr,
    x80000425::deadkeys,
    x80000425::nbDeadkeys
);
