...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_altGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0029, 0x002a, 0x002b,
    0x002b, 0x002d, 0x002d, 0x002f, 0x003a, 0x003b, 0x003d, 0x003f,
    0x00a7, 0x00a8, 0x00b4, 0x00df, 0x00e1, 0x00e9, 0x00ed, 0x00fa,
    0x00fd, 0x010d, 0x011b, 0x0159, 0x0161, 0x016f, 0x017e, 0x20ac,

};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_altGr[] {
        14,     15,    100,     28,      1,     27,     55,      2,
        78,     74,     53,     98,     52,     41,     12,     51,
        40,     43,     13,     86,      9,     11,     10,     26,
         8,      5,      3,      6,      4,     39,      7,     18,
...
constexpr Keylayout_r::KeyLayoutMap_t::uchar_type uchar_shiftAltGr[] {
    0x0008, 0x0009, 0x000d, 0x000d, 0x001b, 0x0021, 0x0022, 0x0025,
    0x0028, 0x002a, 0x002b, 0x002d, 0x002f, 0x002f, 0x005e, 0x005f,
    0x00b0, 0x00d7, 0x00f7, 0x02c7, 0x02dd, 
};
constexpr Keylayout_r::KeyLayoutMap_t::scancode_type scancode_shiftAltGr[] {
        14,     15,    100,     28,      1,     40,     39,     12,
        27,     55,     78,     74,     26,     98,     43,     53,
        41,     51,     52,     13,     86, 
};
