...
RED_AUTO_TEST_CASE(TestDialogMod)
{
    ...
    InteractiveTargetMod d(ini, time_base, timer_events_, graphic_events_, front.gd(), front, 800, 600, Rect(0, 0, 799, 599), client_execute, global_font(), theme);
...
RED_AUTO_TEST_CASE(TestDialogModReject)
{
    ...
    InteractiveTargetMod d(ini, time_base, timer_events_, graphic_events_, front.gd(), front, screen_info.width, screen_info.height, Rect(0, 0, 799, 599), client_execute, global_font(), theme);
...
RED_AUTO_TEST_CASE(TestDialogModChallenge2)
{
    ...
    InteractiveTargetMod d(ini, time_base, timer_events_, graphic_events_, front.gd(), front, screen_info.width, screen_info.height, Rect(800, 600, 799, 599), client_execute, global_font(), theme);
