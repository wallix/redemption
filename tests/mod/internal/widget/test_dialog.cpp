...
RED_AUTO_TEST_CASE(EventWidgetOkCancel)
{
    ...
    // flat_dialog.ok.rdp_input_mouse(MOUSE_FLAG_BUTTON1|MOUSE_FLAG_DOWN, 15, 15);
    RED_CHECK(notifier.last_widget == &flat_dialog);
    RED_CHECK(notifier.last_event == 0);
    ...
    //                                  flat_dialog.ok.x(), flat_dialog.ok.y());
    RED_CHECK(notifier.last_widget == &flat_dialog);
    ...
    flat_dialog.rdp_input_mouse(MOUSE_FLAG_BUTTON1|MOUSE_FLAG_DOWN, x, y);
    // flat_dialog.cancel->rdp_input_mouse(MOUSE_FLAG_BUTTON1|MOUSE_FLAG_DOWN, 15, 15);
    RED_CHECK(notifier.last_widget == &flat_dialog);
    RED_CHECK(notifier.last_event == 0);
