...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit)
{
    ...
    CHECK_SIG(drawable.gd, "\xa2\x83\xc9\x3f\x2e\x0a\xe8\xe3\xb4\x08\x27\x38\x3c\x56\xa5\xed\x6c\x46\xb4\x04");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit2)
{
    ...
    CHECK_SIG(drawable.gd, "\x84\xd6\xc6\xbe\xb0\xd5\xbe\x01\x99\x72\xc1\xe0\xfc\xd9\x5f\x33\x91\x40\x5e\x81");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit3)
{
    ...
    CHECK_SIG(drawable.gd, "\x6d\x70\x05\x11\xe5\x3d\x98\xa4\x53\x0e\xc2\xcf\x3f\x27\xda\x63\xb3\x50\x43\x92");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit4)
{
    ...
    CHECK_SIG(drawable.gd, "\x1e\xf8\x27\x8b\x51\x40\x95\x9f\xa2\x11\x77\x83\x76\x87\x8e\x56\x0e\x87\xf7\x35");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit5)
{
    ...
    CHECK_SIG(drawable.gd, "\x4d\x1d\xde\x48\xe4\x3b\xca\x16\x49\xf8\xc6\xa2\x2b\xb6\xd8\x41\x4d\x1d\x10\x02");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit6)
{
    ...
    CHECK_SIG(drawable.gd, "\x18\xfd\x61\xa5\x48\x8e\xd1\x96\x2a\x82\xa3\xfc\x1f\x7b\x9a\xce\xbc\xee\x14\x09");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditClip)
{
    ...
    CHECK_SIG(drawable.gd, "\xe0\x8f\xa1\x08\x78\x93\x67\x19\xea\xc1\xf0\xa0\x7a\xba\x6f\x91\x88\x6c\x9c\x89");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditClip2)
{
    ...
    CHECK_SIG(drawable.gd, "\xf7\x5e\x7f\x51\xd8\xfd\x81\x8f\x1e\x8d\x73\xa8\x9c\xd7\xeb\x94\xf9\x35\xd2\x2b");
}
...
BOOST_AUTO_TEST_CASE(EventWidgetEdit)
{
    ...
    CHECK_SIG(drawable.gd, "\x06\x35\x2c\xbb\xf9\xe4\xd6\xb1\xe7\xd8\xa7\x97\x63\x8a\x67\xf3\x58\x3d\x47\x44");
    ...
    CHECK_SIG(drawable.gd, "\x1f\x1b\x42\x70\xd5\x06\xf7\x86\xb9\xee\xfb\x8f\xed\xb5\x5a\x30\xfc\x11\xa1\x5e");
    ...
    CHECK_SIG(drawable.gd, "\xb9\x6c\xe1\x87\xeb\x7f\x77\x16\x9d\x18\xe6\x4e\xd1\xf2\x11\x5e\x12\x89\x0e\xd7");
    BOOST_CHECK(notifier.sender == &wedit);
    BOOST_CHECK(notifier.event == NOTIFY_TEXT_CHANGED);
    notifier.sender = nullptr;
    notifier.event = 0;
    ...
    CHECK_SIG(drawable.gd, "\x92\x27\x53\x44\xf7\x1c\xcb\x17\x3c\xe2\x2f\xa7\xec\x1d\x50\x3b\x26\xfc\x5c\xe8");
    ...
    CHECK_SIG(drawable.gd, "\x16\x3c\xed\x11\xb8\x7f\xc7\xa5\x95\xe0\x7f\xc0\x80\x81\xc4\x45\x86\xcf\xae\x52");

    keymap.push_kevent(Keymap2::KEVENT_LEFT_ARROW);
    wedit.rdp_input_scancode(0, 0, 0, 0, &keymap);
    wedit.rdp_input_invalidate(Rect(0, 0, wedit.cx(), wedit.cx()));
    // drawable.save_to_png(OUTPUT_FILE_PATH "edit-e7.png");
    CHECK_SIG(drawable.gd, "\x2a\xdb\xc9\x67\xa1\x0a\x90\x0b\x71\xba\xee\xb2\xf1\x7a\x69\xbf\x81\x4c\x37\x1c");
    ...
    CHECK_SIG(drawable.gd, "\x10\xde\xc3\x6e\xc7\xeb\x61\xb0\xa0\x52\x79\x66\xff\x98\x38\x22\x4c\xdf\x0f\xb2");
    ...
    CHECK_SIG(drawable.gd, "\x0d\x81\x9c\x82\x3f\x74\x8c\x99\x6d\x46\xbc\x3b\x82\xd6\x23\xc9\xd3\x59\x62\xc2");
    ...
    CHECK_SIG(drawable.gd, "\xd9\x91\xf5\x9e\x54\x5f\x7e\x35\xe8\x3c\x72\xac\xaf\x2f\x77\x64\x57\x11\xda\x66");
    ...
    CHECK_SIG(drawable.gd, "\x19\x07\xef\x0d\x1b\xc4\xcc\xba\x55\xf8\x4d\xf3\x59\x0e\xfb\x09\x49\x10\x50\x17");
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditAndComposite)
{
    ...
    CHECK_SIG(drawable.gd, "\x42\x13\x7c\x26\xa7\x7f\x59\xbe\x96\x0d\x62\xbd\x64\xe9\xe9\xef\xdf\xc1\xae\x17");
    ...
    CHECK_SIG(drawable.gd, "\x3e\x5e\xc8\xb9\xdd\x06\xcf\xe0\xfb\xf8\x3d\x06\x72\x8e\xc8\xc5\x1a\xd5\xa5\x86");
    wcomposite.clear();
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditScrolling)
{
    ...
    CHECK_SIG(drawable.gd, "\x76\x19\xcc\x5d\xc0\xf6\x6a\xb3\x1b\x4e\xdb\x60\xf5\xa8\x64\x53\xde\xff\x3e\xae");
