...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit)
{
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xbd\x7b\x96\xbf\x0f\x7f\xfd\x2b\xab\x0b\x38\x6f\x5a\x0a\x93\x2d\x7d\xc3\x3d\x46"
    )){
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit2)
{
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x80\xbb\x8c\x86\xf5\x9e\x67\xc9\x26\xc8\xa2\xfc\x34\x4d\x63\xa4\xdd\x55\x54\xe8"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xb8\x5c\x16\x4b\x8e\xa9\x6c\x7b\xe1\xab\x52\x5e\x68\xea\x1d\x9d\x25\x21\xbc\x0d"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xc7\x8f\x6b\xb8\x20\xe0\x0d\x68\x0a\x2b\xb2\x27\xfa\xe6\xcd\xac\x1f\x26\xce\xd4"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
...
BOOST_AUTO_TEST_CASE(TraceWidgetEdit3)
{
    ...
    char message[1024];
    if (!check_sig(drawable.gd.impl(), message,
        "\x7e\xa0\x42\x9e\x72\x4a\xd1\x26\x03\xee\x2b\x64\x01\xb4\xc4\x46\xac\x18\xa1\x21"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x77\x0d\xb5\x0c\x45\xc9\x2d\xab\x00\x95\x99\xcf\xac\xa2\xee\x07\x03\x3c\xf1\xcc"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x37\x03\x36\xe6\xd0\x9a\xac\x83\x51\x69\x5c\x71\xf1\xc7\x40\xb7\x4a\x1c\xa9\x6a"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x36\x2b\x05\x1f\x52\x86\x11\xb9\x0a\xac\xac\x50\x46\xe5\xa9\xa4\x4b\xdf\x2c\x07"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
}
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditLabels)
{
    ...
    char message[1024];
    if (!check_sig(drawable.gd.impl(), message,
        "\x1b\x00\x44\x22\x30\x91\xb4\xf6\x2f\xd4\x5a\x08\xfe\x59\xf0\xaf\x8d\xad\xa0\x1c"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xbe\xaf\xc9\x87\x0d\xd6\x30\x7c\x8a\xe3\xed\x85\xba\xa2\x3d\x48\x46\x1b\x68\x1e"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xa8\xbd\x98\x2c\xe7\xf9\x76\xeb\xd4\x9c\x73\x95\x19\xd4\x94\x72\x0d\xd0\xdd\x85"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x50\xba\xcc\xab\x26\x75\x81\x3d\xaa\xe8\x21\xd9\x86\xa6\x38\x32\xa4\x3f\x22\xaa"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xc4\x4f\x38\x33\x7a\x27\x35\x44\x63\xba\x16\xfd\x35\x1e\x0c\x6f\x54\xc5\xd7\xd8"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
...
BOOST_AUTO_TEST_CASE(TraceWidgetEditLabelsPassword)
{
    ...
    char message[1024];
    if (!check_sig(drawable.gd.impl(), message,
        "\xa3\xaf\x62\x5c\x4c\x0d\xe4\x51\x66\x04\x4c\x4d\x32\x07\xe5\x9c\x1e\x11\x64\x13"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xee\x77\xf2\x26\x74\xea\xa5\x69\xaa\x04\xf0\xc9\x45\x8c\x89\xd0\x04\x17\xf0\x6c"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xc6\xc0\x75\x9a\x5b\x71\x44\xdc\x45\x8a\x06\x1a\x79\x0c\x53\x5b\xe5\xcb\x50\xe7"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x7f\xdd\xc5\x1d\x9b\xb2\xf6\x1b\x36\xa8\xdc\xda\x54\xbe\x9b\x1b\xf4\x12\x19\x03"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\x17\x49\xc8\x96\xa4\x29\x4f\x2e\xf5\x25\x91\x55\xc7\x81\xd9\x07\xe2\x33\x1d\xe6"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xb5\x4c\x6c\xaa\x95\x3c\xa6\x61\x8d\x2c\x89\xb8\xd5\x32\x00\xd5\x2e\x62\x30\xd8"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
...
BOOST_AUTO_TEST_CASE(EventWidgetEditEvents)
{
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xe3\xc7\xaa\x49\xda\x08\x4b\xaa\x47\x94\x24\xf9\x84\x23\xe7\x1e\x9e\x19\xbe\xfe"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
    ...
    if (!check_sig(drawable.gd.impl(), message,
        "\xaa\x20\xdf\x8a\x13\x2d\x9f\xf1\xf6\x3b\x29\x9c\x7b\xd7\xaf\x19\x1a\x5e\x6c\x4c"
    )){
        BOOST_CHECK_MESSAGE(false, message);
    }
