...
RED_AUTO_TEST_CASE(TestColors)
{
    ...
    RED_CHECK_EQUAL(BGRColor_(0xFF0000), color_decode(RDPColor::from(0x7C00), 15, palette));
    RED_CHECK_EQUAL(BGRColor_(0x00FF00), color_decode(RDPColor::from(0x03E0), 15, palette));
    RED_CHECK_EQUAL(BGRColor_(0x0000FF), color_decode(RDPColor::from(0x001F), 15, palette));
    ...
    RED_CHECK_EQUAL(BGRColor_(0xFF0000), color_decode(RDPColor::from(0xF800), 16, palette));
    RED_CHECK_EQUAL(BGRColor_(0x00FF00), color_decode(RDPColor::from(0x07E0), 16, palette));
    RED_CHECK_EQUAL(BGRColor_(0x0000FF), color_decode(RDPColor::from(0x001F), 16, palette));

    RED_CHECK_EQUAL(RDPColor::from(0xFF), color_encode(BGRColor_(0xFFFFFF), 8));
    RED_CHECK_EQUAL(RDPColor::from(0xE0), color_encode(BGRColor_(0xFF0000), 8));
    RED_CHECK_EQUAL(RDPColor::from(0x1C), color_encode(BGRColor_(0x00FF00), 8));
    RED_CHECK_EQUAL(RDPColor::from(0x03), color_encode(BGRColor_(0x0000FF), 8));

    RED_CHECK_EQUAL(RDPColor::from(0x7FFF), color_encode(BGRColor_(0xFFFFFF), 15));
    RED_CHECK_EQUAL(RDPColor::from(0x7C00), color_encode(BGRColor_(0xFF0000), 15));
    RED_CHECK_EQUAL(RDPColor::from(0x03E0), color_encode(BGRColor_(0x00FF00), 15));
    RED_CHECK_EQUAL(RDPColor::from(0x001F), color_encode(BGRColor_(0x0000FF), 15));

    RED_CHECK_EQUAL(RDPColor::from(0xFFFF), color_encode(BGRColor_(0xFFFFFF), 16));
    RED_CHECK_EQUAL(RDPColor::from(0xF800), color_encode(BGRColor_(0xFF0000), 16));
    RED_CHECK_EQUAL(RDPColor::from(0x07E0), color_encode(BGRColor_(0x00FF00), 16));
    RED_CHECK_EQUAL(RDPColor::from(0x001F), color_encode(BGRColor_(0x0000FF), 16));
