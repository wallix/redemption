...
RED_AUTO_TEST_CASE(TestAddMouse)
{
    ...
    default_pointer.initialize(0, 0, 32, 32, pointer_data, pointer_mask);
    current_pointer = &default_pointer;
    save_mouse_x = mouse_cursor_pos_x = 100;
    save_mouse_y = mouse_cursor_pos_y = 100;    

    gd.opaquerect(screen_rect, gd.u32bgr_to_color(RED)); // RED
    gd.trace_mouse(current_pointer, mouse_cursor_pos_x, mouse_cursor_pos_y, save_mouse);
    ...
    gd.clear_mouse(current_pointer, save_mouse_x, save_mouse_y, save_mouse);
...
RED_AUTO_TEST_CASE(TestAddMouse2)
{
    ...
    default_pointer.initialize(0, 0, 32, 32, pointer_data, pointer_mask);
    current_pointer = &default_pointer;
    save_mouse_x = mouse_cursor_pos_x = 638;
    save_mouse_y = mouse_cursor_pos_y = 470;    
...
RED_AUTO_TEST_CASE(TestAddMouse3)
{
    ...
    default_pointer.initialize(0, 0, 32, 32, pointer_data, pointer_mask);
    current_pointer = &default_pointer;
    save_mouse_x = mouse_cursor_pos_x = 0;
    save_mouse_y = mouse_cursor_pos_y = 0;    

    default_pointer.hotspot_x = 8;
    default_pointer.hotspot_y = 8;
