...
RED_AUTO_TEST_CASE(TestAppRecorder)
{
    ...
    RED_CHECK_FILE_SIZE_AND_CLEAN("/tmp/recorder.1-000000.flv", 13450874);
    RED_CHECK_FILE_SIZE_AND_CLEAN("/tmp/recorder.1-000001.flv", 1641583);
    RED_CHECK_FILE_SIZE_AND_CLEAN("/tmp/recorder.1.flv", 14977057);
}
...
RED_AUTO_TEST_CASE(TestAppRecorderVlc)
{
    ...
    RED_CHECK_FILE_SIZE_AND_CLEAN2("/tmp/recorder.1-000000.flv", 62513401, 62513397);
    RED_CHECK_FILE_SIZE_AND_CLEAN("/tmp/recorder.1-000001.flv", 7555247);
    RED_CHECK_FILE_SIZE_AND_CLEAN2("/tmp/recorder.1.flv", 70069337, 70069333);
}
