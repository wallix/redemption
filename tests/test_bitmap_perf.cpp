...
//    {
//        int bpp = 24;
//        Bitmap bigbmp(FIXTURES_PATH "/last_page.bmp");
//        // make it large enough to hold any image
//        Stream out(2*bigbmp.bmp_size(bpp));
//        unsigned long long usec = ustime();
//        unsigned long long cycles = rdtsc();
...
//            printf("    static uint8_t raw_last_page[] = {", &bmp);
...
//            }
//            printf("    };\n", &bmp);
//            printf("    this->last_page = new Bitmap(24, NULL, %d, %d, raw_last_page, sizeof(raw_last_page));\n",
