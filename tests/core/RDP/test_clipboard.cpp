...
BOOST_AUTO_TEST_CASE(TestFormatDataResponsePDU)
{
    ...
    const char metafilepic_out_data[] =
        "\x05\x00\x01\x00\xc2\x7e\x05\x00\x08\x00\x00\x00\x57\x29\x00\x00\x02\x1f\x00\x00"
        ...
        "\x2c\x01\x00\x00\x01\x00\x18\x00\x00\x00\x00\x00\x40\x7e\x05\x00\x00\x00\x00\x00"
        "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00";

    std::string expected(reinterpret_cast<const char *>(metafilepic_out_data), 130);

    for (int i = 0; i < 130; i++) {
        std::cout << int(ou_stream_metaFilePic.get_data()[i]) <<  " " << int(static_cast<uint8_t>(metafilepic_out_data[i])) <<  std::endl;
    }
