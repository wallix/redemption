...
//     };
//
//     PointerLoaderNew pl(1, CursorSize{32, 32}, Hotspot{8, 9}, {data_data, sizeof(data_data)}, {mask_data, sizeof(mask_data)}, 1, BGRPalette::classic_332(), true, BogusLinuxCursor::enable);
//
//     Pointer cursor(pl);
//
