...
#define RED_TEST_MODULE TestRDPSerializer
...
protected:
    virtual void flush_orders() override {}
    virtual void flush_bitmaps() override {}

    virtual void send_pointer(int cache_idx, const Pointer & cursor) override {
        (void)cache_idx;
        (void)cursor;
    }
    virtual void set_pointer(int cache_idx) override {
        (void)cache_idx;
    }
...
/* 0c70 */ "\x86\x31\xa7\x31\x87\x31\xa7\x31\x86\x31\xa7\x31\x87\x31\xa7\x31" // .1.1.1.1.1.1.1.1
    ...
    Bitmap bogus(16, 16, nullptr, 64, 25, ori_bmp_data, 3200);
    ...
    FakeSerializer serializer(stream_orders, stream_bitmaps, bpp,
