...
/* 0100 */ 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00,                                                              // ......
    ...
    auto answer_challenge_computed = ntlm_server.authenticate_next(negotiate);
    RED_CHECK(answer_challenge == answer_challenge_computed);
...
/* 01e0 */ 0xfb,
    ...
    auto server_authenticate_answer = ntlm_server.authenticate_next(authenticate);
    RED_CHECK(""_av == server_authenticate_answer);
...
//    RED_CHECK(false);
    ...
    auto auth_packet = ntlm_server.authenticate_next({});

    RED_CHECK(pubauthkey == auth_packet);
//
//    RED_CHECK_EQUAL(credssp::State::Cont, ntlm_server.state);
//
//    std::vector<uint8_t>  ts_credentials{
...
/* 00e0 */ 0x00, 0x77, 0x78, 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00,                                            // .wx......
    ...
    auto server_negotiate_answer = ntlm_server.authenticate_next(negotiate);
    RED_CHECK(answer_challenge == server_negotiate_answer);
    RED_CHECK_EQUAL(credssp::State::Cont, ntlm_server.state);
...
/* 0030 */ 0x8e, 0x80, 0xd4, 0x4f, 0xb6, 0x01, 0xb8, 0xd6, 0x74, 0xa8, 0x7f,                                // ...O....t..
    ...
    auto server_pubauthkey = ntlm_server.authenticate_next({});
    RED_CHECK(pubauthkey == server_pubauthkey);
