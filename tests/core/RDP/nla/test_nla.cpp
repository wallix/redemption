...
/* 0080 */ 0x2b, 0x2f, 0x03, 0xb5, 0x74, 0x5e, 0x35, 0x02, 0x03, 0x01, 0x00, 0x01,                          // +/..t^5.....
    ...
    ReplayTime timeobj({{1569842033, 895587}});
    std::string extra_message;
    rdpClientNTLM ntlm_client(user, domain, pass, host, "107.0.0.1", public_key, false, rand, timeobj, true);
...
RED_AUTO_TEST_CASE(TestNlaserver0)
{
    ...
    uint8_t host[] = "WIN10CGR";
    ReplayRandom rand(std::vector<uint8_t>({
        0x27, 0xd4, 0x5b, 0x32, 0xdb, 0xb4, 0x4d, 0xa8
    }));
    ReplayTime timeobj({{0x01d57780,0x24CA66C2}});
...
//"\x64\x00\x65\x00\x76\x00"d e v
//\x07\x00\x08\x00\xc2\x66\xca\x24\x80\x77\xd5\x01\x00\x00\x00\x00" //d.e.v......f.$.w !
...
//rdpproxy: INFO (19414/19414) -- ModuleManager::internal module 'Transition' loaded
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_NEXT
//rdpproxy: INFO (19414/19414) -- ----------> ACL next_module <--------
//rdpproxy: INFO (19414/19414) -- ===============> MODULE_SELECTOR
//rdpproxy: INFO (19414/19414) -- ----------> ACL new_mod <--------
//rdpproxy: INFO (19414/19414) -- target_module=MODULE_INTERNAL_WIDGET_SELECTOR(15)
//rdpproxy: INFO (19414/19414) -- ModuleManager::Creation of internal module 'selector'
//rdpproxy: WARNING (19414/19414) -- Unexpected receving 'end_time' - '-;-;-;-;-;-'
//rdpproxy: INFO (19414/19414) -- ModuleManager::internal module 'Transition' loaded
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_NEXT
//rdpproxy: INFO (19414/19414) -- ----------> ACL next_module <--------
//rdpproxy: INFO (19414/19414) -- ===============> WAIT WITH CURRENT MODULE
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_NEXT
//rdpproxy: INFO (19414/19414) -- ----------> ACL next_module <--------
//rdpproxy: INFO (19414/19414) -- ===============> WAIT WITH CURRENT MODULE
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_NEXT
...
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_NEXT
//rdpproxy: INFO (19414/19414) -- ----------> ACL next_module <--------
//rdpproxy: INFO (19414/19414) -- ===========> MODULE_RDP
//rdpproxy: INFO (19414/19414) -- ----------> ACL new_mod <--------
//rdpproxy: INFO (19414/19414) -- target_module=MODULE_RDP(2)
//rdpproxy: WARNING (19414/19414) -- AclSerializer::start_session_log: failed to extract date
//rdpproxy: INFO (19414/19414) -- ModuleManager::Creation of new mod 'RDP'
//rdpproxy: [rdpproxy] psid="156994835419414" user="u" type="TARGET_CONNECTION" target="Administrator@proxykdc.lab" host="10.10.44.217" port="3389"
//rdpproxy: INFO (19414/19414) -- connecting to 10.10.44.217:3389
//rdpproxy: INFO (19414/19414) -- connection to 10.10.44.217:3389 (10.10.44.217) succeeded : socket 7
//rdpproxy: INFO (19414/19414) -- SocketTransport: recv_timeout=1000
//rdpproxy: INFO (19414/19414) -- Remote RDP Server domain="" login="Administrator@proxykdc.lab" host="WIN10CGR"
//rdpproxy: INFO (19414/19414) -- RdpNego: TLS=Enabled NLA=Enabled adminMode=Disabled
//rdpproxy: INFO (19414/19414) -- Server key layout is 40c
//rdpproxy: INFO (19414/19414) -- ModuleManager::Creation of new mod 'RDP' suceeded
//rdpproxy: INFO (19414/19414) -- RdpNego::NEGO_STATE_INITIAL
//rdpproxy: INFO (19414/19414) -- RdpNego::send_x224_connection_request_pdu
//rdpproxy: INFO (19414/19414) -- Send cookie:
//rdpproxy: INFO (19414/19414) -- /* 0000 */ "\x43\x6f\x6f\x6b\x69\x65\x3a\x20\x6d\x73\x74\x73\x68\x61\x73\x68" // Cookie: mstshash
//rdpproxy: INFO (19414/19414) -- /* 0010 */ "\x3d\x41\x64\x6d\x69\x6e\x69\x73\x74\x72\x61\x74\x6f\x72\x40\x70" // =Administrator@p
//rdpproxy: INFO (19414/19414) -- /* 0020 */ "\x72\x6f\x78\x79\x6b\x64\x63\x2e\x6c\x61\x62\x0d\x0a"             // roxykdc.lab..
//rdpproxy: INFO (19414/19414) -- RdpNego::send_x224_connection_request_pdu done
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_next_data::Negociate
//rdpproxy: INFO (19414/19414) -- nego->state=RdpNego::NEGO_STATE_NEGOCIATE
//rdpproxy: INFO (19414/19414) -- RdpNego::NEGO_STATE_NLA
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_connection_confirm
//rdpproxy: INFO (19414/19414) -- NEG_RSP_TYPE=2 NEG_RSP_FLAGS=15 NEG_RSP_LENGTH=8 NEG_RSP_SELECTED_PROTOCOL=2
//rdpproxy: INFO (19414/19414) -- CC Recv: PROTOCOL HYBRID
//rdpproxy: INFO (19414/19414) -- activating TLS (HYBRID)
//rdpproxy: INFO (19414/19414) -- RdpNego::activate_ssl_hybrid
//rdpproxy: INFO (19414/19414) -- Client TLS start
//rdpproxy: INFO (19414/19414) -- SSL_connect()
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_next_data::SslHybrid
//rdpproxy: INFO (19414/19414) -- RdpNego::activate_ssl_hybrid
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_next_data::SslHybrid
//rdpproxy: INFO (19414/19414) -- RdpNego::activate_ssl_hybrid
//rdpproxy: INFO (19414/19414) -- SSL_get_peer_certificate()
//rdpproxy: INFO (19414/19414) -- certificate directory is: '/etc/rdpproxy/cert/0000'
//rdpproxy: INFO (19414/19414) -- certificate file is: '/etc/rdpproxy/cert/0000/rdp,10.10.44.217,3389,X509.pem'
//rdpproxy: INFO (19414/19414) -- nb1=1082 nb2=1082
//rdpproxy: INFO (19414/19414) -- TLS::X509 existing::issuer=CN = WINKDC2012.proxykdc.lab
//rdpproxy: INFO (19414/19414) -- TLS::X509 existing::subject=CN = WINKDC2012.proxykdc.lab
//rdpproxy: INFO (19414/19414) -- TLS::X509 existing::fingerprint=46:6f:7f:a9:bd:b9:30:2f:cf:d8:1b:ae:ee:98:2c:07:5e:c7:92:78
//rdpproxy: [RDP Session] session_id="SESSIONID-0000" client_ip="10.10.43.9" target_ip="10.10.44.217" user="u" device="win2k12" service="rdp" account="Administrator@proxykdc.lab" type="SERVER_CERTIFICATE_MATCH_SUCCESS" description="X.509 server certificate match"
//rdpproxy: [RDP Session] session_id="SESSIONID-0000" client_ip="10.10.43.9" target_ip="10.10.44.217" user="u" device="win2k12" service="rdp" account="Administrator@proxykdc.lab" type="CERTIFICATE_CHECK_SUCCESS" description="Connexion to server allowed"
//rdpproxy: INFO (19414/19414) -- TLS::X509::issuer=CN = WINKDC2012.proxykdc.lab
//rdpproxy: INFO (19414/19414) -- TLS::X509::subject=CN = WINKDC2012.proxykdc.lab
//rdpproxy: INFO (19414/19414) -- TLS::X509::fingerprint=46:6f:7f:a9:bd:b9:30:2f:cf:d8:1b:ae:ee:98:2c:07:5e:c7:92:78
//rdpproxy: INFO (19414/19414) -- TLSContext::X509_get_pubkey()
//rdpproxy: INFO (19414/19414) -- TLSContext::i2d_PublicKey()
//rdpproxy: INFO (19414/19414) -- Connected to target using TLS version TLSv1.2
//rdpproxy: INFO (19414/19414) -- SocketTransport::enable_client_tls() done
//rdpproxy: INFO (19414/19414) -- activating CREDSSP
//rdpproxy: INFO (19414/19414) -- rdpNTLMClient datas: (restricted_admin=false)
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x82, 0x01, 0x0a, 0x02, 0x82, 0x01, 0x01, 0x00, 0xdb, 0xf2, 0x21, 0x0a, 0x32, 0xac, 0x86,  // 0..........!.2..
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x04, 0x88, 0xf1, 0xcc, 0x21, 0xc6, 0x89, 0x66, 0x4b, 0x88, 0xa5, 0xac, 0x84, 0xc0, 0xae, 0x52,  // ....!..fK......R
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x6d, 0xfb, 0x4c, 0xf8, 0x3d, 0x5e, 0x51, 0xd5, 0x20, 0x8a, 0xc4, 0x6f, 0xe6, 0x68, 0x0e, 0x1b,  // m.L.=^Q. ..o.h..
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x1e, 0x19, 0xbd, 0x95, 0x23, 0x5f, 0x67, 0x65, 0x6a, 0x05, 0xe8, 0x19, 0xc6, 0x14, 0x52, 0x88,  // ....#_gej.....R.
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x3b, 0xde, 0x32, 0xbd, 0xd6, 0x85, 0x6a, 0x12, 0xf1, 0xbc, 0xd5, 0x65, 0xfc, 0x75, 0x04, 0xe2,  // ;.2...j....e.u..
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x78, 0x4a, 0x6f, 0x42, 0xd7, 0x2d, 0x5d, 0xb2, 0x38, 0x50, 0xac, 0xd4, 0x1e, 0x00, 0xf1, 0x0c,  // xJoB.-].8P......
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x5d, 0x4d, 0xc1, 0x95, 0x55, 0x17, 0x5a, 0xa4, 0x6a, 0xc3, 0x48, 0x93, 0x56, 0x3b, 0x08, 0x8c,  // ]M..U.Z.j.H.V;..
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x0a, 0x87, 0x12, 0x57, 0x97, 0x23, 0x42, 0x1d, 0x9a, 0xb8, 0x3f, 0xd8, 0x68, 0xb8, 0xa8, 0xba,  // ...W.#B...?.h...
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x16, 0x84, 0x38, 0xa6, 0xee, 0x88, 0x46, 0xfd, 0x0c, 0x7a, 0xdd, 0xcb, 0x72, 0x02, 0x6c, 0x84,  // ..8...F..z..r.l.
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0xfa, 0xef, 0xb6, 0x13, 0x8a, 0x6e, 0xf8, 0x71, 0x08, 0x39, 0xb1, 0x87, 0x08, 0xa0, 0xa7, 0x47,  // .....n.q.9.....G
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0x3e, 0x40, 0x0d, 0x73, 0xb6, 0xc9, 0x8c, 0xe1, 0x76, 0xff, 0xb4, 0xa0, 0x18, 0x22, 0x3f, 0x32,  // >@.s....v...."?2
//rdpproxy: INFO (19414/19414) -- /* 00b0 */ 0x5d, 0xcc, 0xc7, 0x47, 0x4c, 0x15, 0x65, 0x48, 0x1f, 0x6d, 0xdc, 0x57, 0xbe, 0xaf, 0x71, 0xb6,  // ]..GL.eH.m.W..q.
//rdpproxy: INFO (19414/19414) -- /* 00c0 */ 0x4e, 0xa5, 0x63, 0xff, 0x04, 0xc7, 0x57, 0x3d, 0x83, 0x53, 0xd9, 0xe3, 0x73, 0x30, 0xcb, 0x08,  // N.c...W=.S..s0..
//rdpproxy: INFO (19414/19414) -- /* 00d0 */ 0xec, 0x7e, 0x98, 0x1d, 0xb2, 0x8a, 0xe6, 0xf2, 0x97, 0xbc, 0xfd, 0x5f, 0xa7, 0xf0, 0xd4, 0x10,  // .~........._....
//rdpproxy: INFO (19414/19414) -- /* 00e0 */ 0x49, 0xbb, 0x7d, 0xfb, 0xfe, 0x52, 0xd0, 0x68, 0x41, 0x61, 0xf4, 0x82, 0xf4, 0x18, 0x4a, 0x05,  // I.}..R.hAa....J.
//rdpproxy: INFO (19414/19414) -- /* 00f0 */ 0xa4, 0xe4, 0xed, 0x69, 0x60, 0x27, 0x77, 0x97, 0x20, 0xa0, 0x22, 0x85, 0x8c, 0x91, 0x2e, 0xde,  // ...i`'w. .".....
//rdpproxy: INFO (19414/19414) -- /* 0100 */ 0x0c, 0xde, 0xba, 0xca, 0x0b, 0x9e, 0xba, 0x22, 0x6b, 0x02, 0x03, 0x01, 0x00, 0x01,              // ......."k.....
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x41, 0x00, 0x64, 0x00, 0x6d, 0x00, 0x69, 0x00, 0x6e, 0x00, 0x69, 0x00, 0x73, 0x00, 0x74, 0x00,  // A.d.m.i.n.i.s.t.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x72, 0x00, 0x61, 0x00, 0x74, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x40, 0x00, 0x70, 0x00, 0x72, 0x00,  // r.a.t.o.r.@.p.r.
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00,  // o.x.y.k.d.c...l.
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x61, 0x00, 0x62, 0x00,                                                                          // a.b.
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x53, 0x00, 0x65, 0x00, 0x63, 0x00, 0x75, 0x00, 0x72, 0x00, 0x65, 0x00, 0x4c, 0x00, 0x69, 0x00,  // S.e.c.u.r.e.L.i.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x6e, 0x00, 0x75, 0x00, 0x78, 0x00, 0x21, 0x00, 0x33, 0x00,                                      // n.u.x.!.3.
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x31, 0x00, 0x30, 0x00, 0x43, 0x00, 0x47, 0x00, 0x52, 0x00,  // W.I.N.1.0.C.G.R.
//rdpproxy: INFO (19414/19414) -- rdpNTLMClient datas done ==============
//rdpproxy: INFO (19414/19414) -- NTLM Authentication : Negotiate - sending Authentication Token
//rdpproxy: INFO (19414/19414) -- TSRequest hexdump ---------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest version 6 ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest negoTokens ------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x01, 0x00, 0x00, 0x00, 0xb7, 0x82, 0x08, 0xe2,  // NTLMSSP.........
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00,  // ....(.......(...
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x06, 0x01, 0xb1, 0x1d, 0x00, 0x00, 0x00, 0x0f,                                                  // ........
//rdpproxy: INFO (19414/19414) -- TSRequest authInfo --------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest pubkeyAuth ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest error_code 0 ---------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest clientNonce -----------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest ts_request_header --(request length = 55)-
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x37,                                                                                      // 07
//rdpproxy: INFO (19414/19414) -- TSRequest version_field ---------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa0, 0x03, 0x02, 0x01, 0x06,                                                                    // .....
//rdpproxy: INFO (19414/19414) -- TSRequest nego_tokens_header ----------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa1, 0x30, 0x30, 0x2e, 0x30, 0x2c, 0xa0, 0x2a, 0x04, 0x28,                                      // .00.0,.*.(
//rdpproxy: INFO (19414/19414) -- TSRequest auth_info_header ------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest pub_key_auth_header ---------------------
//rdpproxy: INFO (19414/19414) -- TSRequest error_code field ------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest nonce -----------------------------------
//rdpproxy: INFO (19414/19414) -- emit TSRequest full dump--------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x37, 0xa0, 0x03, 0x02, 0x01, 0x06, 0xa1, 0x30, 0x30, 0x2e, 0x30, 0x2c, 0xa0, 0x2a, 0x04,  // 07......00.0,.*.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x28, 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x01, 0x00, 0x00, 0x00, 0xb7, 0x82, 0x08,  // (NTLMSSP........
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0xe2, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00,  // .....(.......(..
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x00, 0x06, 0x01, 0xb1, 0x1d, 0x00, 0x00, 0x00, 0x0f,                                            // .........
//rdpproxy: INFO (19414/19414) -- emit TSRequest hexdump -DONE----------------------------
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_next_data::Credssp
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_credssp
//rdpproxy: INFO (19414/19414) -- Client Authentication : Receiving Authentication Token - Challenge
//rdpproxy: INFO (19414/19414) -- recv TSRequest full dump++++++++++++++++++++++++++++++++
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x81, 0xe6, 0xa0, 0x03, 0x02, 0x01, 0x06, 0xa1, 0x81, 0xde, 0x30, 0x81, 0xdb, 0x30, 0x81,  // 0..........0..0.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0xd8, 0xa0, 0x81, 0xd5, 0x04, 0x81, 0xd2, 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x02,  // .......NTLMSSP..
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x00, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x38, 0x00, 0x00, 0x00, 0x35, 0x82, 0x89, 0xe2, 0xab,  // .......8...5....
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0xb8, 0x4d, 0x26, 0xe0, 0x87, 0x11, 0x87, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8a,  // .M&.............
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x00, 0x8a, 0x00, 0x48, 0x00, 0x00, 0x00, 0x06, 0x03, 0x80, 0x25, 0x00, 0x00, 0x00, 0x0f, 0x50,  // ...H......%....P
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00, 0x02,  // .R.O.X.Y.K.D.C..
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x00, 0x10, 0x00, 0x50, 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44,  // ...P.R.O.X.Y.K.D
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x00, 0x43, 0x00, 0x01, 0x00, 0x14, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00, 0x44,  // .C.....W.I.N.K.D
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x04, 0x00, 0x18, 0x00, 0x70,  // .C.2.0.1.2.....p
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e,  // .r.o.x.y.k.d.c..
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x03, 0x00, 0x2e, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e,  // .l.a.b.....W.I.N
//rdpproxy: INFO (19414/19414) -- /* 00b0 */ 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x2e,  // .K.D.C.2.0.1.2..
//rdpproxy: INFO (19414/19414) -- /* 00c0 */ 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63,  // .p.r.o.x.y.k.d.c
//rdpproxy: INFO (19414/19414) -- /* 00d0 */ 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x07, 0x00, 0x08, 0x00, 0x9e, 0xe6, 0x5f,  // ...l.a.b......._
//rdpproxy: INFO (19414/19414) -- /* 00e0 */ 0xc2, 0x77, 0x78, 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00,                                            // .wx......
//rdpproxy: INFO (19414/19414) -- recv TSRequest hexdump - START PARSING DATA+++++++++++++
//rdpproxy: INFO (19414/19414) -- Credssp recvTSRequest() Remote Version 6, Negotiated version 6
//rdpproxy: INFO (19414/19414) -- Target Name (56 16)
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x50, 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00,  // P.R.O.X.Y.K.D.C.
//rdpproxy: INFO (19414/19414) -- Target Info (72 138)
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x02, 0x00, 0x10, 0x00, 0x50, 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00,  // ....P.R.O.X.Y.K.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x44, 0x00, 0x43, 0x00, 0x01, 0x00, 0x14, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00,  // D.C.....W.I.N.K.
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x04, 0x00, 0x18, 0x00,  // D.C.2.0.1.2.....
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00,  // p.r.o.x.y.k.d.c.
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x03, 0x00, 0x2e, 0x00, 0x57, 0x00, 0x49, 0x00,  // ..l.a.b.....W.I.
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x4e, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00,  // N.K.D.C.2.0.1.2.
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x2e, 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00,  // ..p.r.o.x.y.k.d.
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x07, 0x00, 0x08, 0x00, 0x9e, 0xe6,  // c...l.a.b.......
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x5f, 0xc2, 0x77, 0x78, 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00,                                      // _.wx......
//rdpproxy: INFO (19414/19414) -- NTLMContextClient Compute response from challenge
//rdpproxy: INFO (19414/19414) -- using /dev/urandom as random source
//rdpproxy: INFO (19414/19414) -- Time Stamp (1569948384, 939173)
//rdpproxy: INFO (19414/19414) -- Client Random Challenge {0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5}
//rdpproxy: INFO (19414/19414) -- NTLMContextClient Compute response: SessionBaseKey
//rdpproxy: INFO (19414/19414) -- using /dev/urandom as random source
//rdpproxy: INFO (19414/19414) -- Random ExportedSessionKey
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xd5, 0x3d, 0xb7, 0x01, 0x08, 0x23, 0x6c, 0x84, 0x00, 0xf0, 0xe6, 0x34, 0x6a, 0xf6, 0xc7, 0x49,  // .=...#l....4j..I
//rdpproxy: INFO (19414/19414) -- Field LmChallengeResponse, len: 24
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xe3, 0x52, 0x51, 0x84, 0xf5, 0xc3, 0x5e, 0x23, 0x47, 0xde, 0x7d, 0x3a, 0x52, 0x0e, 0xa1, 0x38,  // .RQ...^#G.}:R..8
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5,                                                  // .R.D.s..
//rdpproxy: INFO (19414/19414) -- Field NtChallengeResponse, len: 186
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x71, 0x93, 0xa7, 0xd1, 0x9d, 0x3d, 0x65, 0x05, 0xa0, 0x9e, 0x84, 0x35, 0xda, 0x31, 0xbe, 0x6e,  // q....=e....5.1.n
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa5, 0x54, 0x0e, 0x00, 0xe0, 0x82, 0x93, 0x5d,  // .........T.....]
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x10, 0x00,  // .R.D.s..........
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x50, 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00,  // P.R.O.X.Y.K.D.C.
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x01, 0x00, 0x14, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00,  // ....W.I.N.K.D.C.
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x04, 0x00, 0x18, 0x00, 0x70, 0x00, 0x72, 0x00,  // 2.0.1.2.....p.r.
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00,  // o.x.y.k.d.c...l.
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x61, 0x00, 0x62, 0x00, 0x03, 0x00, 0x2e, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00,  // a.b.....W.I.N.K.
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x2e, 0x00, 0x70, 0x00,  // D.C.2.0.1.2...p.
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00,  // r.o.x.y.k.d.c...
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x07, 0x00, 0x08, 0x00, 0x9e, 0xe6, 0x5f, 0xc2, 0x77, 0x78,  // l.a.b......._.wx
//rdpproxy: INFO (19414/19414) -- /* 00b0 */ 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,                                      // ..........
//rdpproxy: INFO (19414/19414) -- Field DomainName, len: 0
//rdpproxy: INFO (19414/19414) -- Field UserName, len: 52
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x41, 0x00, 0x64, 0x00, 0x6d, 0x00, 0x69, 0x00, 0x6e, 0x00, 0x69, 0x00, 0x73, 0x00, 0x74, 0x00,  // A.d.m.i.n.i.s.t.
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x72, 0x00, 0x61, 0x00, 0x74, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x40, 0x00, 0x70, 0x00, 0x72, 0x00,  // r.a.t.o.r.@.p.r.
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00,  // o.x.y.k.d.c...l.
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x61, 0x00, 0x62, 0x00,                                                                          // a.b.
//rdpproxy: INFO (19414/19414) -- Field Workstation, len: 16
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x31, 0x00, 0x30, 0x00, 0x43, 0x00, 0x47, 0x00, 0x52, 0x00,  // W.I.N.1.0.C.G.R.
//rdpproxy: INFO (19414/19414) -- Field EncryptedRandomSessionKey, len: 16
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xd6, 0xdc, 0x86, 0xeb, 0xb2, 0x6d, 0x59, 0xf5, 0x57, 0xbb, 0x5b, 0x53, 0xb2, 0x96, 0x10, 0x3e,  // .....mY.W.[S...>
//rdpproxy: INFO (19414/19414) -- negotiateFlags "0xE288A235"{
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_56, // (31)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_KEY_EXCH, // (30)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_128, // (29)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_VERSION, // (25)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_TARGET_INFO, // (23)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_EXTENDED_SESSION_SECURITY, // (19)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_ALWAYS_SIGN, // (15)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_WORKSTATION_SUPPLIED, // (13)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_NTLM, // (9)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_SEAL, // (5)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_SIGN, // (4)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_REQUEST_TARGET, // (2)
//rdpproxy: INFO (19414/19414) --     |NTLMSSP_NEGOTIATE_UNICODE, // (0)
//rdpproxy: INFO (19414/19414) -- }
//rdpproxy: INFO (19414/19414) -- VERSION = {
//rdpproxy: INFO (19414/19414) -- 	ProductMajorVersion: 6
//rdpproxy: INFO (19414/19414) -- 	ProductMinorVersion: 1
//rdpproxy: INFO (19414/19414) -- 	ProductBuild: 7601
//rdpproxy: INFO (19414/19414) -- 	NTLMRevisionCurrent: 0x0F
//rdpproxy: INFO (19414/19414) -- }
//rdpproxy: INFO (19414/19414) -- Field MIC, len: 16
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x83, 0x19, 0x3c, 0x16, 0x65, 0x3f, 0xf0, 0xf3, 0x68, 0xd1, 0x87, 0xd7, 0x43, 0xb0, 0xde, 0x3e,  // ..<.e?..h...C..>
//rdpproxy: INFO (19414/19414) -- Full NTLMAuthenticate Dump, len: 382
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x03, 0x00, 0x00, 0x00, 0x18, 0x00, 0x18, 0x00,  // NTLMSSP.........
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x58, 0x00, 0x00, 0x00, 0xba, 0x00, 0xba, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // X.......p.......
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x2a, 0x01, 0x00, 0x00, 0x34, 0x00, 0x34, 0x00, 0x2a, 0x01, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00,  // *...4.4.*.......
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x5e, 0x01, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x6e, 0x01, 0x00, 0x00, 0x35, 0xa2, 0x88, 0xe2,  // ^.......n...5...
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x06, 0x01, 0xb1, 0x1d, 0x00, 0x00, 0x00, 0x0f, 0x83, 0x19, 0x3c, 0x16, 0x65, 0x3f, 0xf0, 0xf3,  // ..........<.e?..
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x68, 0xd1, 0x87, 0xd7, 0x43, 0xb0, 0xde, 0x3e, 0xe3, 0x52, 0x51, 0x84, 0xf5, 0xc3, 0x5e, 0x23,  // h...C..>.RQ...^#
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x47, 0xde, 0x7d, 0x3a, 0x52, 0x0e, 0xa1, 0x38, 0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5,  // G.}:R..8.R.D.s..
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x71, 0x93, 0xa7, 0xd1, 0x9d, 0x3d, 0x65, 0x05, 0xa0, 0x9e, 0x84, 0x35, 0xda, 0x31, 0xbe, 0x6e,  // q....=e....5.1.n
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa5, 0x54, 0x0e, 0x00, 0xe0, 0x82, 0x93, 0x5d,  // .........T.....]
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x10, 0x00,  // .R.D.s..........
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0x50, 0x00, 0x52, 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00,  // P.R.O.X.Y.K.D.C.
//rdpproxy: INFO (19414/19414) -- /* 00b0 */ 0x01, 0x00, 0x14, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00,  // ....W.I.N.K.D.C.
//rdpproxy: INFO (19414/19414) -- /* 00c0 */ 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x04, 0x00, 0x18, 0x00, 0x70, 0x00, 0x72, 0x00,  // 2.0.1.2.....p.r.
//rdpproxy: INFO (19414/19414) -- /* 00d0 */ 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00,  // o.x.y.k.d.c...l.
//rdpproxy: INFO (19414/19414) -- /* 00e0 */ 0x61, 0x00, 0x62, 0x00, 0x03, 0x00, 0x2e, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00,  // a.b.....W.I.N.K.
//rdpproxy: INFO (19414/19414) -- /* 00f0 */ 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x2e, 0x00, 0x70, 0x00,  // D.C.2.0.1.2...p.
//rdpproxy: INFO (19414/19414) -- /* 0100 */ 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00,  // r.o.x.y.k.d.c...
//rdpproxy: INFO (19414/19414) -- /* 0110 */ 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x07, 0x00, 0x08, 0x00, 0x9e, 0xe6, 0x5f, 0xc2, 0x77, 0x78,  // l.a.b......._.wx
//rdpproxy: INFO (19414/19414) -- /* 0120 */ 0xd5, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x00, 0x64, 0x00, 0x6d, 0x00,  // ..........A.d.m.
//rdpproxy: INFO (19414/19414) -- /* 0130 */ 0x69, 0x00, 0x6e, 0x00, 0x69, 0x00, 0x73, 0x00, 0x74, 0x00, 0x72, 0x00, 0x61, 0x00, 0x74, 0x00,  // i.n.i.s.t.r.a.t.
//rdpproxy: INFO (19414/19414) -- /* 0140 */ 0x6f, 0x00, 0x72, 0x00, 0x40, 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00,  // o.r.@.p.r.o.x.y.
//rdpproxy: INFO (19414/19414) -- /* 0150 */ 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x57, 0x00,  // k.d.c...l.a.b.W.
//rdpproxy: INFO (19414/19414) -- /* 0160 */ 0x49, 0x00, 0x4e, 0x00, 0x31, 0x00, 0x30, 0x00, 0x43, 0x00, 0x47, 0x00, 0x52, 0x00, 0xd6, 0xdc,  // I.N.1.0.C.G.R...
//rdpproxy: INFO (19414/19414) -- /* 0170 */ 0x86, 0xeb, 0xb2, 0x6d, 0x59, 0xf5, 0x57, 0xbb, 0x5b, 0x53, 0xb2, 0x96, 0x10, 0x3e,              // ...mY.W.[S...>
//rdpproxy: INFO (19414/19414) -- rdpClientNTLM::encrypt_public_key_echo
//rdpproxy: INFO (19414/19414) -- using /dev/urandom as random source
//rdpproxy: INFO (19414/19414) -- Random Client Nonce
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4c, 0x55, 0x31, 0xef, 0xf8, 0xd7, 0xeb, 0x7b, 0xd5, 0x1e, 0xe8, 0x58, 0x3f, 0xc6, 0x7b, 0x69,  // LU1....{...X?.{i
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x9f, 0x31, 0xbb, 0xc8, 0xea, 0x3c, 0x9c, 0x92, 0x9a, 0xe2, 0x6b, 0x70, 0xaa, 0xb8, 0x0d, 0x3e,  // .1...<....kp...>
//rdpproxy: INFO (19414/19414) -- TSRequest hexdump ---------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest version 6 ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest negoTokens ------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x03, 0x00, 0x00, 0x00, 0x18, 0x00, 0x18, 0x00,  // NTLMSSP.........
...
//rdpproxy: INFO (19414/19414) -- TSRequest authInfo --------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest pubkeyAuth ------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x01, 0x00, 0x00, 0x00, 0xd7, 0x3e, 0x43, 0x0d, 0xc7, 0x31, 0xf3, 0xf9, 0x00, 0x00, 0x00, 0x00,  // .....>C..1......
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x75, 0x81, 0xcb, 0x4b, 0xfd, 0xe1, 0x0f, 0x85, 0x98, 0x59, 0x33, 0x47, 0x2a, 0x1b, 0x60, 0xc6,  // u..K.....Y3G*.`.
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x24, 0x84, 0xca, 0x98, 0x54, 0xcb, 0x08, 0x9a, 0x94, 0x88, 0xb8, 0x81, 0xcf, 0x27, 0x9b, 0x53,  // $...T........'.S
//rdpproxy: INFO (19414/19414) -- TSRequest error_code 0 ---------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest clientNonce -----------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4c, 0x55, 0x31, 0xef, 0xf8, 0xd7, 0xeb, 0x7b, 0xd5, 0x1e, 0xe8, 0x58, 0x3f, 0xc6, 0x7b, 0x69,  // LU1....{...X?.{i
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x9f, 0x31, 0xbb, 0xc8, 0xea, 0x3c, 0x9c, 0x92, 0x9a, 0xe2, 0x6b, 0x70, 0xaa, 0xb8, 0x0d, 0x3e,  // .1...<....kp...>
//rdpproxy: INFO (19414/19414) -- TSRequest ts_request_header --(request length = 495)-
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x82, 0x01, 0xef,                                                                          // 0...
//rdpproxy: INFO (19414/19414) -- TSRequest version_field ---------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa0, 0x03, 0x02, 0x01, 0x06,                                                                    // .....
//rdpproxy: INFO (19414/19414) -- TSRequest nego_tokens_header ----------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa1, 0x82, 0x01, 0x8e, 0x30, 0x82, 0x01, 0x8a, 0x30, 0x82, 0x01, 0x86, 0xa0, 0x82, 0x01, 0x82,  // ....0...0.......
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x04, 0x82, 0x01, 0x7e,                                                                          // ...~
//rdpproxy: INFO (19414/19414) -- TSRequest auth_info_header ------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest pub_key_auth_header ---------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa3, 0x32, 0x04, 0x30,                                                                          // .2.0
//rdpproxy: INFO (19414/19414) -- TSRequest error_code field ------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest nonce -----------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa5, 0x22, 0x04, 0x20,                                                                          // .". 
//rdpproxy: INFO (19414/19414) -- emit TSRequest full dump--------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x82, 0x01, 0xef, 0xa0, 0x03, 0x02, 0x01, 0x06, 0xa1, 0x82, 0x01, 0x8e, 0x30, 0x82, 0x01,  // 0............0..
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x8a, 0x30, 0x82, 0x01, 0x86, 0xa0, 0x82, 0x01, 0x82, 0x04, 0x82, 0x01, 0x7e, 0x4e, 0x54, 0x4c,  // .0..........~NTL
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x4d, 0x53, 0x53, 0x50, 0x00, 0x03, 0x00, 0x00, 0x00, 0x18, 0x00, 0x18, 0x00, 0x58, 0x00, 0x00,  // MSSP.........X..
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x00, 0xba, 0x00, 0xba, 0x00, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2a, 0x01, 0x00,  // .....p.......*..
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x00, 0x34, 0x00, 0x34, 0x00, 0x2a, 0x01, 0x00, 0x00, 0x10, 0x00, 0x10, 0x00, 0x5e, 0x01, 0x00,  // .4.4.*.......^..
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x00, 0x10, 0x00, 0x10, 0x00, 0x6e, 0x01, 0x00, 0x00, 0x35, 0xa2, 0x88, 0xe2, 0x06, 0x01, 0xb1,  // .....n...5......
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x1d, 0x00, 0x00, 0x00, 0x0f, 0x83, 0x19, 0x3c, 0x16, 0x65, 0x3f, 0xf0, 0xf3, 0x68, 0xd1, 0x87,  // .......<.e?..h..
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0xd7, 0x43, 0xb0, 0xde, 0x3e, 0xe3, 0x52, 0x51, 0x84, 0xf5, 0xc3, 0x5e, 0x23, 0x47, 0xde, 0x7d,  // .C..>.RQ...^#G.}
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0x3a, 0x52, 0x0e, 0xa1, 0x38, 0xaa, 0x52, 0xcc, 0x44, 0xe5, 0x73, 0x04, 0xb5, 0x71, 0x93, 0xa7,  // :R..8.R.D.s..q..
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0xd1, 0x9d, 0x3d, 0x65, 0x05, 0xa0, 0x9e, 0x84, 0x35, 0xda, 0x31, 0xbe, 0x6e, 0x01, 0x01, 0x00,  // ..=e....5.1.n...
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0xa5, 0x54, 0x0e, 0x00, 0xe0, 0x82, 0x93, 0x5d, 0xaa, 0x52, 0xcc,  // ......T.....].R.
//rdpproxy: INFO (19414/19414) -- /* 00b0 */ 0x44, 0xe5, 0x73, 0x04, 0xb5, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x10, 0x00, 0x50, 0x00, 0x52,  // D.s..........P.R
//rdpproxy: INFO (19414/19414) -- /* 00c0 */ 0x00, 0x4f, 0x00, 0x58, 0x00, 0x59, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00, 0x01, 0x00, 0x14,  // .O.X.Y.K.D.C....
//rdpproxy: INFO (19414/19414) -- /* 00d0 */ 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43, 0x00, 0x32, 0x00, 0x30,  // .W.I.N.K.D.C.2.0
//rdpproxy: INFO (19414/19414) -- /* 00e0 */ 0x00, 0x31, 0x00, 0x32, 0x00, 0x04, 0x00, 0x18, 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78,  // .1.2.....p.r.o.x
//rdpproxy: INFO (19414/19414) -- /* 00f0 */ 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62,  // .y.k.d.c...l.a.b
//rdpproxy: INFO (19414/19414) -- /* 0100 */ 0x00, 0x03, 0x00, 0x2e, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e, 0x00, 0x4b, 0x00, 0x44, 0x00, 0x43,  // .....W.I.N.K.D.C
//rdpproxy: INFO (19414/19414) -- /* 0110 */ 0x00, 0x32, 0x00, 0x30, 0x00, 0x31, 0x00, 0x32, 0x00, 0x2e, 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f,  // .2.0.1.2...p.r.o
//rdpproxy: INFO (19414/19414) -- /* 0120 */ 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64, 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61,  // .x.y.k.d.c...l.a
//rdpproxy: INFO (19414/19414) -- /* 0130 */ 0x00, 0x62, 0x00, 0x07, 0x00, 0x08, 0x00, 0x9e, 0xe6, 0x5f, 0xc2, 0x77, 0x78, 0xd5, 0x01, 0x00,  // .b......._.wx...
//rdpproxy: INFO (19414/19414) -- /* 0140 */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x00, 0x64, 0x00, 0x6d, 0x00, 0x69, 0x00, 0x6e,  // .......A.d.m.i.n
//rdpproxy: INFO (19414/19414) -- /* 0150 */ 0x00, 0x69, 0x00, 0x73, 0x00, 0x74, 0x00, 0x72, 0x00, 0x61, 0x00, 0x74, 0x00, 0x6f, 0x00, 0x72,  // .i.s.t.r.a.t.o.r
//rdpproxy: INFO (19414/19414) -- /* 0160 */ 0x00, 0x40, 0x00, 0x70, 0x00, 0x72, 0x00, 0x6f, 0x00, 0x78, 0x00, 0x79, 0x00, 0x6b, 0x00, 0x64,  // .@.p.r.o.x.y.k.d
//rdpproxy: INFO (19414/19414) -- /* 0170 */ 0x00, 0x63, 0x00, 0x2e, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x62, 0x00, 0x57, 0x00, 0x49, 0x00, 0x4e,  // .c...l.a.b.W.I.N
//rdpproxy: INFO (19414/19414) -- /* 0180 */ 0x00, 0x31, 0x00, 0x30, 0x00, 0x43, 0x00, 0x47, 0x00, 0x52, 0x00, 0xd6, 0xdc, 0x86, 0xeb, 0xb2,  // .1.0.C.G.R......
//rdpproxy: INFO (19414/19414) -- /* 0190 */ 0x6d, 0x59, 0xf5, 0x57, 0xbb, 0x5b, 0x53, 0xb2, 0x96, 0x10, 0x3e, 0xa3, 0x32, 0x04, 0x30, 0x01,  // mY.W.[S...>.2.0.
//rdpproxy: INFO (19414/19414) -- /* 01a0 */ 0x00, 0x00, 0x00, 0xd7, 0x3e, 0x43, 0x0d, 0xc7, 0x31, 0xf3, 0xf9, 0x00, 0x00, 0x00, 0x00, 0x75,  // ....>C..1......u
//rdpproxy: INFO (19414/19414) -- /* 01b0 */ 0x81, 0xcb, 0x4b, 0xfd, 0xe1, 0x0f, 0x85, 0x98, 0x59, 0x33, 0x47, 0x2a, 0x1b, 0x60, 0xc6, 0x24,  // ..K.....Y3G*.`.$
//rdpproxy: INFO (19414/19414) -- /* 01c0 */ 0x84, 0xca, 0x98, 0x54, 0xcb, 0x08, 0x9a, 0x94, 0x88, 0xb8, 0x81, 0xcf, 0x27, 0x9b, 0x53, 0xa5,  // ...T........'.S.
//rdpproxy: INFO (19414/19414) -- /* 01d0 */ 0x22, 0x04, 0x20, 0x4c, 0x55, 0x31, 0xef, 0xf8, 0xd7, 0xeb, 0x7b, 0xd5, 0x1e, 0xe8, 0x58, 0x3f,  // ". LU1....{...X?
//rdpproxy: INFO (19414/19414) -- /* 01e0 */ 0xc6, 0x7b, 0x69, 0x9f, 0x31, 0xbb, 0xc8, 0xea, 0x3c, 0x9c, 0x92, 0x9a, 0xe2, 0x6b, 0x70, 0xaa,  // .{i.1...<....kp.
//rdpproxy: INFO (19414/19414) -- /* 01f0 */ 0xb8, 0x0d, 0x3e,                                                                                // ..>
//rdpproxy: INFO (19414/19414) -- emit TSRequest hexdump -DONE----------------------------
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_next_data::Credssp
//rdpproxy: INFO (19414/19414) -- RdpNego::recv_credssp
//rdpproxy: INFO (19414/19414) -- Client Authentication : Receiving Encrypted PubKey + 1
//rdpproxy: INFO (19414/19414) -- recv TSRequest full dump++++++++++++++++++++++++++++++++
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x39, 0xa0, 0x03, 0x02, 0x01, 0x06, 0xa3, 0x32, 0x04, 0x30, 0x01, 0x00, 0x00, 0x00, 0xec,  // 09......2.0.....
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x9d, 0xe0, 0xd7, 0xdd, 0xfb, 0xa6, 0xa8, 0x00, 0x00, 0x00, 0x00, 0x37, 0x51, 0x1a, 0x07, 0xf0,  // ...........7Q...
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x3a, 0xab, 0x45, 0x8f, 0x29, 0x0f, 0x2b, 0x25, 0xbf, 0x91, 0x39, 0x02, 0x48, 0x4a, 0xf1, 0x46,  // :.E.).+%..9.HJ.F
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x7f, 0x11, 0x87, 0x7e, 0x64, 0xe9, 0x78, 0xec, 0x2c, 0x20, 0x7d,                                // ...~d.x., }
//rdpproxy: INFO (19414/19414) -- recv TSRequest hexdump - START PARSING DATA+++++++++++++
//rdpproxy: INFO (19414/19414) -- Credssp recvTSRequest() Remote Version 6, Negotiated version 6
//rdpproxy: INFO (19414/19414) -- rdpClientNTLM::encrypt_ts_credentials
//rdpproxy: INFO (19414/19414) -- TSCredentialsPassword: Domain User Password
//rdpproxy: INFO (19414/19414) -- TSRequest hexdump ---------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest version 6 ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest negoTokens ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest authInfo --------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x01, 0x00, 0x00, 0x00, 0x05, 0x8b, 0x82, 0x0b, 0xc2, 0xd0, 0x8a, 0x3b, 0x01, 0x00, 0x00, 0x00,  // ...........;....
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x71, 0x09, 0xce, 0x7f, 0x07, 0xbc, 0x61, 0x05, 0x14, 0xa2, 0xbe, 0x9e, 0x96, 0x5b, 0xd5, 0x2e,  // q.....a......[..
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0xf5, 0xdb, 0x43, 0xa4, 0x55, 0xe9, 0x58, 0x62, 0x39, 0x5b, 0x3c, 0xfe, 0xe4, 0xe7, 0x7d, 0xc0,  // ..C.U.Xb9[<...}.
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x7a, 0x70, 0x85, 0x93, 0x79, 0x64, 0xa5, 0x18, 0x52, 0xb8, 0x45, 0xd7, 0x0c, 0x4a, 0xc2, 0xd8,  // zp..yd..R.E..J..
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x3a, 0x80, 0xc8, 0xaf, 0xf8, 0x61, 0xd4, 0xf9, 0xf0, 0x13, 0xc8, 0xf0, 0x06, 0x15, 0x6e, 0x67,  // :....a........ng
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0x7f, 0x7b, 0xb5, 0xdc, 0x40, 0xd2, 0x13, 0x4c, 0x5e, 0x5f, 0x03, 0xfe, 0x4c, 0xe9, 0x7e, 0x47,  // .{..@..L^_..L.~G
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0xbe, 0xa9, 0xd8, 0xba, 0x3e, 0x46, 0x1f, 0xcb, 0x4d, 0xc1, 0xde, 0x45, 0x29, 0x38, 0xfb, 0xd2,  // ....>F..M..E)8..
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x82, 0x50, 0x2c, 0x51, 0xc1, 0x29, 0x57,                                                        // .P,Q.)W
//rdpproxy: INFO (19414/19414) -- TSRequest pubkeyAuth ------------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest error_code 0 ---------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest clientNonce -----------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x4c, 0x55, 0x31, 0xef, 0xf8, 0xd7, 0xeb, 0x7b, 0xd5, 0x1e, 0xe8, 0x58, 0x3f, 0xc6, 0x7b, 0x69,  // LU1....{...X?.{i
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x9f, 0x31, 0xbb, 0xc8, 0xea, 0x3c, 0x9c, 0x92, 0x9a, 0xe2, 0x6b, 0x70, 0xaa, 0xb8, 0x0d, 0x3e,  // .1...<....kp...>
//rdpproxy: INFO (19414/19414) -- TSRequest ts_request_header --(request length = 164)-
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x81, 0xa4,                                                                                // 0..
//rdpproxy: INFO (19414/19414) -- TSRequest version_field ---------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa0, 0x03, 0x02, 0x01, 0x06,                                                                    // .....
//rdpproxy: INFO (19414/19414) -- TSRequest nego_tokens_header ----------------------
//rdpproxy: INFO (19414/19414) -- TSRequest auth_info_header ------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa2, 0x79, 0x04, 0x77,                                                                          // .y.w
//rdpproxy: INFO (19414/19414) -- TSRequest pub_key_auth_header ---------------------
//rdpproxy: INFO (19414/19414) -- TSRequest error_code field ------------------------
//rdpproxy: INFO (19414/19414) -- TSRequest nonce -----------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xa5, 0x22, 0x04, 0x20,                                                                          // .". 
//rdpproxy: INFO (19414/19414) -- emit TSRequest full dump--------------------------------
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0x30, 0x81, 0xa4, 0xa0, 0x03, 0x02, 0x01, 0x06, 0xa2, 0x79, 0x04, 0x77, 0x01, 0x00, 0x00, 0x00,  // 0........y.w....
//rdpproxy: INFO (19414/19414) -- /* 0010 */ 0x05, 0x8b, 0x82, 0x0b, 0xc2, 0xd0, 0x8a, 0x3b, 0x01, 0x00, 0x00, 0x00, 0x71, 0x09, 0xce, 0x7f,  // .......;....q...
//rdpproxy: INFO (19414/19414) -- /* 0020 */ 0x07, 0xbc, 0x61, 0x05, 0x14, 0xa2, 0xbe, 0x9e, 0x96, 0x5b, 0xd5, 0x2e, 0xf5, 0xdb, 0x43, 0xa4,  // ..a......[....C.
//rdpproxy: INFO (19414/19414) -- /* 0030 */ 0x55, 0xe9, 0x58, 0x62, 0x39, 0x5b, 0x3c, 0xfe, 0xe4, 0xe7, 0x7d, 0xc0, 0x7a, 0x70, 0x85, 0x93,  // U.Xb9[<...}.zp..
//rdpproxy: INFO (19414/19414) -- /* 0040 */ 0x79, 0x64, 0xa5, 0x18, 0x52, 0xb8, 0x45, 0xd7, 0x0c, 0x4a, 0xc2, 0xd8, 0x3a, 0x80, 0xc8, 0xaf,  // yd..R.E..J..:...
//rdpproxy: INFO (19414/19414) -- /* 0050 */ 0xf8, 0x61, 0xd4, 0xf9, 0xf0, 0x13, 0xc8, 0xf0, 0x06, 0x15, 0x6e, 0x67, 0x7f, 0x7b, 0xb5, 0xdc,  // .a........ng.{..
//rdpproxy: INFO (19414/19414) -- /* 0060 */ 0x40, 0xd2, 0x13, 0x4c, 0x5e, 0x5f, 0x03, 0xfe, 0x4c, 0xe9, 0x7e, 0x47, 0xbe, 0xa9, 0xd8, 0xba,  // @..L^_..L.~G....
//rdpproxy: INFO (19414/19414) -- /* 0070 */ 0x3e, 0x46, 0x1f, 0xcb, 0x4d, 0xc1, 0xde, 0x45, 0x29, 0x38, 0xfb, 0xd2, 0x82, 0x50, 0x2c, 0x51,  // >F..M..E)8...P,Q
//rdpproxy: INFO (19414/19414) -- /* 0080 */ 0xc1, 0x29, 0x57, 0xa5, 0x22, 0x04, 0x20, 0x4c, 0x55, 0x31, 0xef, 0xf8, 0xd7, 0xeb, 0x7b, 0xd5,  // .)W.". LU1....{.
//rdpproxy: INFO (19414/19414) -- /* 0090 */ 0x1e, 0xe8, 0x58, 0x3f, 0xc6, 0x7b, 0x69, 0x9f, 0x31, 0xbb, 0xc8, 0xea, 0x3c, 0x9c, 0x92, 0x9a,  // ..X?.{i.1...<...
//rdpproxy: INFO (19414/19414) -- /* 00a0 */ 0xe2, 0x6b, 0x70, 0xaa, 0xb8, 0x0d, 0x3e,                                                        // .kp...>
//rdpproxy: INFO (19414/19414) -- emit TSRequest hexdump -DONE----------------------------
//rdpproxy: INFO (19414/19414) -- CS_Cluster: Server Redirection Supported
//rdpproxy: INFO (19414/19414) -- GCC::UserData tag=0c01 length=16
//rdpproxy: INFO (19414/19414) -- GCC::UserData tag=0c03 length=16
//rdpproxy: INFO (19414/19414) -- GCC::UserData tag=0c02 length=12
//rdpproxy: INFO (19414/19414) -- =================== SC_SECURITY =============
//rdpproxy: INFO (19414/19414) -- No encryption
//rdpproxy: INFO (19414/19414) -- send extended login info (RDP5-style) 107fb :Administrator@proxykdc.lab
//rdpproxy: INFO (19414/19414) -- Rdp::Get license: username="Administrator@proxykdc.lab"
//rdpproxy: INFO (19414/19414) -- RdpNegociation::get_license LIC::RecvFactory::flic.tag=255
//rdpproxy: INFO (19414/19414) -- /* 0000 */ 0xff, 0x03, 0x10, 0x00, 0x07, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,  // ................
//rdpproxy: INFO (19414/19414) -- use rdp5
//rdpproxy: INFO (19414/19414) -- mod_rdp::send_input_fastpath: Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- Rdp::receiving the server-to-client Monitor Layout PDU MonitorLayoutPDU monitorCount=1 ((left=0, top=0, right=1919, bottom=1079, primary=yes(0x1)))
//rdpproxy: INFO (19414/19414) -- Resizing to 1920x1080x16
...
//rdpproxy: INFO (19414/19414) -- mod_rdp::send_input_fastpath: Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- Front::can_be_start_capture: Capture is not necessary
//rdpproxy: INFO (19414/19414) -- recv_tls WANT READ
//rdpproxy: INFO (19414/19414) -- process save session info : Logon extended info
//rdpproxy: INFO (19414/19414) -- process save session info : Logon Errors Info
//rdpproxy: INFO (19414/19414) -- ErrorNotificationType=LOGON_MSG_SESSION_CONTINUE(0xFFFFFFFE) "The logon process is continuing." SessionIdentifier=2
//rdpproxy: INFO (19414/19414) -- process save session info : Logon long
//rdpproxy: INFO (19414/19414) -- Logon Info Version 2 (data): Domain="PROXYKDC" UserName="Administrator" SessionId=2
//rdpproxy: INFO (19414/19414) -- process save session info : Logon extended info
//rdpproxy: INFO (19414/19414) -- process save session info : Auto-reconnect cookie
//rdpproxy: INFO (19414/19414) -- ServerAutoReconnectPacket: Version=1 LogonId=2
//rdpproxy: INFO (19414/19414) -- 0000 93 bc b4 66 33 bf 5b 17 c6 15 df 05 5a 49 2c 14  ...f3.[.....ZI,.
//rdpproxy: INFO (19414/19414) -- Front::incoming: (Fast-Path) Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- mod_rdp::send_input_fastpath: Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- Front::incoming: (Fast-Path) Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- mod_rdp::send_input_fastpath: Synchronize Event toggleFlags=0x0
//rdpproxy: INFO (19414/19414) -- Front::incoming: DisconnectProviderUltimatum received
//rdpproxy: INFO (19414/19414) -- Front::incoming: DisconnectProviderUltimatum: reason=RN_USER_REQUESTED [3]
...
//rdpproxy: INFO (19414/19414) -- RDP Target (-1): total_received=134116, total_sent=24507
//rdpproxy: INFO (19414/19414) -- Session::Client Session Disconnected
