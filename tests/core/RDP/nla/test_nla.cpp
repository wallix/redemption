...
RED_AUTO_TEST_CASE(TestNlaserver)
{
    ...
    NtlmServer ntlm_server(""_av, "WIN7"_av,"WIN7"_av,"win7"_av,"win7"_av,public_key, rand, timeobj, get_password, 6, true);
...
RED_AUTO_TEST_CASE(TestClientToServerInteraction)
{
    ...
    auto public_key = std::vector<uint8_t>{} << bytes_view("1245789652325415"_av); 
    NtlmServer ntlm_server(""_av, "WIN7"_av,"WIN7"_av,"win7"_av,"win7"_av,public_key, rand_server, timeobj_server, get_password, 6, true);
...
/* 0080 */ 0x2b, 0x2f, 0x03, 0xb5, 0x74, 0x5e, 0x35, 0x02, 0x03, 0x01, 0x00, 0x01,                          // +/..t^5.....
    ...
    NtlmServer ntlm_server("RDP-WINDOWS-DEV"_av,"RDP-WINDOWS-DEV"_av,"RDP-WINDOWS-DEV"_av,"rdp-windows-dev"_av,"rdp-windows-dev"_av,
                           public_key, rand, timeobj, get_password, 5, true);
