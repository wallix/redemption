...
RED_AUTO_TEST_CASE(TestNegoCredSSPV6)
{
    LOG(LOG_INFO, "============= Test Nego Client Side ===========");
    const char client[] =
// RDP Negotiation Request
...
/* 0030 */ "\x00\x06\x01\xb1\x1d\x00\x00\x00\x0f"                             //...(.....
        // authenticate
        "\x30\x82\x01\x8d\xa0\x03\x02\x01\x06\xa1\x82\x01\x2c\x30\x82\x01" //0...........,0.. !
        "\x28\x30\x82\x01\x24\xa0\x82\x01\x20\x04\x82\x01\x1c\x4e\x54\x4c" //(0..$... ....NTL !
        "\x4d\x53\x53\x50\x00\x03\x00\x00\x00\x18\x00\x18\x00\x58\x00\x00" //MSSP.........X.. !
        "\x00\x70\x00\x70\x00\x70\x00\x00\x00\x0e\x00\x0e\x00\xe0\x00\x00" //.p.p.p.......... !
        "\x00\x0c\x00\x0c\x00\xee\x00\x00\x00\x12\x00\x12\x00\xfa\x00\x00" //................ !
        ...
        "\x00\x73\x00\x73\x00\x65\x00\x54\x00\xe9\x00\x6c\x00\xe9\x00\x6d" //.s.s.e.T...l...m !
        "\x00\x61\x00\x71\x00\x75\x00\x65\x00\x44\xbc\x4d\x7a\x13\x3f\x6b" //.a.q.u.e.D.Mz.?k !
        "\x81\xdb\x1d\x2b\x7b\xbf\x1e\x18\x0f\xa3\x32\x04\x30\x01\x00\x00" //...+{.....2.0... !
        "\x00\x43\x9a\xa3\xf0\x45\x6f\x9c\xed\x00\x00\x00\x00\x21\x67\xac" //.C...Eo......!g. !
        "\xc3\x78\x2e\xd8\x79\x81\x28\x37\xe2\x46\x2b\x9b\x9c\xf5\xd6\x96" //.x..y.(7.F+..... !
        "\xff\x4f\x66\x17\x03\x79\x2d\xae\x01\x47\x24\x28\x96\xa5\x22\x04" //.Of..y-..G$(..". !
        "\x20\x88\x4c\xc2\x50\xc0\xdf\xc9\x50\x78\x58\xae\x52\xb0\xae\x6c" // .L.P...PxX.R..l !
        "\x17\x68\x5a\x13\xbd\xa0\x53\x7a\xf3\x58\x12\x7b\xce\x90\x8e\xa8" //.hZ...Sz.X.{.... !
        "\xad" //. !]
...
/* 0010 */ "\x00\x00\x00"                                                     //...
        ...
        // challenge
/* 0000 */ "\x30\x81\x88\xa0\x03\x02\x01\x06\xa1\x81\x80\x30\x7e\x30\x7c\xa0" //0..........0~0|.
/* 0010 */ "\x7a\x04\x78\x4e\x54\x4c\x4d\x53\x53\x50\x00\x02\x00\x00\x00\x00" //z.xNTLMSSP......
/* 0020 */ "\x00\x00\x00\x38\x00\x00\x00\xb7\x82\x08\xe2\xb8\x6c\xda\xa6\xf0" //...8........l...
/* 0030 */ "\xf6\x30\x8d\x00\x00\x00\x00\x00\x00\x00\x00\x40\x00\x40\x00\x38" //.0.........@.@.8
/* 0040 */ "\x00\x00\x00\x05\x01\x28\x0a\x00\x00\x00\x0f\x01\x00\x08\x00\x57" //.....(.........W
...
/* 0080 */ "\x95\x0e\x5a\x4e\x56\x76\xd6\x00\x00\x00\x00"                     //..ZNVv.....
        ...
        // pubauthkey
/* 0000 */ "\x30\x39\xa0\x03\x02\x01\x06\xa3\x32\x04\x30\x01\x00\x00\x00\xaa"
           "\x95\x8d\x1f\x64\x64\x2e\x33\x00\x00\x00\x00\x00\x00\x00\x00\x00"
/* 0000 */ "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
/* 0000 */ "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"


        ;
    TestTransport logtrans(server, sizeof(server)-1, client, sizeof(client)-1);
    logtrans.set_public_key(reinterpret_cast<const uint8_t*>("1"), 1);
    char user[] = "Ulysse";
    char domain[] = "Ithaque";
    char pass[] = "Pénélope\x00";
    char host[] = "Télémaque";
