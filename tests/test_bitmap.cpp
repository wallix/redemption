...
//        printf("\n");
        ...
        Bitmap bmp2(16, 4, 4);
        memset(bmp2.data_co(bpp), 0, 2*4*4);
...
//        printf("\n");
        ...
        BOOST_CHECK(1);
        Bitmap bmp2(bpp, 256, 3);
        bmp2.decompress(bpp, compressed, sizeof(compressed));
...
//        printf("\n");
...

    {
        ...
        Bitmap bmp(bpp, 64, 10);
        bmp.decompress(bpp, compressed, 9);
