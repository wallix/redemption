...
RED_FIXTURE_TEST_CASE(unicode_to_scancode_simple_unicode_no_key_combination,
                      FrenchLocaleFixture)
{
...
RED_FIXTURE_TEST_CASE(unicode_to_scancode_simple_unicode_from_key_combination,
                      FrenchLocaleFixture)
{
...
RED_FIXTURE_TEST_CASE(unicode_to_scancode_extended_unicode,
                      FrenchLocaleFixture)
{
...
RED_FIXTURE_TEST_CASE(unicode_to_scancode_unicode_no_defined,
                      FrenchLocaleFixture)
{
