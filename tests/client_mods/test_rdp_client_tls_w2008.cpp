...
RED_AUTO_TEST_CASE(TestDecodePacket)
{
    ...
    auto mod = new_mod_rdp(t,
        session_reactor, fd_events_, graphic_fd_events_, timer_events_, graphic_events_, sesman_events_, sesman,
        front.gd(), front, info,
    ...
    execute_mod(session_reactor, fd_events_, graphic_fd_events_, timer_events_, graphic_events_, graphic_timer_events_, *mod, front.gd(), 70);
...
RED_AUTO_TEST_CASE(TestDecodePacket2)
{
    ...
    auto mod = new_mod_rdp(t,
        session_reactor, fd_events_, graphic_fd_events_, timer_events_, graphic_events_, sesman_events_, sesman, front.gd(), front, info,
        ini.get_mutable_ref<cfg::mod_rdp::redir_info>(), gen, timeobj,
        channels_authorizations, mod_rdp_params, tls_client_params, authentifier, report_message, license_store, ini,
        nullptr, nullptr, mod_rdp_factory);
    ...
    execute_mod(session_reactor, fd_events_, graphic_fd_events_, timer_events_, graphic_events_, graphic_timer_events_, *mod, front.gd(), 40);
