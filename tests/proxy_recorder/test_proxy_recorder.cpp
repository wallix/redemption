...
private:
    ...
    size_t do_partial_read(uint8_t* /*buffer*/, size_t /*len*/) override { return 0;}
...
RED_AUTO_TEST_CASE(TestNLAOnSiteCapture)
{
    ...
    ProxyRecorder conn(frontConn, nla_tee_trans, backConn, outFile, nla_username, nla_password, enable_kerberos, verbosity);
