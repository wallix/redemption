...
RED_AUTO_TEST_CASE_WD(TestAppRecorderChunk, wd)
{
    ...
    RED_TEST_FILE_SIZE(wd.add_file("recorder-chunk-000001.mp4"), 39'000 +- 20_percent);
...
RED_AUTO_TEST_CASE_WD(TestAppRecorderChunkMeta, wd)
{
    ...
    RED_TEST_FILE_SIZE(wd.add_file("recorder-chunk-meta-000000.mp4"), 440000 +- 7_percent);
    RED_TEST_FILE_SIZE(wd.add_file("recorder-chunk-meta-000000.png"), 15353 /*+- 0_v*/);
    RED_TEST_FILE_SIZE(wd.add_file("recorder-chunk-meta-000001.mp4"), 480000 +- 10_percent);
