...
BOOST_AUTO_TEST_CASE(TestContinuationOrderStates)
{
    ...
    OutFilenameTransport out_png_trans("path file pid count extension", "./", "TestContinuationOrderStates", ".png");
    ...
    png_recorder.flush();
    BOOST_CHECK_EQUAL(341, sq_outfilename_filesize(&(sequence.sq), 0));
    sq_outfilename_filesize(&(sequence.sq), 0);
}
