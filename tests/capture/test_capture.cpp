...
BOOST_AUTO_TEST_CASE(TestSplittedCapture)
{
    ...
    const int groupid = 0;
    {
        ...
        BOOST_CHECK_EQUAL((unsigned)3072, (unsigned)sq_outfilename_filesize(&(capture.png_trans->seq), 0));
        sq_outfilename_unlink(&(capture.png_trans->seq), 0);
        BOOST_CHECK_EQUAL((unsigned)3104, (unsigned)sq_outfilename_filesize(&(capture.png_trans->seq), 1));
        sq_outfilename_unlink(&(capture.png_trans->seq), 1);
        BOOST_CHECK_EQUAL((unsigned)3123, (unsigned)sq_outfilename_filesize(&(capture.png_trans->seq), 2));
        ...
        BOOST_CHECK_EQUAL((unsigned)3156, (unsigned)sq_outfilename_filesize(&(capture.png_trans->seq), 4));
        ...
        BOOST_CHECK_EQUAL((unsigned)3197, (unsigned)sq_outfilename_filesize(&(capture.png_trans->seq), 6));
