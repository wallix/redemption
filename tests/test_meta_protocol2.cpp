...
template<class L>
using sizeof_var_info_list = brigand::fold<
...
struct Buferring2
{
    ...
    void operator()(Packets ... packets) const {
        ...
        using sizeof_by_packet = transform<packet_list, call<sizeof_var_info_list>>;
        ...
        impl(
            ...
            var_info_list_by_buffer{}, accu_sizeof_by_packet{},
            packets...
        );
    }
