                                    ...
                                    Capture * capture)
{
    ...
    for (;;){
        ...
        {
            RDPBmpCache bmp(1, &entry_b->bmp, cache_b_id, cache_b_idx, &front->orders->rdp_layer->client_info);
        ...
        {
            RDPBmpCache bmp(1, &entry_b_h->bmp, cache_b_id_h, cache_b_idx_h, &front->orders->rdp_layer->client_info);
        // check reserved size depending on version
        ...
        {
            RDPBmpCache bmp(1, &entry_b_wallix->bmp, cache_b_id_wallix, cache_b_idx_wallix, &front->orders->rdp_layer->client_info);
           // check reserved size depending on version
        ...
        {
            RDPBmpCache bmp(1, &entry_b_h_wallix->bmp, cache_b_id_h_wallix, cache_b_idx_h_wallix, &front->orders->rdp_layer->client_info);
        // check reserved size depending on version
