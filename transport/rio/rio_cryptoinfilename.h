...
#ifndef _REDEMPTION_TRANSPORT_RIO_RIO_CRYPTOINFILENAME_H_
#define _REDEMPTION_TRANSPORT_RIO_RIO_CRYPTOINFILENAME_H_
...
extern "C" {
    ...
    */
    inline RIO_ERROR rio_m_RIOCryptoInfilename_constructor(RIOCryptoInfilename * self, const CryptoContext * crypto_ctx, const char * filename)
    {
        RIO_ERROR error;
