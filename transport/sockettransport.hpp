...
//    static inline RIO_ERROR rio_m_RIOSocketTLS_enable_TLS_server(RIOSocketTLS * self)
//    {
//        LOG(LOG_INFO, "RIO *::enable_tls_server()");
...
//       self->tls = true;
//       LOG(LOG_INFO, "RIO *::enable_tls_server() done");
//       return RIO_ERROR_OK;
//    }
...
class SocketTransport : public Transport {
    ...
    virtual void enable_tls() throw (Error)
    {
        ...
        LOG(LOG_INFO, "RIO *::enable_tls_client()");
