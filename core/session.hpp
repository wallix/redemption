    ...
    Session(wait_obj & front_event, int sck, Inifile * ini)
        ...
        try {
...

            {
                ...
                pathncpy(path, RECORD_TMP_PATH, sizeof(path)); // default value, actual one should come from movie_path
                ...
                clear_files_flv_meta_png(this->ini->video.record_tmp_path, basename);
            }
