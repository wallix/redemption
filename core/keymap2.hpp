...
struct Keymap2 {
    ...
    // constructor
// ################################################################
    Keymap2(int verbose = 0) : ibuf(0), nbuf(0), ibuf_kevent(0), nbuf_kevent(0), dead_key(DEADKEY_NONE), verbose(verbose)
    {
// ################################################################
    ...
    void event(const uint16_t keyboardFlags, const uint16_t keyCode)
    {
        ...
        switch (extendedKeyCode){
            ...
            default:
                ...
                //  - the fist block (0-127) simply applies the +8 translation and some 0 values
                //  - the second block (128-255) give codes for extended keys
                uint8_t map[256] =  {
