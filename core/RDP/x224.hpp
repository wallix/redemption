    ...
    //==============================================================================
    {
        ...
        switch (this->tpdu_hdr.code){
            case DT_TPDU:
                ...
                this->tpdu_hdr.code_part.DT_TPDU.eot = stream.in_uint8();
            ...
            case DR_TPDU:
                ...
                this->tpdu_hdr.code_part.DR_TPDU.reason = stream.in_uint8();
            ...
            case ER_TPDU:
                ...
                this->tpdu_hdr.code_part.ER_TPDU.reject_cause = stream.in_uint8();
