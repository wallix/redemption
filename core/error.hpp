...
enum {
    ...
    ERR_TRANSPORT_NO_MORE_DATA = 1500,
    ERR_TRANSPORT_WRITE_FAILED,
    ERR_TRANSPORT_READ_FAILED,
    ERR_TRANSPORT_OUTPUT_ONLY_USED_FOR_RECV,
    ERR_TRANSPORT_INPUT_ONLY_USED_FOR_SEND,
    ...
    ERR_X224_SENDING_UNKNOWN_PDU_TYPE = 3000,
    ...
    ERR_SEC_PARSE_PUB_KEY_MAGIC_NOT_OK = 6000,
    ...
    ERR_SEC_UNEXPECTED_LICENCE_NEGOTIATION_PDU,
    ERR_SEC_EXPECTED_LICENCE_NEGOTIATION_PDU,
    ERR_SEC_EXPECTING_CLIENT_RANDOM,
    ERR_SEC_EXPECTED_LOGON_INFO,
    ERR_SEC_EXPECTED_LICENCE_NEG,
    ...
    ERR_RECORDER_NATIVE_CAPTURE_OPEN_FAILED,
    ERR_RECORDER_NATIVE_CAPTURE_ZIP_COMPRESS,
